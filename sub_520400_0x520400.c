...
int32_t __fastcallsub_520400(int32_t arg1, int32_t arg2)
{
    ...
    if (arg2 s> 0)
        ...
        while (true)
            ...
            label_520a30:
                ...
                var_24_8 = 0xfff
            label_520a49:
                sub_489550(eax, &data_5b2591, "Halt", "d:\ax\trunk\ax2017\engine\openglgraphics.cpp", 
                    var_24_8, "GLSetFunctionRenderState")
            ...
            eax = zx.d(lookup_table_520ae0[eax])
            ...
            switch (eax)
                ...
                case 0x1b
                    ...
                    goto label_520980
                case 0x1c
                    char eax_28 = sub_51c750(eax, *(arg1 + (edi_1 << 2) + 4), 0xb, 
                        *(arg1 + (edi_1 << 2) + 8), *(arg1 + (edi_1 << 2) + 0xc), 
                        *(arg1 + (edi_1 << 2) + 0x10))

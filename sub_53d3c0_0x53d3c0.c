...
int32_t __thiscallsub_53d3c0(int32_t* arg1, int32_t* arg2, int32_t* arg3)
{
    ...
    int32_t (* var_18)(void* arg1) = sub_5a2e88
    TEB* fsbase
    ...
    if (ecx_2 != 0)
        ...
        if (ecx_3 == 0)
            ...
            edx_1 = sub_4d2a30(ecx_3)
            int32_t* ecx_4 = var_24
            
            if (ecx_4 != 0)
                ecx_4[7] -= 1
        
        void* eax_8 = data_1151ae8
    ...
    if (arg3 == 0)
        ...
        int32_t* eax_10 = sub_4d2a30(arg3)
        void* edx_2 = data_1151ae8
    ...
    float xmm2_1 = ecx_13[3] f* ecx_13[2]
    double xmm0_2[0x2] = _mm_cvtepi32_pd(zx.q(eax_18)) f+ *((eax_18 u>> 0x1f << 3) + &data_60cbc0)
    int32_t eax_20 = ecx_13[1]
    float xmm1_1 = _mm_cvtpd_ps(xmm0_2) * xmm2_1
    double xmm0_5[0x2] = _mm_cvtepi32_pd(zx.q(eax_20)) f+ *((eax_20 u>> 0x1f << 3) + &data_60cbc0)
    arg1[6] = xmm1_1
    int32_t* xmm0_7 = _mm_cvtpd_ps(xmm0_5) * xmm2_1
    var_2c = xmm0_7
    arg1[7] = xmm0_7
    int32_t var_3c = 0
    int32_t var_38 = int.d(sub_4827e0(xmm1_1 + 0.5f))
    int32_t var_34 = int.d(sub_4827e0(var_2c f+ 0.5f))

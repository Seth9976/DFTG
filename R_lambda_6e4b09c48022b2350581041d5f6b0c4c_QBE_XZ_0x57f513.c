...
struct _EXCEPTION_REGISTRATION_RECORD** __fastcall??R<lambda_6e4b09c48022b2350581041d5f6b0c4c>@@QBE@XZ(int32_t* arg1)
{
    ...
    if (data_6cf750 == 0)
        ...
        if (**arg1 == 0)
            __initterm(0x5a6cb8, 0x5a6cc8)
        
        __initterm(0x5a6ccc, 0x5a6cd0)
        result = arg1[1]
    ...
    fsbase->NtTib.ExceptionList = ExceptionList
    void* const __saved_ebp_2 = &data_57f5d5
    return result
}

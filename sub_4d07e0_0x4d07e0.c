...
int32_t __fastcallsub_4d07e0(int32_t* arg1)
{
    // 第一条实际指令: int32_t var_8 = 0xffffffff
    int32_t var_8 = 0xffffffff
    int32_t (* var_c)(void* arg1) = sub_59fdb0
    TEB* fsbase
    ...
    sub_4d0720(arg1)
    char* eax_3 = arg1[8]
    int32_t* esi = data_114e844
    char* const ecx = &data_5b2591
    
    if (eax_3 != 0)
        ecx = eax_3
    
    int32_t eax_4 = sub_4e1990(ecx, 0)
    int32_t* edi = nullptr
    ...
    if (esi_1 != 0)
        ...
        while (true)
            ...
            if (eax_6 == 0)
                ...
                sub_4984f0(esi_1, 0xc)
                void* edi_1 = data_114e844
                esi[2] -= 1
                ...
                sub_489550(i_2, &data_5b2591, "IsPointerFromAllocator(pItem)", 
                    "d:\ax\trunk\ax2017\engine\xalloc.h", 0x10c, "XTypedAllocator<struct XAsset>::Free")
    ...
    sub_489550(eax_6, &data_5b2591, "Halt", "d:\ax\trunk\ax2017\engine\xmap.h", 0xd9, 

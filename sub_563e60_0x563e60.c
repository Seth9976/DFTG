...
int32_t __fastcallsub_563e60(int32_t* arg1, int32_t arg2)
{
    ...
    switch (arg2)
        case 0xc4
            ...
            while (true)
                ...
                if (var_50_1 != 0)
                    if (sub_561890(esi_5 + 0x1a44, edx) == 0)
                        break
                    
                    eax_38 = 0x1e44
                else
                    if (sub_561890(esi_5 + 4, edx) == 0)
                        break
        ...
        case 0xdb
            ...
            while (i_4 s> 0)
                ...
                for (void* j = nullptr; j s< 0x40; )
                    ...
                    if (ecx_7 == 0)
                        ...
                        ecx_9 = sub_561390(esi_2)
                    
                    uint32_t eax_20 = zx.d(*(j + 0x5d3c28))
                    j += 1
            ...
            goto label_563fd4
        case 0xdd
            if (sub_561390(*arg1) != 4)
                goto label_5644c4
            
            arg1[0x1201] = sub_561390(*arg1)
            @__security_check_cookie@4(eax_1 ^ &__saved_ebp)
            return 1
        case 0xff
        label_5644c4:

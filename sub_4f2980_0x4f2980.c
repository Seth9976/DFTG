...
struct _EXCEPTION_REGISTRATION_RECORD** __fastcallsub_4f2980(int32_t* arg1)
{
    // 第一条实际指令: void* const __return_addr_1 = __return_addr
    void* const __return_addr_1 = __return_addr
    int32_t var_14 = 0xffffffff
    int32_t (* var_18)(void* arg1) = sub_5a12e0
    TEB* fsbase
    ...
    if (arg1[3] != 0)
        ...
        sub_4f1660(arg1)
        sub_4f23c0(arg1, edi_2)
        sub_4f2520(arg1, edi_2)
        int32_t* i_1
        int32_t* var_90_2 = &i_1
        int32_t* var_34
        sub_4889e0(&var_34, *arg1, 2)
        int32_t var_14_1 = 0
        float* ecx_5
        ecx_5.b = 0
        char var_25_1 = 0
        ...
        if (arg1[0xc4] s> 0)
            ...
            do
                if (*(edi_3 - 4) != 0)
                    ...
                    if (arg1[5] s<= 0)
                        sub_489550(i, &data_5b2591, "index >= 0 && index < mSize", 
                    ...
                    ecx_5 = sub_4f2e20(edi_3 + 0x120, edi_3 + 0x104, ecx_5, edi_3 + 0x120, edi_3, 
                        *(edi_3 + 0x100), edx_4[6], var_2c_1)
                    i = i_1
                    edx_4 = var_38
        ...
        void* edx_7 = *var_38
        void* var_3c_1 = edx_7
        int32_t* i_2 = *(edx_7 + 0x10)
        i_1 = i_2
        
        if (cond:2_1)
            sub_489550(i_2, &data_5b2591, "index >= 0 && index < mSize", 
        ...
        if (i_2 s> 0)
            ...
            while (true)
                ...
                *(edx_7 + 0x18)
                void var_80
                int128_t* eax_10 = sub_497aa0(&var_80)
                edi_4 += 1
                ecx_9 = &var_34[0x36]

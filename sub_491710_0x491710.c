...
uint32_t __convention("regparm")sub_491710(int32_t arg1, int32_t* arg2, int128_t* arg3)
{
    // 第一条实际指令: void var_e8
    void var_e8
    ...
    uint32_t result = sub_490490(xmm2_52, &var_58, &var_b8, arg3)

...
void* __fastcallsub_4e3c30(int32_t arg1)
{
    ...
    sub_489550(result, &data_5b2591, ecx_8, "d:\ax\trunk\ax2017\engine\perfevent.cpp", var_1b4, 
        "ProfilerCalcGroupBy")

...
LRESULT __convention("regparm")sub_5575e0(int32_t arg1, int32_t arg2, HWND arg3, int32_t arg4, int32_t arg5)
{
    // 第一条实际指令: int32_t __saved_ebp
    int32_t __saved_ebp
    int32_t eax_1 = __security_cookie ^ &__saved_ebp
    void* eax_2 = data_1511868
    *(eax_2 + 0x28) = arg5 - *(eax_2 + 0x2c)
    void* edx_2 = data_1511868
    ...
    if (*(eax_6 + 0xc) != 0)
        ...
        SendMessageA(*(data_1511868 + 0xc), 0x406, 0, &lParam)
        eax_6 = data_1511868

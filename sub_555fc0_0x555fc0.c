...
LRESULT __convention("regparm")sub_555fc0(int32_t arg1, int32_t arg2, HWND arg3, int16_t arg4)
{
    // 第一条实际指令: void* eax = data_1511868
    void* eax = data_1511868
    ...
    SendMessageA(*(data_1511868 + 0x1c), 0x102, 0xd, 0)
    ...
    if (ecx_3 != 0)
        ...
        if (result != 3)
            if (result == 8)
                LPARAM lParam = __Cnd_wait(*(ecx_3 + 8), U"T")

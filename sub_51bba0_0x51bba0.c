...
int32_t __fastcallsub_51bba0(int32_t* arg1)
{
    ...
    if (result == 0)
        ...
        while (true)
            ...
            void* var_32c
            sub_579300(esi_1, var_330, var_32c)
            void* esi_2 = esi_1 + var_32c
            char* var_328
            void* var_324
            sub_579300(esi_2, var_328, var_324)
            esi_1 = esi_2 + var_324
                                ...
                                if (eax_47 != 1)
                                    if (eax_47 != 2)
                                        ...
                                        *(esp_2 - 8) = 0xa0
                                        ...
                                        ecx_13 = "Halt"
                                    label_51c066:
                                        *(esp_46 - 4) = "d:\ax\trunk\ax2017\engine\soundogg.cpp"
                                        sub_489550(eax_47, &data_5b2591, ecx_13)

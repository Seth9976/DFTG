...
long doublestart(double arg1[0x2] @ xmm0, double arg2)
{
    ...
    while (true)
        ...
        double xmm2_1[0x2] = data_5b1a20
        double xmm4_1[0x2] = data_5b1a30
        uint64_t xmm6_1[0x2] = data_5b1a40
        uint64_t xmm0_2[0x2] = _mm_or_pd(_mm_and_pd(xmm0, data_5b1a10), data_5b1a80)
        eax_2 = _mm_extract_epi16(_mm_add_pd(xmm4_1, xmm0_2), 0) & 0x7f0
        double xmm4_3[0x2] = *(eax_2 + 0x5b1f20)
        xmm7_1 = (*(eax_2 + 0x5b1b10)).q
        ...
        double xmm0_11 = arg2
        double xmm1_10[0x2] = _mm_cmpeq_sd((data_5b1a90).q, xmm0_11, 0)
        int32_t edx_2
        ...
        label_597aad:
            var_c = xmm1_10
            sub_590d14(&arg2, &arg2, &var_c, edx_2)
        ...
        if ((ecx_1 & 0xfff) != 0)
            if ((ecx_1 & 0xfff) - 1 u> 0x7fe)
                ...
                xmm1_10 = data_5b1a10
                uint64_t xmm2_6[0x2] = data_5b1a80
    ...
    double xmm2_2[0x2] = data_5b1ae0
    double xmm1_3[0x2] = _mm_mul_pd(data_5b1ad0, xmm0_5)
    double xmm3_3 = _mm_mul_pd(xmm0_5, xmm0_5)
    double xmm1_4[0x2] = _mm_add_pd(xmm1_3, xmm2_2)
    double xmm2_3[0x2] = data_5b1af0
    double xmm6_7[0x2] = _mm_mul_pd(xmm6_6, data_5b1a50)
    uint64_t xmm4_5[0x2] = _mm_and_pd(xmm0_4, *(edx_1 + 0x5b1a60))
    ...
    double xmm2_5[0x2] = _mm_mul_pd(data_5b1b00, xmm0_5)

...
HWND __convention("regparm")sub_5565f0(int32_t arg1, void* arg2, HWND arg3, int32_t arg4, int32_t arg5, int32_t arg6, int32_t arg7)
{
    ...
    if (result != 0xa)
        if (result == 0xb)
            HINSTANCE* esi_2 = data_1511868
            
            if (esi_2[7] == 0)
                *(data_1511868 + 0x1c) = sub_5550e0(result, arg3, *esi_2, 0x7d7, 0)
                esi_2 = data_1511868
            ...
            sub_48d8d0(arg2, edx_3, ecx_7, *(arg2 + 0x10), "%hd:%hd:%hd %2s")
            
            if (__Cnd_wait("PM", &var_1c) == 0)
                uint32_t eax_16
        ...
        if (result == 0xc)
            ...
            if (ecx_8[7] == 0)
                *(data_1511868 + 0x1c) = sub_5550e0(X, arg3, *ecx_8, 0x7d6, 1)
                ecx_8 = data_1511868
            
            BOOL eax_27 = MoveWindow(ecx_8[7], X_1, Y_1, X - X_1, arg7 - Y_1, 1)
            HINSTANCE* esi_3 = data_1511868
            
            if (esi_3[8] == 0)
                *(data_1511868 + 0x20) = sub_5550e0(eax_27, arg3, *esi_3, 0x7d7, 0)
                esi_3 = data_1511868
            ...
            sub_48d8d0(arg2, edx_8, ecx_13, *(arg2 + 0x10), "%hd/%hd/%hd %hd:%hd:%hd %2s")
            ...
            SendMessageA(*(data_1511868 + 0x1c), 0x1002, 0, &var_18)
            SendMessageA(*(data_1511868 + 0x20), 0x1002, 0, &var_18)
            ShowWindow(*(data_1511868 + 0x1c), SW_SHOW)
            ShowWindow(*(data_1511868 + 0x20), SW_SHOW)
            result = SetFocus(*(data_1511868 + 0x1c))
    else
        int32_t* esi_1 = data_1511868
        
        if (esi_1[7] == 0)
            *(data_1511868 + 0x1c) = sub_5550e0(result, arg3, *esi_1, 0x7d6, 1)
            esi_1 = data_1511868
        ...
        sub_48d8d0(arg2, edx_1, ecx_3, *(arg2 + 0x10), "%hd/%hd/%hd")
    label_5566a7:
        SendMessageA(*(data_1511868 + 0x1c), 0x1002, 0, &var_18)
        ShowWindow(*(data_1511868 + 0x1c), SW_SHOW)
        result = SetFocus(*(data_1511868 + 0x1c))

...
int32_t __convention("regparm")sub_4d02d0(int32_t arg1, char arg2, void* arg3, char arg4, int32_t arg5, int32_t arg6, int32_t* arg7, int64_t* arg8)
{
    ...
    *(arg3 + 0x320) = arg8[1].d
    ...
    if (eax_7 != (*data_6c8cd4)())
        edi_2 = arg3 + 0x110
    else
        edi_2 = arg3 + 0x110
        
        if (eax_7(arg3 + 0x210, &data_6c8cd4).b != 0)
            int32_t eax_9 = (**edi_2)()
    ...
    if (arg2 == 0)
        ...
        *(arg3 + 4) = 0
        __builtin_memcpy(arg3 + 0x210, &data_6c8cd4, 0x100)
    else if (result.b == 0)
        *(arg3 + 8) = arg5

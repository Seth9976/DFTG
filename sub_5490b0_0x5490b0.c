...
int128_t* __convention("regparm")sub_5490b0(int32_t arg1, int32_t* arg2, int32_t arg3, int128_t* arg4)
{
    ...
    if (arg3 - 2 u<= 9)
        switch (arg3)
            ...
            case 4, 0xb
                ...
                goto label_5492f8
            case 5
                float xmm3 = data_11e5ff4
                float xmm2 = data_11e6000
                float xmm6 = data_11e5ffc
                float xmm1 = data_11e5ff8
            ...
            label_549144:
                ...
                float var_28 = xmm6_4
                int32_t var_24 = (xmm1_2 f* xmm4_3 + xmm5_4 + arg2[2] f* xmm6_4) ^ (data_60cca0.o).d
                *arg4 = xmm0_5.o
                return arg4
            case 6
                float xmm6_8 = data_11e5ff4
                float xmm3_3 = data_11e6000
                float xmm2_4 = data_11e5ffc
                float xmm1_8 = data_11e5ff8
                ...
                goto label_549144
            case 7
                float xmm6_5 = data_11e5ff4
                float xmm2_2 = data_11e5ffc
                float xmm3_2 = data_11e5ff8
                float xmm1_7 = data_11e6000
                ...
                goto label_549144
    sub_489550(arg1, &data_5b2591, "Halt", "d:\ax\trunk\ax2017\engine\editor\fabeditor.cpp", 0x2f2, 
        "CalcDragPlane")

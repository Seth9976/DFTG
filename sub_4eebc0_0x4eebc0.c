...
int128_t* __convention("regparm")sub_4eebc0(int32_t arg1, int32_t arg2, int32_t* arg3, int128_t* arg4)
{
    ...
    float xmm0_1 = sub_41f120(xmm1_4)
    float xmm0_3 = sub_41f100(xmm1_4)
    float xmm0_5 = (xmm2 + xmm2) * 3.14159274f * 0.00277777785f * 0.5f
    float xmm0_6 = sub_41f120(xmm0_5)
    float xmm0_8 = sub_41f100(xmm0_5)
    float xmm0_10 = (xmm3 + xmm3) * 3.14159274f * 0.00277777785f * 0.5f
    float xmm0_11 = sub_41f120(xmm0_10)
    float xmm0_13 = sub_41f100(xmm0_10)

...
void* __fastcallsub_51c520(void* arg1, int32_t arg2)
{
    ...
    if (ebx_2 s> 0)
        int32_t ecx_6 = 0
        uint32_t temp1_1 = modu.dp.d(0:(sub_48dd80()), ebx_2)
        eax = nullptr
    ...
    sub_489550(eax, &data_5b2591, ecx_5, "d:\ax\trunk\ax2017\engine\mathfunctions.cpp", var_24, 
        "XWeightedArrayPick")

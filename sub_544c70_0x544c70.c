...
void*sub_544c70()
{
    ...
    if ((*(data_114e840 + 0xc) & 2) == 0 || *(data_aca1f0 + 0x18) == 0)
        ...
        if (GetCursorPos(&var_5c:4) != 0)
            int32_t Y = data_1151af8
            int32_t X = data_1151af4
            SetCursorPos(X, Y)
    ...
    if ((*(data_114e840 + 0xc) & 4) == 0 || *(data_aca1f0 + 0x18) == 0)
        if (data_1151af2 == 1)
            data_1151af2 = 0
            ShowCursor(1)
    else if (data_1151af2 != 0)
        if (GetCursorPos(&var_5c:4) != 0)
            int32_t Y_1 = data_1151b08
            int32_t X_1 = data_1151b04
    ...
    else if (GetCursorPos(&data_1151b04) != 0)
        data_1151af2 = 1
        ShowCursor(0)
    
    int64_t xmm0_15 = data_1151b18.d
    float xmm2_1 = data_1151b0c f- xmm0_15
    float xmm1_1 = data_1151b14 f- data_1151b20
    var_5c = xmm0_15
    float xmm0_17 = data_1151b10 f- data_1151b18:4
    int32_t edx
    int32_t xmm0_21
    edx, xmm0_21 = sub_41dbe0(xmm0_17 * xmm0_17 + xmm2_1 * xmm2_1 + xmm1_1 * xmm1_1)
    int32_t xmm2_3 = var_5c.d
    float xmm1_3 = _mm_max_ss(0x3f800000, xmm0_21)
    float var_20 = data_1151b20 f- data_1151b14
    int64_t var_28 = _mm_unpacklo_ps(xmm2_3 f- data_1151b0c, data_1151b18:4 f- data_1151b10)
    void var_74
    int64_t* eax_12
    int32_t edx_1
    eax_12, edx_1 = sub_482720(&var_74, edx, &var_28, &var_74)
    ...
    int64_t* eax_16 = sub_482720(&var_74, edx_1, &var_28, &var_74)
    ...
    float xmm0_37 = xmm2_13 f+ data_1151b18.d
    float xmm3_14 = xmm2_13 f+ data_1151b0c
    float xmm6_7 = xmm6_6 f+ data_1151b10
    float xmm7_7 = xmm7_6 f+ data_1151b14
    float xmm1_11 = xmm6_6 f+ data_1151b18:4
    float xmm2_15 = xmm7_6 f+ data_1151b20
    data_1151b18.d = xmm0_37
    data_1151b0c = xmm3_14
    ...
    data_1151b18:4 = xmm1_11
    data_1151b20 = xmm2_15
    float xmm0_40 = sub_41f120(xmm0_39)
    float xmm1_13 = xmm0_40 * 0f
    int32_t edx_2
    float xmm0_42
    edx_2, xmm0_42 = sub_41f100(xmm0_39)
    ...
    int64_t* eax_24 = sub_482720(&var_74, edx_3, &var_1c, &var_74)
    float eax_25 = eax_24[1].d
    var_1c = *eax_24
    
    if (not(0.99000001f f<= sub_426e40(var_1c.d * 0f + var_1c:4.d * 0f + eax_25)))
        var_28 = var_5c
        var_20_3 = xmm5_14
    
    float xmm0_115 = data_1151b20 + var_20_3
    int32_t ecx_5 = data_1151b54
    data_1151b0c.q = _mm_unpacklo_ps(var_28.d f+ data_1151b18.d, var_28:4.d f+ data_1151b18:4)
    data_1151b14 = xmm0_115
    void* result = sub_4fd250(ecx_5)
    void* result_2 = result
    
    if (result_2 != 0)
        float xmm0_117 = data_1151b58 f+ data_1151b84
        data_1151b58 = xmm0_117
        float xmm0_118 = xmm0_117 * 0.5f
        float xmm0_119 = sub_41f100(xmm0_118)
        float xmm0_121 = sub_41f120(xmm0_118)
        var_28:4.d = xmm0_121

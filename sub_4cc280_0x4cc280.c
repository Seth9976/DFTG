...
void __fastcallsub_4cc280(int32_t arg1, char arg2)
{
    // 第一条实际指令: int32_t ebx
    int32_t ebx
    ebx.b = arg2
    ...
    label_4cc472:
        ...
        var_58 = "d:\ax\trunk\ax2017\engine\dataarray.h"
    label_4cc488:
        sub_489550(eax, &data_5b2591, ecx_2, var_58, var_54, var_50_1)
    ...
    if (ecx_1[1] != 0x1e)
        var_50_1 = "UIDefGet"
        var_54 = 0x126
        var_58 = "d:\ax\trunk\ax2017\engine\uidef.cpp"
        ecx_2 = "ptr->assetType == ASSET_TYPE_UI"
        goto label_4cc488
    
    eax = sub_4981f0(ecx_1)
    ...
    while (true)
        if (*(esi_1 + ecx_3) != 0)
            ...
            if (eax u>= data_6c9d94)
                break
            
            void* ecx_4 = data_6c9d90
            eax *= 0x438
            ...
            if (*(esi_1 + ecx_5) != 0)
                eax = sub_4ca090(eax, edi_1, ecx_5, &data_5b2591)
            ...
            uint32_t (* edx_5)[0x4] = sub_4ca090(eax, edi_1, var_c_1, &data_5b2591)
                        ...
                        if (eax_6 s> 0)
                            do
                                ...
                                if (not(cond:1_1))
                                    uint32_t eax_8
                                    int32_t edx_6
                                    eax_8, edx_6 = sub_4cac50(&var_40, edx_5, ecx_8, &var_40)
                                    edx_6.b = var_5
                                    *(eax_8 + 0x434)
                                    sub_4cc280()
                                    eax_6 = var_20_1

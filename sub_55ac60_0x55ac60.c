...
void* __convention("regparm")sub_55ac60(int32_t arg1, int32_t arg2, int32_t arg3, float arg4 @ xmm1, int32_t arg5, float arg6, int32_t* arg7, void* arg8)
{
    ...
    *arg7 = arg2
    ...
    if (esi - arg2 s>= 0)
        ...
        do
            (*((arg3 << 3) + &data_6ceda8))(arg6 - (_mm_cvtepi32_ps(zx.o(edi + esi_1)) + 0.5f), xmm1)

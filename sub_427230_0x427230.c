...
int32_t __fastcallsub_427230(int32_t* arg1)
{
    // 第一条实际指令: void* eax_4
    void* eax_4
    void* esi
    ...
    if (data_6d00ac != 2)
        ...
        if (eax_1 s> 0x3e8)
            ...
            int32_t eax_7
            int32_t edx_1
            edx_1:eax_7 = muls.dp.d(0x10624dd3, sub_498220(arg1))
    ...
    label_427382:
        ...
        label_427451:
            sub_489550(eax_4, &data_5b2591, "Halt", 
                "d:\ax\trunk\ax2017\jams\shared\tgggame\code\gamedialogs.cpp", var_18, var_14)

...
int32_t* __convention("regparm")sub_4c3a30(int32_t arg1, void* arg2, int32_t* arg3, void* arg4, void* arg5)
{
    // 第一条实际指令: int32_t var_8 = 0xffffffff
    int32_t var_8 = 0xffffffff
    int32_t (* var_c)(void* arg1) = sub_59fa51
    TEB* fsbase
    ...
    int32_t var_20 = 0
    char* var_14
    int32_t xmm0[0x4] = sub_48a2c0(&var_14, &data_5b2591)
    char* ebx = arg4
    int32_t var_8_1 = 1
    char i
    ...
    for (void* i_1 = i_2; i_1 != 0; i_1 = i_2)
        ...
        if (eax_3 == 0)
            sub_489550(eax_3, &data_5b2591, "Halt", "d:\ax\trunk\ax2017\engine\localization.cpp", 0x6f, 
                "RemoveMarkup")
        ...
        int32_t xmm0_2[0x4] = sub_48a670(&var_14, eax_4)
        var_8_1.b = 6
        ...
        if (data_aca1f4 != 0 && esi_1 != 0 && *esi_1 != 0)
            ...
            *(eax_5 + 4) -= 1
            ...
            if (temp1_1 == 1)
                xmm0_2 = sub_4984f0(eax_5, *(eax_5 + 0xc) + 0x10)
                var_18 = &data_5b2591
    ...
    if (esi == 0)
        sub_489550(i_2, &data_5b2591, "str", "d:\ax\trunk\ax2017\engine\xstring.cpp", 0x94, 
            "XString::XString")

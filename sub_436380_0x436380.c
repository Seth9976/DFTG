...
int32_t __convention("regparm")sub_436380(int32_t arg1, int32_t arg2, int32_t* arg3, int32_t arg4, int32_t arg5)
{
    ...
    label_436428:
            ...
            while (esi_1 != ebx)
                ...
                if (arg5(eax_10, *edi) == 0)
                    ...
                    *var_18_1 = eax_2
                    ...
                    sub_579a90(&edi[1], edi, esi_1 - edi)
                    eax_2 = eax_10
                    *edi = eax_2
        ...
        for (void* i_1 = i_3 s>> 1; i_1 s> 0; i_1 -= 1)
            var_10 = edi[i_1 - 1]
            eax_2 = sub_436930(&var_10, i_1 - 1, edi, i_3, &var_10, arg5)
            ...
            do
                if (i_3 s>= 2)
                    ...
                    *(edi + ebx_1 - 4) = *edi
                    ...
                    sub_436930(eax_20, nullptr, edi, eax_20, &var_10, arg5)

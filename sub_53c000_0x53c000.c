...
BOOL __fastcallsub_53c000(char* arg1)
{
    // 第一条实际指令: void var_2c
    void var_2c
    int32_t eax_1 = __security_cookie ^ &var_2c
    RECT rect
    BOOL result = GetClientRect(*(data_1151ae8 + 0x24), &rect)
    ...
    if (right != 0 && bottom != 0)
        ...
        if (ecx != 0)
            BOOL* eax_3 = sub_48f5c0(ecx)
            result = *eax_3
            
            if (*result != right || *(result + 4) != bottom)
                int32_t* ecx_1 = *(arg1 + 8)
                (*(*ecx_1 + 0x84))(ecx_1, 0, 0, 0)
                int32_t* eax_5 = sub_4d2a30(*(arg1 + 0x10))
                int32_t* eax_6 = sub_53e610(data_1151ae8 + 0x38, eax_5)
                ...
                if (result == 0x887a0005 || result == 0x887a0007)
                    sub_53bf70(result, edx_2, arg1, result)
                    noreturn
                ...
                if (result s< 0)
                    ...
                    var_40_1 = 0x5dc
                label_53c197:
                    sub_489550(result, &data_5b2591, "SUCCEEDED(hr)", 
                        "d:\ax\trunk\ax2017\engine\windows\windowsdx11.cpp", var_40_1, 
                ...
                result = (*(*eax_10 + 0x24))(eax_10, 0, 0x60a280, &eax_6[7])
                ...
                *(*eax_3 + 4) = bottom
                ...
                if (ecx_11 != 0)
                    int32_t** eax_14 = sub_48f5c0(ecx_11)
                    sub_4d2ac0(eax_14)
                    **eax_14 = right
                    result = *eax_14
                    *(result + 4) = bottom

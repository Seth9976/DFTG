...
int128_t* __convention("regparm")sub_4f50d0(int32_t arg1, int32_t arg2, int32_t* arg3, int128_t* arg4)
{
    ...
    if (9.99999975e-06f f> _mm_cvtpd_ps(__andps_xmmxud_memxud(_mm_cvtps_pd(xmm0_46 - 0f), data_60cc80)))
        sub_489550(arg1, &data_5b2591, U"0", "d:\ax\trunk\ax2017\engine\mat4.cpp", 0x124, "Mat4Inverse")
    ...
    float var_68
    float* eax_1 = sub_4f4c40(&var_68, arg2, arg3, &var_68)

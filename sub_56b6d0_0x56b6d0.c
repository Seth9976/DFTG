...
char* __convention("regparm")sub_56b6d0(int32_t arg1, int32_t* arg2, void* arg3, uint32_t* arg4, int32_t arg5)
{
    ...
    do
        ...
        i_1 -= 1
    while (i != 1)
    uint32_t eax_3 = sub_561390(arg3)
    uint32_t eax_4 = sub_561390(arg3)
        ...
        if (eax_3 s>= 0 && eax_4 s>= 0)
            ...
            if (eax_4 == 0 || ecx_5 != 0)
                ...
                if (edi_2 s>= 0 && edi_2 s<= 0x1fffffff)
                    ...
                    if (sub_56b1c0(eax_12, eax_3, arg3, edi_4, ecx, ebx_1) == 0)
                        _free(ebx_1)
                        ebx_1 = nullptr
                    
                    *arg2 = eax_3
                    *arg4 = edi_4
                    return sub_5614d0(ecx, 4, ebx_1, *ecx, eax_3, edi_4)
    else if (*(arg3 + 0x20) != 0)
        goto label_56b75d

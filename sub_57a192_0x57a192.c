...
int32_tsub_57a192(void* arg1, void** arg2, int32_t* arg3, char* arg4)
{
    // 第一条实际指令: int32_t __saved_ebp_1 = 0x10
    int32_t __saved_ebp_1 = 0x10
    int32_t var_8 = 0x61bb70
    int32_t (* var_10)(int32_t* arg1, void* arg2, void* arg3) = __except_handler4
    TEB* fsbase
    struct _EXCEPTION_REGISTRATION_RECORD* ExceptionList = fsbase->NtTib.ExceptionList
    uint32_t __security_cookie_1 = __security_cookie
    int32_t var_8_3 = 0x61bb70 ^ __security_cookie_1
    int32_t __saved_ebp
    int32_t var_34 = __security_cookie_1 ^ &__saved_ebp
    int32_t* var_1c = &var_34
    void* const var_38_4 = &data_57a19e
    ...
    if (ecx != 0 && *(ecx + 8) != 0 && (edx_1 != 0 || *arg3 s< 0))
        ...
        label_57a209:
            ...
            *esi_1 = ___AdjustPointer(ecx_3, &arg4[8])
            ...
            sub_579a90(esi_1, *(arg1 + 0x18), *(arg4 + 0x14))
            ...
            sub_579a90(esi_1, ___AdjustPointer(ecx_5, &arg4[8]), *(arg4 + 0x14))

...
long double __convention("regparm")sub_4fd790(int32_t arg1, int32_t arg2, void* arg3, float arg4 @ xmm2, float* arg5)
{
    ...
    int32_t mxcsr
    int16_t x87control
    long double st0 = sub_59aa00(mxcsr, x87control, fconvert.d(fconvert.t(xmm0_4)))
    ...
    if (not(0f < xmm0_21))
        ...
        xmm1 = sub_41f140(4, xmm0_21, xmm0_14, xmm0_8)
        xmm0_21 = var_58_1.d
    else
        xmm1 = xmm0_8
    ...
    *arg5 = xmm1
    ...
    if (not(0 f< xmm0_21))
        ...
        xmm1_2 = sub_41f140(4, xmm0_21, xmm0_16, xmm0_10)
        xmm0_21 = var_58_1.d
    else
        xmm1_2 = xmm0_10
    ...
    if (xmm0_21 < 1f)
        arg5[2] = sub_41f140(4, xmm0_21, var_48.d, xmm0_12)
        return result

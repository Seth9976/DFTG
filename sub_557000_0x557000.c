...
LRESULT __convention("regparm")sub_557000(int32_t arg1, int32_t arg2, HWND arg3, LRESULT arg4)
{
        ...
        if (esi_1 != 0)
            ...
            switch (*(esi_1 + 0x14) - 4)
                case 0
                    ...
                    lpbi.d = arg3
                    lpbi:4.d = *edi_1
                    lpbi:8.d = sub_554060(*(esi_1 + 0x10))
                    lpbi:0xc.d = 0x6ced68
                    lpbi:0x10.d = 3
                    ...
                    if (ChooseColorA(&param0_1) != 0)
                        ...
                        sub_553d20(&var_324, 0x104, "%d,%d,%d")
                        _free(*(*(data_1511868 + 4) + 0x10))
                        *(*(data_1511868 + 4) + 0x10) = sub_553d60(&var_324)
                case 1
                    int32_t param0
                    ...
                    *(esi_1 + 0x10)
                    ...
                    if (ChooseFontA(&param0) != 0)
                        ...
                        _free(*(*(data_1511868 + 4) + 0x10))
                        sub_555630(&var_674)
                        *(*(data_1511868 + 4) + 0x10) = sub_553d60(&data_15168a8)
                case 2
                    void var_42c
                    ...
                    sub_48d8d0(&var_42c, edx, ecx_2, *(esi_1 + 8), 
                        "Title: %32[^\r\n] Path: %256[^\r\n] Filter: %256[^\r\n] Default Extension: %32[^\r"
                    "]")
                    void* ecx_3 = &var_42c
                    
                    if (__execvp("?", &var_42c) == 0)
                        ecx_3 = "Select file"
                    
                    if (__execvp("?", &var_114) != 0)
                        void* ecx_4 = &var_114
                        int32_t eax_18
                    ...
                    lpbi:0x1c.d = ecx_6
                    int32_t var_6f0_13 = *(*(data_1511868 + 4) + 0x10)
                    uint32_t (* ecx_7)[0x10][0x4]
                    
                    if (cond:2_1)
                        lpbi:0x14.d = &data_5b2591
                        _free(var_6f0_13)
                        ecx_7 = &data_5b2591
                    else
                    ...
                    *(*(data_1511868 + 4) + 0x10) = sub_553d60(ecx_7)
                    _free(*(*(data_1511868 + 4) + 8))
                    var_6ac
                    sub_5556b0(&var_6ac:4)
                    *(*(data_1511868 + 4) + 8) = sub_553d60(0x1517030)
                case 3
                    ...
                    if (SHGetMalloc(&ppMalloc) s>= 0)
                        ...
                        lpbi:4.d = var_694
                        lpbi:0x10.d = 5
                        lpbi:0x14.d = sub_5557f0
                        lpbi:0x18.d = esi_3
                        struct ITEMIDLIST* pidl = SHBrowseForFolderA(&lpbi)
                        
                        if (pidl == 0)
                            _memset(&data_1516f28, 0, 0x104)
                        else
                            SHGetPathFromIDListA(pidl, &data_1516f28)
                    ...
                    _free(*(*(data_1511868 + 4) + 0x10))
                    *(*(data_1511868 + 4) + 0x10) = sub_553d60(&data_1516f28)

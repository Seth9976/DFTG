...
int128_t* __convention("regparm")sub_4c98a0(int32_t arg1, int32_t arg2, int32_t* arg3, float arg4 @ xmm1, int128_t* arg5, int128_t* arg6)
{
    // 第一条实际指令: arg4 - 1f
    arg4 - 1f
    int32_t esi = arg2
        ...
        do
            ...
            if (*(eax + 4) == 6)
                ...
                if (not(0 f< xmm0_7))
                    ...
                    xmm3 = sub_41f140(4, xmm0_7, (zx.o(0)).d, 1f)
                else
                    xmm3 = 1f

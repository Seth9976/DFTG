...
char** __convention("regparm")sub_50a860(int32_t arg1, int32_t arg2, char** arg3, void* arg4)
{
    // 第一条实际指令: int32_t var_8 = 0xffffffff
    int32_t var_8 = 0xffffffff
    int32_t (* var_c)(void* arg1) = sub_5a1b7a
    TEB* fsbase
    ...
    int32_t var_8_1 = 0
    int32_t var_20 = 0
    sub_48a9d0(arg3, "samplerFn_layer%d")
    int32_t var_8_2 = 0
    char* arg_4
    char* edi = arg_4
    int32_t var_20_1 = 1
    char* var_28
    sub_50a700(&edi[0x34], arg2, &var_28, &edi[0x34], arg4)
    int32_t var_8_3 = 1
    int32_t esi_1 = 0
    ...
    if (esi_1 s> 0)
        ...
        char* eax_7 = *sub_48a9d0(&var_1c, &data_5efc90)
        
        if (eax_7 != 0)
            ecx_3 = eax_7
        
        sub_48a670(&arg_4, ecx_3)
        var_8_3.b = 4
    ...
    char* var_18
    char** eax_10 = sub_50a790(&var_18, edi)
    char* const var_24 = &data_5b2591
    var_8_3.b = 6
    
    if (*(edi + 0x1c) != 0)
        sub_489550(eax_10, &data_5b2591, "Halt", "d:\ax\trunk\ax2017\engine\materialfndef.cpp", 0x2f4, 
            "EmitTextureFn")
    ...
    char* const var_14
    sub_48a9d0(&var_14, "float4 %s(float2 arg_uv)\n{\n%s\n%s\n%s}\n")
    var_8_3.b = 0xb
    int32_t eax_19 = *(arg4 + 0x104)
    void* ebx_2 = arg4 + (eax_19 << 3)
    *(arg4 + 0x104) = eax_19 + 1
    sub_48a560(ebx_2 + 4, arg3)
    sub_48a560(ebx_2 + 8, &var_14)
    var_8_3.b = 0xc
    char* esi_4 = arg_4

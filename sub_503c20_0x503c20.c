...
float* __convention("regparm")sub_503c20(int32_t arg1, int32_t* arg2, float* arg3, float* arg4, int32_t* arg5, float arg6, int32_t* arg7)
{
    ...
    if (p_1)
        ...
        var_18 = sub_41f120(xmm0_6)
        double* eax_1
        float xmm0_9
        eax_1, xmm0_9 = sub_41f100(xmm0_6)
        xmm2 f- 0
        var_14 = xmm0_9
        eax_1:1.b =
    ...
    *arg3 = xmm2_15 f* var_a0.d + xmm1_21 f* xmm0_40.d + xmm3_13 * xmm1_16 + xmm2_18 * 0f
    ...
    float xmm1_41 = __shufps_xmmps_memps_immb(data_60cb20, data_60cb20, 0x55)
    ...
    float xmm7_7 = __shufps_xmmps_memps_immb(data_60cb20, data_60cb20, 0xaa)

...
float __convention("regparm")sub_5044a0(int32_t arg1, float* arg2, int64_t* arg3, float* arg4, float* arg5, float* arg6, float arg7)
{
    ...
    int64_t* eax_4
    int32_t edx
    eax_4, edx = sub_482720(&var_4c, arg2, &var_28, &var_4c)
    float xmm2_2 = arg4[4]
    float xmm3_3 = arg4[5]
    float xmm1_3 = arg4[3]
    ...
    int64_t* eax_8
    int32_t edx_1
    eax_8, edx_1 = sub_482720(&var_4c, edx, &var_28, &var_4c)
    ...
    if (arg2 != 0)
        ...
        int64_t* eax_12
        int32_t edx_2
        eax_12, edx_2 = sub_482720(&var_4c, edx_1, &var_1c, &var_4c)
        ...
        int64_t* eax_16
        eax_16, edx_1 = sub_482720(&var_4c, edx_2, &var_1c, &var_4c)
        var_3c = *eax_16
        var_34_1 = eax_16[1].d
    ...
    if (arg6 != 0)
        ...
        int64_t* eax_21
        int32_t edx_3
        eax_21, edx_3 = sub_482720(&var_4c, edx_1, &var_1c, &var_4c)
        ...
        int64_t* eax_25 = sub_482720(&var_4c, edx_3, &var_1c, &var_4c)

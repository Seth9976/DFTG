...
int128_t* __convention("regparm")sub_4f2e20(int32_t arg1, int32_t* arg2, float* arg3, int32_t* arg4, int32_t arg5, int32_t arg6, int32_t arg7, int32_t arg8)
{
    // 第一条实际指令: float var_298
    float var_298
    int32_t eax_1 = __security_cookie ^ &var_298
    int32_t* edi = arg4
    int128_t* result = *edi * 0xd8
    int32_t* var_22c = edi
    ...
    if (9.99999975e-06f f> _mm_cvtpd_ps(__andps_xmmxud_memxud(_mm_cvtps_pd(xmm7_12), data_60cc80)))
    label_4f4819:
        @__security_check_cookie@4(eax_1 ^ &var_298)
        return result
    
    void var_a0
    int128_t* eax_4 = sub_4f50d0(&var_a0, arg2, ecx_3, &var_a0)
        ...
        while (true)
            ...
            if (xmm2_39 <= 9.99999975e-06f)
                ...
                if (not(xmm2_43 <= 9.99999975e-06f))
                    float xmm0_199
                    eax_10, xmm0_199 = sub_41dbe0(xmm2_39)
                    float var_210
                    float xmm0_203
                    ...
                    if (not(xmm0_199 <= 9.99999975e-06f))
                        ...
                        eax_10, xmm0_203 = sub_41dbe0(xmm2_43)
                    ...
                    label_4f4822:
                        ...
                        var_2ac_1 = "d:\ax\trunk\ax2017\engine\vec3.cpp"
                        break
                    ...
                    var_210 = xmm0_206.d
                    var_20 = xmm0_206
                    float xmm5_39[0x4] = *sub_4f4aa0(&var_b0, &var_20, &var_30, &var_b0)
            ...
            if (ecx_7 == *edi)
                ...
                float xmm0_357
                eax_10, xmm0_357 = sub_41dbe0(xmm3_47 * xmm3_47 + xmm4_54 * xmm4_54 + xmm6_36 * xmm6_36)
                ...
                float xmm0_366
                eax_10, xmm0_366 =
                    sub_41dbe0(var_280_7 * var_280_7 + var_290_9 * var_290_9 + var_28c_7 * var_28c_7)
                ...
                float xmm2_83 = 1f / (
                    sub_41dbe0(xmm3_55 * xmm3_55 + xmm2_82 * xmm2_82 + xmm4_67 * xmm4_67)
                    + 9.99999975e-06f)
                float var_28_4 = xmm2_83 * xmm4_67
                var_30 = _mm_unpacklo_ps(xmm2_83 * xmm2_82, xmm2_83 * xmm3_55)
                int128_t xmm0_381 = *sub_41de50(&var_b0, 0x5d22a0, 0x5d22ac, &var_b0, &var_20, &var_30)
                result = edi[arg5 - 1] * 0x2c
                *(result + arg7) = xmm0_381
                goto label_4f4819
            
            ecx_7 = *(ecx_7 * 0xd8 + arg6 + 0x6c)
    else
        while (true)
            if (edx != 0)
                eax_10 = edi[edx - 1]
                bool cond:1_1 = eax_10 != *(edi[edx] * 0xd8 + arg6 + 0x6c)
                edi = var_22c
                
                if (cond:1_1)
                    var_2a4_3 = &data_5fb3fc
                    var_2a8_1 = 0x514
                    var_2ac_1 = "d:\ax\trunk\ax2017\engine\animation.cpp"
    ...
    sub_489550(eax_10, &data_5b2591, ecx_10, var_2ac_1, var_2a8_1, var_2a4_3)

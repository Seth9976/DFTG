...
void* __fastcallsub_500040(void* arg1, int32_t arg2)
{
    // 第一条实际指令: int32_t i = 0
    int32_t i = 0
    void* ecx = nullptr
    ...
    if (ecx s> 0)
        int32_t esi_1 = 0
        uint32_t temp1_1 = modu.dp.d(0:(sub_48dd80()), var_8)
        result = nullptr
    ...
    sub_489550(result, &data_5b2591, ecx_10, "d:\ax\trunk\ax2017\engine\particle.cpp", var_24, 

...
int32_t* __convention("regparm")sub_534ae0(int32_t arg1, char* arg2, void* arg3, int32_t arg4)
{
    // 第一条实际指令: int32_t var_8 = 0xffffffff
    int32_t var_8 = 0xffffffff
    int32_t (* var_c)(void* arg1) = sub_5a2933
    TEB* fsbase
    ...
    do
        if (i u> 5)
            sub_489550(eax_3, &data_5b2591, "Halt", "d:\ax\trunk\ax2017\engine\iblimport.cpp", 0x228, 
                "HDRCubeToIrradiance")
        ...
        void var_78
        int128_t* eax_7 = sub_51b1b0(&var_44, &var_24c, &var_78, &var_44, &var_38)
        int32_t ecx_1 = *(edi + 8)
        int32_t var_354_1 = 0
        int32_t* eax_8 = sub_4d2c50(eax_7, ecx_1, ecx_1, *(edi + 0xc), 3)
        void* edx_2 = data_114ec70
        var_2c[i] = eax_8
        *(edx_2 + 0x24c) += 1
        int32_t eax_10 = *(edx_2 + 0x24c) * 5
        *(edx_2 + (eax_10 << 2) + 0x10c) = 2
        *(edx_2 + (eax_10 << 2) + 0x114) = eax_8
        *(edx_2 + (eax_10 << 2) + 0x118) = 0
        *(edx_2 + (eax_10 << 2) + 0x11c) = 0
        sub_4ded00(eax_10, 0, eax_8, 0)
        
        if (data_aca614 != 0)
            data_aca614 = 0
            sub_4924f0(&data_aca234)
        
        (*(*data_114ec78 + 0x8c))(0xffff0000)
        int32_t var_5c
        ...
        void var_33c
        int128_t* eax_13 = sub_4dab70(&var_33c)
        ...
        void var_2fc
        int128_t var_2ac = *sub_4829a0(&var_2fc, &var_240, &data_5d27f8, &var_2fc)
        ...
        float* eax_17 = sub_497e60(&var_33c, &data_aca2bc, &data_aca37c, &var_33c)
        data_aca2fc = *eax_17
        data_aca30c = *(eax_17 + 0x10)
        data_aca31c = *(eax_17 + 0x20)
        data_aca32c = *(eax_17 + 0x30)
        float* eax_19 = sub_497e60(&var_33c, &data_aca37c, &data_aca3fc, &var_33c)
        data_aca3bc = *eax_19
        data_aca3cc = *(eax_19 + 0x10)
        data_aca3dc = *(eax_19 + 0x20)
        data_aca3ec = *(eax_19 + 0x30)
        float* eax_21 = sub_497e60(&var_33c, &data_aca2fc, &data_aca3fc, &var_33c)
        data_aca33c = *eax_21
        data_aca34c = *(eax_21 + 0x10)
        data_aca35c = *(eax_21 + 0x20)
        void* ThreadLocalStoragePointer = fsbase->ThreadLocalStoragePointer
        data_aca36c = *(eax_21 + 0x30)
        void* esi = *ThreadLocalStoragePointer
        
        if (data_15167d8 s> *(esi + 4))
            __Init_thread_header(&data_15167d8)
            
            if (data_15167d8 == 0xffffffff)
                int32_t var_8_1 = 0
                data_15167dc = sub_4d0b50("sys/skybox.structure", 2)
                int32_t var_8_2 = 0xffffffff
                __Init_thread_footer(&data_15167d8)
        
        int32_t eax_24 = data_15167e0
        
        if (eax_24 s> *(esi + 4))
            eax_24 = __Init_thread_header(&data_15167e0)
            
            if (data_15167e0 == 0xffffffff)
                int32_t var_8_3 = 1
                data_15167e4 = sub_4d0b50("sys/pbr/ibl_irradiance.material", 5)
                int32_t var_8_4 = 0xffffffff
                eax_24 = __Init_thread_footer(&data_15167e0)
        
        int32_t* ecx_6 = data_15167dc
        ...
        int32_t* eax_26 = sub_4981f0(ecx_6)
        int32_t** var_22c_1 = eax_26
        
        if (*eax_26 == 0)
            sub_489550(eax_26, &data_5b2591, "pDefStructure->pStructureImportData", 
                "d:\ax\trunk\ax2017\engine\iblimport.cpp", 0x24c, "HDRCubeToIrradiance")
        ...
        if (*edi_2 s> 0)
            do
                ...
                int32_t var_1dc_1 = data_15167e4
                int32_t var_220_1 = j * 0x150 + edi_2[2]
                ...
                "3f\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x80\x
                        3f", 
                    0x40)
                int128_t var_194_1 = data_5d2464
                
                if (j == 0)
                    j = sub_48f690(&var_224)
    ...
    if (arg2 == 0)
        sub_489550(arg2, &data_5b2591, "str", "d:\ax\trunk\ax2017\engine\xstring.cpp", 0x94, 
            "XString::XString")
    ...
    int32_t eax_34
    int32_t ecx_11
    eax_34, ecx_11 = sub_48a670(&i_1, "_irr")
    int32_t var_34c_3 = 1
    int32_t* result = sub_533d90(eax_34, &var_2c, ecx_11)
    sub_4d1720(result)
    sub_4d0720(result)
    int32_t var_8_6 = 3

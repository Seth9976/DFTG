...
void* __fastcallsub_50eca0(HDC arg1)
{
    ...
    if (i_1 != 0)
        int32_t var_a0
        GetWindowRect(GetDlgItem(data_1151080, 0x80), &var_a0)
        ScreenToClient(data_1151080, &var_a0)
        POINT point
        ...
        do
            sub_50d3a0(&i_4, _mm_cvtepi32_ps(zx.o(i)) * xmm0_4 / 5f f+ data_1151094)
            int32_t var_14_1 = 0
            char* lpString_1 = i_4
        ...
        if (edx_5 s>= 0)
            do
                ...
                do
                    ...
                    float xmm0_12 = sub_41f140(esi_8, xmm0_11, xmm3_1, xmm6_1)
                    float xmm0_14 = sub_41f140(esi_8, xmm0_11, var_58_2, xmm0_7)
                    float xmm0_16 = sub_41f140(esi_8, xmm1_10, xmm3_1, var_5c_2)
                    float xmm0_18 = sub_41f140(esi_8, xmm1_10, var_58_2, xmm0_7)
                    float xmm1_15 = data_1151094
                    float xmm0_20 = data_1151090 - xmm1_15
                    uint128_t xmm2_10 = *sub_50cd80(&var_b0)
                    ...
                    float xmm1_18 = data_1151094
                    float xmm0_34 = data_1151090 - xmm1_18
                    uint128_t xmm2_12 = *sub_50cd80(&var_a0)
                    ...
                    float xmm1_21 = data_1151094
                    float xmm0_48 = data_1151090 - xmm1_21
                    void var_c0
                    uint128_t xmm2_14 = *sub_50cd80(&var_c0)
                    ...
                    float xmm1_24 = data_1151094
                    float xmm0_62 = data_1151090 - xmm1_24
                    void var_d0
                    uint128_t xmm2_16 = *sub_50cd80(&var_d0)
        ...
        if (edx_5 s> 0)
            do
                ...
                int32_t eax_43
                int32_t edx_8
                eax_43, edx_8 = sub_50cdf0(i_1, edx_5.b)
                char* i_6 = i_4
                COLORREF color
                
                if (data_1151088 == i_6 && data_115108c != 0)
                    color = 0x6464ff
                else if (data_1151084 != i_6)
                    color = 0x808080
                else
                    color = 0xc8
                ...
                int32_t eax_51
                int32_t edx_11
                eax_51, edx_11 = sub_50cdf0(i_4, 0)
                char* i_7 = i_4
                COLORREF color_1
                
                if (data_1151088 == i_7 && data_115108c == 0)
                    color_1 = 0x6464ff
                else if (data_1151084 != i_7)
                    color_1 = 0x808080
                else
                    color_1 = 0xc8

...
LRESULT __stdcallsub_554980(HWND arg1, uint32_t arg2, WPARAM arg3, LPARAM arg4)
{
    // 第一条实际指令: data_1511868 = GetPropA(GetParent(GetParent(arg1)), "lpInsData")
    data_1511868 = GetPropA(GetParent(GetParent(arg1)), "lpInsData")
    ...
    if (arg2 == 8)
        sub_553f00(ShowWindow(arg1, SW_HIDE), arg3)
    else if (arg2 != 0x20a)
        if (arg2 == 0x87)
            return 4

...
int32_tsub_540d40(int32_t arg1 @ esi, float arg2 @ xmm2, int32_t arg3, int32_t* arg4)
{
    // 第一条实际指令: void* const __return_addr_1 = __return_addr
    void* const __return_addr_1 = __return_addr
    int32_t var_14 = 0xffffffff
    int32_t (* var_18)(void* arg1) = sub_5a2feb
    TEB* fsbase
    ...
    uint32_t (* eax_6)[0x4] = sub_498490(eax_5)
    int32_t esi_1 = *(ecx + 4)
    void* var_8068 = nullptr
    int32_t var_8084_1 = 0
    int32_t var_8080_1 = eax_4
    uint32_t (* eax_8)[0x4] = sub_498490(esi_1 * 0x18)
    void* ecx_4 = ecx
    int32_t edx_1 = 0
    edi[2] = esi_1
    void* esi_2 = nullptr
    *edi = eax_8
    ...
    if (eax_9 s> 0)
        ...
        while (true)
            if (esi_2 s< 0 || edi_1 s>= eax_9)
                sub_489550(eax_9, &data_5b2591, "index >= 0 && index < mSize", 
                    "d:\ax\trunk\ax2017\engine\xarray.h", 0xb5, "XArray<struct PackAsset>::operator []")
            ...
            if (eax_10 == 3)
                if (var_8068 s>= eax_4)
                    sub_489550(var_8068, &data_5b2591, "mSize < mSizeReserved", 
                        "d:\ax\trunk\ax2017\engine\xarray.h", 0xa1, "XArray<struct stbrp_rect>::Alloc")
                ...
                float eax_24
                float edx_7
                eax_24, edx_7 = sub_48f600(ecx_5)
                int32_t esi_5 = int.d(sub_4827e0(eax_24 + 0.5f))
                float xmm1_4 = 1f / arg2
                int32_t eax_25 = int.d(sub_4827e0(edx_7 + 0.5f))
                float xmm0_20 = _mm_cvtepi32_ps(zx.o(esi_5))
                float xmm2_5 = _mm_cvtepi32_ps(zx.o(eax_25)) * xmm1_4
                int16_t esi_6 = (int.d(sub_4827e0(xmm0_20 * xmm1_4 + 0.5f))).w
                int16_t eax_26 = (int.d(sub_4827e0(xmm2_5 + 0.5f))).w
                ...
                *(&(*eax_6)[edi_3 * 2] - 0xa) = eax_26 + (arg3 << 1).w
                ...
                if (eax_10 != 0x12)
                    sub_489550(eax_10, &data_5b2591, "Halt", 
                        "d:\ax\trunk\ax2017\engine\editor\atlasmaker.cpp", 0x47b, "AtlasMakerCalcRects")
                ...
                void var_80b0
                uint128_t xmm1_1 = *sub_540820(&var_80b0, *(esi_2 + edx_2 + 4), ecx_5, &var_80b0, 
                    *(esi_2 + edx_2 + 8), arg4)
                int32_t* eax_16 = ecx
                ...
                if (edi_1 s>= eax_16[1])
                    sub_489550(eax_16, &data_5b2591, "index >= 0 && index < mSize", 
                        ...
                        "XArray<struct PackAsset>::operator []")
                ...
                *(eax_17 + esi_2 + 0xc) = xmm1_1
                ...
                int16_t esi_3 = (int.d(sub_4827e0(xmm0_6 * xmm1_3 + 0.5f))).w
                int16_t eax_21 = (int.d(sub_4827e0(xmm2_2 + 0.5f))).w + (arg3 << 1).w
                edx_1 = eax_12 << 4
    ...
    while (true)
        ...
        void var_8058
        sub_53e6b0(&var_8028, edx_1, &var_8058, ecx_4)
        int32_t eax_29
        eax_29, edx_1 = sub_53eb00(0xffff, eax_6, &var_8058, esi_2)
        ecx_4 = nullptr
        int32_t eax_30 = 0
        ...
        if (esi_2 s> 0)
            ...
            while (true)
                if (eax_30 s< 0 || eax_30 s>= var_8068)
                    sub_489550(eax_30, &data_5b2591, "index >= 0 && index < mSize", 
                        "d:\ax\trunk\ax2017\engine\xarray.h", 0xb5, 
                        "XArray<struct stbrp_rect>::operator []")
                ...
                if (*(edx_1 + 4) == 0)
                    ...
                    *var_8070_1 = *(edx_1 - 8)
                    ...
                    if (eax_31 s>= edi[2])
                        sub_489550(eax_31, &data_5b2591, "mSize < mSizeReserved", 
                            "d:\ax\trunk\ax2017\engine\xarray.h", 0xa1, "XArray<struct PackLoc>::Alloc")

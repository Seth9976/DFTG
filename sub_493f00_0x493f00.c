...
int32_t __convention("regparm")sub_493f00(int32_t arg1, float* arg2, float* arg3, int128_t* arg4)
{
    ...
    float eax_3 = esi[3]
    sub_490370(eax_3, data_126cc38, 0x40, *(esi + 4), eax_3, eax_2)
    int32_t eax_4 = data_114a77c
    int32_t ebx = 0
    int32_t var_7c = 0
    data_114a77c = eax_4 + 0x40
    int32_t result = 0
    int32_t result_1 = 0
    ...
    while (true)
        ...
        float xmm0_7 = sub_41f100(xmm1_4) * *esi
        float xmm0_10 = sub_41f100(xmm0_4) * *esi
        int32_t edi = 0
        float xmm0_12 = sub_41f120(xmm1_4)
        float xmm0_14 = sub_41f120(xmm0_4)
        void* esi_2 = eax_4 * 0xa0 + 0xc4a794 + ebx * 0xa0
        
        while (true)
            float xmm1_8 = _mm_cvtepi32_ps(zx.o(edi)) * 0.125f * 6.28318548f
            float xmm0_18 = _mm_cvtepi32_ps(zx.o(edi + 1)) * 0.125f * 6.28318548f
            float xmm0_21 = sub_41f100(xmm1_8) * *var_84
            float xmm0_24 = sub_41f100(xmm0_18) * *var_84
            float xmm0_27 = sub_41f120(xmm1_8) * *var_84
            float xmm0_29 = sub_41f120(xmm0_18)
            ...
            if (result_1 != 0)
                ...
                var_4c_6 = xmm7_15
                xmm1_31 = 1f / (sub_41dbe0(xmm7_15 * xmm7_15 + xmm4_36 * xmm4_36 + xmm5_15 * xmm5_15)
                    + 9.99999975e-06f)
                ...
                var_4c_6 = xmm7_12
                xmm1_31 = 1f / (sub_41dbe0(xmm7_12 * xmm7_12 + xmm2_9 * xmm2_9 + xmm3_9 * xmm3_9)
                    + 9.99999975e-06f)
            ...
            if (ebx s>= 0x40)
                ...
                int32_t var_138_1 = 0x6ae
                var_140_1:4.d = "d:\ax\trunk\ax2017\engine\draw3d.cpp"
                sub_489550(eax_13, &data_5b2591, "quadIndex < totalQuads")
            ...
            do
                ...
                *(esi_2 - 4) = xmm4_40
                var_140_1.o = *arg4
                int32_t eax_16 = sub_497d80(var_140_1)
                edi_4 += 0xc
                *(esi_2 + 4) = 0
                *(esi_2 + 8) = 0x3f000000

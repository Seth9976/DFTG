...
int32_t __fastcallsub_540a20(int32_t* arg1, int32_t* arg2)
{
    // 第一条实际指令: void* const __return_addr_1 = __return_addr
    void* const __return_addr_1 = __return_addr
    int32_t var_14 = 0xffffffff
    int32_t (* var_18)(void* arg1) = sub_5a2fc0
    TEB* fsbase
        ...
        while (true)
            if (ecx s< 0 || ecx s>= result)
                sub_489550(result, &data_5b2591, "index >= 0 && index < mSize", 
                    "d:\ax\trunk\ax2017\engine\xarray.h", 0xc3, "XArray<struct XAsset *>::operator []")
            ...
            if (eax_4 == 3)
                ...
                if (eax_15 s>= arg2[2])
                    sub_489550(eax_15, &data_5b2591, "mSize < mSizeReserved", 
                        "d:\ax\trunk\ax2017\engine\xarray.h", 0x96, "XArray<struct PackAsset>::Append")
                ...
                *(eax_16 + (ecx_9 << 2) + 0x18) = 0
                ...
                if (eax_4 != 0x12)
                    sub_489550(eax_4, &data_5b2591, "Halt", 
                        "d:\ax\trunk\ax2017\engine\editor\atlasmaker.cpp", 0x453, 
                        "AtlasMakerCalcImages")
                ...
                int32_t* var_28
                sub_4889e0(&var_28, edi_1, 0x12)
                int32_t var_14_1 = 0
                void* eax_5 = var_34
                
                if (*(eax_5 + 0x14) == 0)
                    sub_489550(eax_5, &data_5b2591, "pDefFont->layerCount", 
                        "d:\ax\trunk\ax2017\engine\editor\atlasmaker.cpp", 0x40b, "GlyphCount")
                ...
                if (ecx_3 == 0)
                    sub_489550(eax_9, &data_5b2591, "pDefFont->layerCount", 
                        "d:\ax\trunk\ax2017\engine\editor\atlasmaker.cpp", 0x413, "GlyphLayerCount")
                    ...
                    do
                        ...
                        if (eax_11 s> 0)
                            ...
                            do
                                ...
                                if (eax_12 s>= arg2[2])
                                    sub_489550(eax_12, &data_5b2591, "mSize < mSizeReserved", 

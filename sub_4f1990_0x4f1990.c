...
int32_t __convention("regparm")sub_4f1990(int32_t arg1, int32_t arg2, int32_t* arg3, float arg4 @ xmm1, int128_t* arg5)
{
    ...
    int32_t result
    float xmm0_3
    result, xmm0_3 = sub_4f56c0(&var_10, esi_1, _mm_cvtepi32_ps(zx.o(esi_1)) * arg4)
    float xmm3 = xmm0_3
    float xmm0_4 = var_10
    float xmm0_5
        ...
        if (ecx_3 s< arg3[4])
            ...
            if (10000f f<= edx_4[3] || 10000f f<= *edx_4 || 10000f f<= edx_4[1] || 10000f f<= edx_4[2]
                ...
                if (10000f f<= *(result + 0xc) || 10000f f<= *result || 10000f f<= *(result + 4)
                    ...
                    result = sub_4f5500(result, edx_4, arg5, xmm3, result)
    ...
    sub_489550(result, &data_5b2591, ecx_4, "d:\ax\trunk\ax2017\engine\animation.cpp", var_24, 

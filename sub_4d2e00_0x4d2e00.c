...
int32_t* __convention("regparm")sub_4d2e00(int32_t arg1, float* arg2, int32_t* arg3, float* arg4)
{
    ...
    if (edi != 0)
        ...
        if (ecx != 0)
            ...
            if (edi[0xc] != 1)
                int32_t* ecx_5 = *sub_48f5c0(ecx)
                
                if (edi[0xc] == ecx_5[0xc])
                    int32_t eax_6 = *ecx_5
                    float xmm2 = float.s(edi[0xe])
                    float xmm4 = float.s(edi[0xd])
                    int32_t eax_8 = ecx_5[1]
                    float xmm3 = _mm_cvtpd_ps(float.d(eax_6) f+ *((eax_6 u>> 0x1f << 3) + &data_60cbc0))
                    float xmm7_1 = xmm4 / xmm3
                    int32_t eax_10 = edi[1]
                    float xmm1 = _mm_cvtpd_ps(float.d(eax_8) f+ *((eax_8 u>> 0x1f << 3) + &data_60cbc0))
                    float xmm6_1 = xmm2 / xmm1
                    int32_t eax_12 = *edi
                    float xmm5_3 = (
                        _mm_cvtpd_ps(float.d(eax_10) f+ *((eax_10 u>> 0x1f << 3) + &data_60cbc0))
                        + xmm2) / xmm1 - xmm6_1
                    float xmm1_4 = (
                        _mm_cvtpd_ps(float.d(eax_12) f+ *((eax_12 u>> 0x1f << 3) + &data_60cbc0))
                        + xmm4) / xmm3 - xmm7_1
            ...
            sub_4892e0(var_1c_1)
            sub_4d0ff0(sub_4d0720(arg3), 1, arg3, 0)

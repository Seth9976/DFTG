...
int32_t?convert_decimal_string_to_floating_type_common@__crt_strtox@@YA?AW4SLD_STATUS@@ABUfloating_point_string@1@ABVfloating_point_value@1@@Z(int32_t* arg1, int32_t* arg2)
{
        ...
        if (ecx_4 == 0)
            ...
            if (eax_17 != 0)
                ...
                do
                    ...
                    uint32_t ecx_8 = zx.d(*((eax_17 << 2) + &data_5aa526))
                    uint32_t esi_2 = zx.d(*((eax_17 << 2) + &data_5aa527))
                    uint32_t eax_18 = esi_2 + ecx_8
                    _memset(&var_914, 0, ecx_8 << 2)
                    sub_579300(&(&var_914)[ecx_8], 
                        (zx.d(*((eax_17 << 2) + &data_5aa524)) << 2) + &data_5a9c20, esi_2 << 2)
                    uint32_t eax_25
            ...
            if (ecx_7 == 0)
                ...
                int32_t edi_7 = *((ecx_7 << 2) + &data_5aa5bc)
    ...
    if (eax_49 != 0)
        ...
        do
            ...
            uint32_t ecx_19 = zx.d(*((eax_49 << 2) + &data_5aa526))
            uint32_t esi_8 = zx.d(*((eax_49 << 2) + &data_5aa527))
            uint32_t eax_50 = ecx_19 + esi_8
            _memset(&var_914, 0, ecx_19 << 2)
            sub_579300(&(&var_914)[ecx_19], 
                (zx.d(*((eax_49 << 2) + &data_5aa524)) << 2) + &data_5a9c20, esi_8 << 2)
            uint32_t eax_57
            char* var_b48_10
    ...
    int32_t edi_14 = *((ecx_18 << 2) + &data_5aa5bc)
    int32_t result
        ...
        if (ecx_29 u>= ((eax_2 - 1) & 0x1d) + 0x19 || eax_83 == 0)
                ...
                if (ecx_30 != 0)
                    ...
                    if (eax_91 != 0)
                        ...
                        do
                            ...
                            uint32_t ecx_34 = zx.d(*((eax_91 << 2) + &data_5aa526))
                            uint32_t esi_14 = zx.d(*((eax_91 << 2) + &data_5aa527))
                            uint32_t eax_92 = ecx_34 + esi_14
                            _memset(&var_914, 0, ecx_34 << 2)
                            sub_579300(&(&var_914)[ecx_34], 
                                (zx.d(*((eax_91 << 2) + &data_5aa524)) << 2) + &data_5a9c20, 
                                esi_14 << 2)
                            uint32_t eax_99
                    ...
                    if (ecx_33 != 0)
                        int32_t edi_23 = *((ecx_33 << 2) + &data_5aa5bc)
            ...
            if (eax_122 != 0)
                while (true)
                    ...
                    uint32_t ecx_42 = zx.d(*((ebx_16 << 2) + &data_5aa526))
                    uint32_t esi_17 = zx.d(*((ebx_16 << 2) + &data_5aa527))
                    uint32_t eax_123 = ecx_42 + esi_17
                    _memset(&var_914, 0, ecx_42 << 2)
                    sub_579300(&(&var_914)[ecx_42], 
                        (zx.d(*((ebx_16 << 2) + &data_5aa524)) << 2) + &data_5a9c20, esi_17 << 2)
                    uint32_t eax_129
            ...
            label_584476:
                ...
                void* eax_146 = *((edx_52 << 2) + &data_5aa5bc)

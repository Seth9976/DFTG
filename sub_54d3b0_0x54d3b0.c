...
double* __fastcallsub_54d3b0(int32_t* arg1, int32_t* arg2)
{
    ...
    int64_t* eax_4
    int32_t edx
    eax_4, edx = sub_482720(&var_64, arg2, &var_14, &var_64)
    float eax_5 = eax_4[1].d
    var_14 = *eax_4
    float var_3c
    int64_t* eax_7
    int16_t x87control
    eax_7, x87control = sub_482720(&var_3c, edx, &data_5d22f4, &var_3c)
    ...
    float xmm0_20 = sub_41f120(xmm0_19)
    float xmm1_10 = xmm0_20 * 0f
    float xmm0_22 = sub_41f100(xmm0_19)
    ...
    float xmm0_41 =
        sub_41dbe0(xmm1_19 * xmm1_19 + xmm7_4 * xmm7_4 + xmm3_4 * xmm3_4 + xmm2_10 * xmm2_10)
    ...
    *arg1 = var_3c.o
    ...
    float xmm0_56 = sub_41f120(xmm0_55)
    ...
    double* result
    float xmm0_58
    result, xmm0_58 = sub_41f100(xmm0_55)
    float xmm7_5 = arg1[1]

...
LRESULT __stdcallsub_555180(HWND arg1, uint32_t arg2, HWND arg3, LPARAM arg4)
{
    // 第一条实际指令: void var_2c
    void var_2c
    ...
    GetClassNameA(hWnd_4, &data_1517340, 0x104)
    uint32_t eax_5 = __Cnd_wait(&data_1517340, "Edit")
    int32_t ecx
    ecx.b = eax_5 == 0
    HWND hWnd
    ...
    if (arg2 == 8)
        if (hWnd_4 != GetParent(arg3))
            sub_553f00(SendMessageA(hWnd_4, 0x102, 0xd, 0), arg3)
        ...
        if (arg2 != 0x111)
            ...
            if (arg2 == 0x102)
                if (wParam == 0xd)
                    if (*(eax_7 + 4) != 0)
                        GetWindowTextA(hWnd_4, &data_1517340, 0x104)
                        _free(*(*(data_1511868 + 4) + 0x10))
                        *(*(data_1511868 + 4) + 0x10) = sub_553d60(&data_1517340)
            ...
            if (GetPropA(edi, "Wprc") == 0)
                GetClassNameA(edi, &data_1517340, 0x104)
                
                if (__Cnd_wait(&data_1517340, "Edit") == 0)
                    SetPropA(edi, "Wprc", GetWindowLongA(edi, 0xfffffffc))
                    SetWindowLongA(edi, 0xfffffffc, sub_555180)
        ...
        if (ecx == 0)
            ...
            sub_553f50(eax_13, &rect, hDC, 3, eax_13)
            int32_t var_18
            int32_t var_18_1 = var_18 + 1
            rect += 1
            uint32_t eax_14 = GetSysColor(COLOR_WINDOW)
            sub_553f50(eax_14, &rect, hDC, 3, eax_14)

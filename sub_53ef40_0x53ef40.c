...
int32_t __convention("regparm")sub_53ef40(int32_t arg1, int32_t arg2, int32_t arg3, int32_t* arg4, int32_t* arg5)
{
        ...
        while (true)
            if (ecx != 0)
                ...
                if (ecx != 0)
                    ...
                    arg4[5] -= 1
                    sub_4984f0(var_6c, 0x10)
                    int32_t xmm0_4 = _mm_bsrli_si128(var_30_1, 8)
                    int32_t* eax_8 = sub_498440(0x10)
                    eax_8[3] += 1
                    ...
                    *ecx_10 = xmm0_4
                    ...
                    int32_t* eax_14 = sub_498440(0x10)
                    eax_14[3] += 1
                    ...
                    *ecx_12 = var_58_1
                    ...
                    arg4[5] += 1
                    arg4[4] = ecx_12
                    uint128_t** eax_20 = sub_498440(0x18)
                    eax_20[3] += 1

...
LRESULT __stdcallsub_559050(HWND arg1, uint32_t arg2, WPARAM arg3, HWND arg4)
{
    // 第一条实际指令: HWND var_e8
    HWND var_e8
    ...
    if (Msg_1 u<= 0x18)
        if (Msg_1 == 0x18)
            if (wParam_11 == 0)
                ...
                SendMessageA(*(data_1511868 + 0x20), 0x102, 0xd, 0)
                wParam_11 = var_e8
        ...
        switch (Msg_1)
            case 1
                ...
                if (eax_6 != 0)
                    ...
                    SetWindowLongA(var_e8, 0xfffffffc, sub_558bb0)
                    ...
                    if (eax_8 != 0)
                        ...
                        sub_579a90(hData_1, &hInstance_2, 0x5c)
            ...
            case 2
                if (ecx != 0)
                    ...
                    DestroyWindow(*(data_1511868 + 0x18))
                    DestroyWindow(*(data_1511868 + 0x14))
                    void* eax_19 = data_1511868
            ...
            case 5
                ...
                eax_25 = sx.d(edi.w)
            label_5592ea:
                sub_5575e0(eax_25, Msg_1, ecx_7, eax_25, var_f4_11)
                @__security_check_cookie@4(eax_1 ^ &var_e8)
                return 0
            case 7
                SetFocus(*(ecx + 0x14))
        ...
        if (Msg_1 u> 0x111)
                ...
                label_55a311:
                    ...
                    switch (Msg_1)
                        ...
                        case 0x182
                            ...
                            LRESULT wParam_3 = SendMessageA(*(data_1511868 + 0x14), 0x18f, 0, lParam_2)
                            
                            if (wParam_3 != 0xffffffff)
                                SendMessageA(*(data_1511868 + 0x14), 0x182, wParam_3, 0)
                            
                            LRESULT eax_98 = SendMessageA(*(data_1511868 + 0x18), 0x182, wParam_11, 0)
                            @__security_check_cookie@4(eax_1 ^ &var_e8)
                            return eax_98
                        case 0x184
                            SendMessageA(*(ecx + 0x18), 0x184, 0, 0)
                            void* eax_110 = data_1511868
                            HWND hWnd_9 = *(eax_110 + 0x1c)
                            
                            if (hWnd_9 != 0)
                                DestroyWindow(hWnd_9)
                                *(data_1511868 + 0x1c) = 0
                                eax_110 = data_1511868
                            ...
                            SetWindowTextA(*(data_1511868 + 0x10), &data_5b2591)
                            goto label_55a30e
                        case 0x186
                            ...
                            if (lParam_5 != 0xffffffff && lParam_5 != 0 && *(lParam_5 + 0x14) != 0x63)
                                LRESULT wParam_6 =
                                    SendMessageA(*(data_1511868 + 0x14), 0x18f, 0, lParam_5)
                                
                                if (wParam_6 != 0xffffffff)
                                    LRESULT eax_116 =
                                        SendMessageA(*(data_1511868 + 0x14), 0x186, wParam_6, 0)
                                    HWND eax_118 = *(data_1511868 + 0x14)
                                    WPARAM wParam_7 = zx.d(GetDlgCtrlID(eax_118)) | 0x10000
                                    SendMessageA(GetParent(*(data_1511868 + 0x14)), 0x111, wParam_7, 
                                        eax_118)
                                    
                                    if (*(lParam_5 + 0x14) == 8)
                                        *(lParam_5 + 8) = &data_60b558
                        ...
                        case 0x187
                            ...
                            LRESULT wParam_5 = SendMessageA(*(data_1511868 + 0x14), 0x18f, 0, lParam_4)
                            
                            if (wParam_5 == 0xffffffff)
                                @__security_check_cookie@4(eax_1 ^ &var_e8)
                                return 0
                            
                            LRESULT eax_109 = SendMessageA(*(data_1511868 + 0x14), 0x187, wParam_5, 0)
                            @__security_check_cookie@4(eax_1 ^ &var_e8)
                            return eax_109
                        case 0x188
                            ...
                            if (wParam_4 != 0xffffffff)
                                LRESULT lParam_3 =
                                    SendMessageA(*(data_1511868 + 0x14), 0x199, wParam_4, 0)
                                
                                if (lParam_3 != 0xffffffff && lParam_3 != 0
                                        && *(lParam_3 + 0x14) != 0x63)
                                    LRESULT eax_102 =
                                        SendMessageA(*(data_1511868 + 0x18), 0x18f, 0, lParam_3)
                                    @__security_check_cookie@4(eax_1 ^ &var_e8)
                                    return eax_102
                        ...
                        case 0x198
                            ...
                            return eax_106
                        case 0x199
                            int32_t eax_104 = sub_5583d0(wParam_11)
                            @__security_check_cookie@4(eax_1 ^ &var_e8)
                            return eax_104
                        case 0x19a
                            LRESULT eax_125 = sub_5587a0(wParam_11, edi)
                            @__security_check_cookie@4(eax_1 ^ &var_e8)
                            return eax_125
                        case 0x1a0
                            if (0x14 u> edi.w)
                        ...
                        case 0x200
                            ...
                            if (edx_2 s< esi_16 - 5 || edx_2 s> esi_16 + 5)
                                if (*(ecx + 0x40) != 0)
                                    ...
                                    HWND hdc = var_e8
                                    *(data_1511868 + 0x48) = edx_2
                                    void* eax_89 = data_1511868
                        ...
                        case 0x201
                            ...
                            *(data_1511868 + 0x40) = 1
                            *(data_1511868 + 0x54) = 0
                            *(data_1511868 + 0x58) = var_40.right - var_40.left
                            *(data_1511868 + 0x48) = edi_4
                            HDC eax_70 = GetDC(arg1)
                            HGDIOBJ h = SelectObject(eax_70, CreatePen(PS_COSMETIC, 3, 0))
                            void* ecx_35 = data_1511868
                        ...
                        case 0x202
                            ...
                            *(data_1511868 + 0x2c) = var_40.bottom - var_40.top - edi_8
                            ecx_7 = arg1
            ...
            switch (Msg_1)
                ...
                case 0x403
                    ...
                    *(data_1511868 + 0xc) = var_e8
                    void* eax_140 = data_1511868
                    ...
                    if (*(eax_140 + 0xc) != 0)
                        ...
                        SendMessageA(*(data_1511868 + 0xc), 0x406, 0, &lParam_1)
                        ShowWindow(*(data_1511868 + 0xc), SW_SHOW)
                ...
                case 0x404
                    ...
                    sub_5575e0(eax_151, edx_6, arg1, eax_151, var_40.bottom - var_40.top)
                    goto label_55a30e
                case 0x405
                    ...
                    int32_t eax_131 = SetWindowLongA(*(data_1511868 + 0x14), 0xffffffeb, dwNewLong)
                    @__security_check_cookie@4(eax_1 ^ &var_e8)
                    return eax_131
        else
            if (Msg_1 == 0x111)
                if (*(ecx + 0x14) == edi)
                    ...
                    if (esi_4 == 1)
                        ...
                        *(data_1511868 + 4) = eax_46
                        void* eax_47 = data_1511868
                        void* edx_1 = *(eax_47 + 4)
            ...
            switch (Msg_1 + &jump_table_55a334[4])
                case &lookup_table_55a364
                    void* eax_39 = *(ecx + 4)
                    ...
                    if (*(eax_39 + 0x14) == 8)
                        *(eax_39 + 8) = &data_60b558
                        ecx = data_1511868
                    
                    *(ecx + 0x40) = 0
                    SendMessageA(*(data_1511868 + 0x14), 0x100, 9, 0)
                    @__security_check_cookie@4(eax_1 ^ &var_e8)
                    return 0
                case &lookup_table_55a364[1], &lookup_table_55a364[2], &lookup_table_55a364[3], 
                        &lookup_table_55a364[4], &lookup_table_55a364[5], &lookup_table_55a364[6], 
                        &lookup_table_55a364[7], &lookup_table_55a364[8], &lookup_table_55a364[9], 
                        &lookup_table_55a364[0xa]
                    goto label_55a311
                case &lookup_table_55a364[0xb]
                    sub_557870(ecx, edi)
                    @__security_check_cookie@4(eax_1 ^ &var_e8)
                    return 0
                case &lookup_table_55a364[0xc]
                    MulDiv(0x14, GetDeviceCaps(GetDC(arg1), 0x5a), 0x60)
                    @__security_check_cookie@4(eax_1 ^ &var_e8)
                    return 0
                case &lookup_table_55a364[0xd]
                    int32_t eax_37 = edi

...
float __fastcallsub_503920(void* arg1, void* arg2)
{
    ...
    if (edx s> 0)
        ...
        var_90.d = &var_50
        float xmm1_1[0x4] = *sub_508190(var_90)
        ...
        double var_28
        int32_t* eax_8 = sub_5080d0(&var_28, *(arg2 + 0x24))
        int128_t var_38
        var_38:4.q = *eax_8
        ...
        var_90_1.d = &var_50
        int96_t xmm0_13 = (*sub_508190(var_90_1)).12
        var_50 = *(arg2 + 0x30)
        var_60 = xmm0_13:4.d
        var_70 = xmm0_13:8.d
        result = xmm0_13.d
    ...
    if (not(esi[0x13] f<= 0f))
        int32_t eax_13 = *sub_4981f0(*esi)
        
        if (*(*(eax_2 + 0x2dc) * 0x168 + eax_13 + 0xe6) == 0)

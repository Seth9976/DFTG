...
char* __fastcallsub_509320(int32_t* arg1)
{
    // 第一条实际指令: int32_t var_8 = 0xffffffff
    int32_t var_8 = 0xffffffff
    int32_t (* var_c)(void* arg1) = sub_5a19a8
    TEB* fsbase
    ...
    if (arg1.b u>= 0x80)
        ...
        if (eax_3.b != 0xc0)
            ...
            if (eax_3.b != 0xe0)
                ...
                if (arg1.b != 0xf0)
                    sub_489550(eax_3, &data_5b2591, "!Xutf8_is_invalid_lead_char(mText + charIndex)", 
                        "d:\ax\trunk\ax2017\engine\uitextbox.cpp", 0x23f, "UITextBox::GetCharacterX")
    ...
    sub_48a6e0(&arg_4, eax_4, esi)
    uint32_t eax_6 = ebx[0x15] - 1
    
    if (eax_6 u<= 7)
        eax_6 = zx.d(lookup_table_509550[eax_6])
        ...
        switch (eax_6)
            ...
            case 1
                ...
                float xmm0_3 = sub_4e9430(ebx[0xc], edx_4)
    ...
    sub_489550(eax_6, &data_5b2591, "Halt", "d:\ax\trunk\ax2017\engine\uitextbox.cpp", 0x253, 

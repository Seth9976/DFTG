...
int32_t __convention("regparm")sub_543fd0(int32_t arg1, int32_t* arg2, float* arg3, void* arg4)
{
    ...
    int32_t eax_4 = sub_5233d0(eax_2) i* ebx
    ...
    *arg3 = ecx_6
    ...
    sub_55f0b0(eax_14, ebx, var_20, eax, ecx_8, eax_14, *arg3)
    int32_t eax_15
    eax_15.b = 1
    return eax_15
}

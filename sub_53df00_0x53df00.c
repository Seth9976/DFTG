...
char* __convention("regparm")sub_53df00(int32_t arg1, PSTR arg2, char* arg3, int32_t arg4 @ edi, int32_t arg5, int32_t* arg6, void** arg7, int32_t* arg8, char arg9)
{
    // 第一条实际指令: int32_t var_8 = 0xffffffff
    int32_t var_8 = 0xffffffff
    int32_t (* var_c)(void* arg1) = sub_5a2f0c
    TEB* fsbase
    ...
    defines.Definition = &data_5f17bc
    char const* const var_250_1 = "HAVE_RIFT"
    void* const var_24c_1 = &data_5f17bc
    int32_t* i = *arg6
    ...
    if (arg5 != 1)
        if (arg5 != 0)
            ...
            sub_489550(arg5, &data_5b2591, "Halt", "d:\ax\trunk\ax2017\engine\windows\windowsdx11.cpp", 
                0x9f6, ppErrorMsgs)
    ...
    void** const include = &data_60a248
    ...
    if (arg9 == 0)
        ...
        ppErrorMsgs = sub_4e5700(&ppErrorMsgs_6, pSrcData)
        int32_t var_8_1 = 0
        struct ID3DBlob* ppErrorMsgs_1 = ppErrorMsgs_6
        ppErrorMsgs = ppErrorMsgs_1
        
        if (ppErrorMsgs_1 != 0 && ppErrorMsgs_1->vtable.b != 0)
            char* eax_10 = sub_48a080(&ppErrorMsgs)
            *(eax_10 + 4) += 1
        
        char* const pSrcData_6
        sub_4e6720(&pSrcData_6)
        var_8_1.b = 1
        char* pSrcData_5 = pSrcData_6
        pSrcData_1 = pSrcData_5
        
        if (pSrcData_5 != 0 && *pSrcData_5 != 0)
            char* eax_11 = sub_48a080(&pSrcData_1)
            *(eax_11 + 4) += 1
        
        var_8_1.b = 2
        int32_t* ecx_7 = data_1150b90
        ppErrorMsgs = &pSrcData_1
        sub_48a560(ecx_7, ppErrorMsgs)
        var_8_1.b = 3
        int32_t* eax_12
        
        if (data_aca1f4 != 0 && pSrcData_5 != 0 && *pSrcData_5 != 0)
            eax_12 = sub_48a080(&pSrcData_1)
            int32_t temp0_1 = eax_12[1]
            eax_12[1] -= 1
            
            if (temp0_1 == 1)
                sub_4984f0(eax_12, eax_12[3] + 0x10)
        ...
        esi_2 = D3DCompileFromFile(&fileName, pDefines, &include, arg2, pTarget, 0x1000, 0, &ppCode, 
            ppErrorMsgs)
        sub_48a2c0(&pDefines, &data_5b2591)
        var_8_1.b = 4
        int32_t* ecx_13 = data_1150b90
        ppErrorMsgs = &pDefines
        sub_48a560(ecx_13, ppErrorMsgs)
        var_8_1.b = 5
        ...
        if (data_aca1f4 != 0)
            ...
            if (pDefines_1 != 0 && pDefines_1->Name.b != 0)
                char* eax_15 = sub_48a080(&pDefines)
        ...
        if (data_aca1f4 != 0)
            ...
            if (ppErrorMsgs_7 != 0 && ppErrorMsgs_7->vtable.b != 0)
                char* eax_17 = sub_48a080(&ppErrorMsgs_6)
                int32_t temp3_1 = *(eax_17 + 4)
                *(eax_17 + 4) -= 1
                
                if (temp3_1 == 1)
                    sub_4984f0(eax_17, *(eax_17 + 0xc) + 0x10)
                    ppErrorMsgs_6 = &data_5b2591
    ...
    if (esi_2 s>= 0)
        ...
        *arg8 = ppErrorMsgs_3
        char* eax_24 = sub_4c2e40(ppErrorMsgs_3)
        ppErrorMsgs = ppErrorMsgs_3
        *arg7 = eax_24
        sub_579300(eax_24, eax_22, ppErrorMsgs)
        result.b = 1
    else
        ...
        sub_4892e0("Dx11 compile error on %s:\n%s\n")
        result.b = 0

...
int128_t*sub_4e8300()
{
    ...
    int32_t* ecx = data_1150db8
    
    if (ecx != 0)
        (*(*ecx + 0x24))(1)
        data_1150ebc = data_5d2b78
        int32_t edx_1 = sub_4e7b40()
        float xmm7_2 = data_1150ebc.d ^ 0x80000000
        float xmm5_2 = data_1150ebc:4 ^ 0x80000000
        float xmm1_1 = data_1150e3c.d
        float xmm6_2 = data_1150ebc:8 ^ 0x80000000
        float xmm0_2 = data_1150e3c:0xc
        float xmm4_1 = data_1150e3c:8
        float xmm3_1 = data_1150e3c:4
        float xmm2_4 = xmm1_1 f* data_1150ebc:0xc + xmm0_2 * xmm7_2 + xmm4_1 * xmm5_2 - xmm3_1 * xmm6_2
        float xmm2_8 = xmm3_1 f* data_1150ebc:0xc + xmm0_2 * xmm5_2 + xmm1_1 * xmm6_2 - xmm4_1 * xmm7_2
        float xmm2_12 = xmm4_1 f* data_1150ebc:0xc + xmm0_2 * xmm6_2 + xmm3_1 * xmm7_2 - xmm1_1 * xmm5_2
        float xmm5_4 = xmm2_8 * xmm2_8
        float xmm6_4 = xmm2_12 * xmm2_12
        float xmm0_31 = xmm0_2 f* data_1150ebc:0xc - xmm1_1 * xmm7_2 - xmm3_1 * xmm5_2 - xmm4_1 * xmm6_2
        ...
        void var_28
        int64_t* eax_6 = sub_482720(&var_28, edx_1, &var_38, &var_28)
        int32_t var_30_2 = eax_6[1].d
        var_38 = *eax_6
        int128_t var_70
        result = sub_41de50(&var_28, &data_5d22f4, &var_38, &var_28, &var_70:4, &var_48)

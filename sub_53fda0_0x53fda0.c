...
void __fastcallsub_53fda0(void* arg1)
{
    // 第一条实际指令: void* edx
    void* edx
    void* var_24 = edx
    ...
    if (i s< *(arg1 + 0x18))
        do
            ...
            if (sub_53fd20(&var_40, edx, edx, var_40) == 0)
                break
    ...
    while (i_1 s> *(arg1 + 0x10))
        ...
        var_40 = (*(arg1 + 0xc)).o
        eax, edx = sub_53fd20(&var_40, edx, edx, var_40)
    ...
    while (i_2 s< *(arg1 + 0x14))
        ...
        int32_t i_6 = i_2
        var_40 = i_4.o
        eax, edx = sub_53fd20(&var_40, edx, var_24, var_40)

...
int32_t* __fastcallsub_4f2520(int32_t* arg1, int32_t* arg2)
{
    // 第一条实际指令: void* const __return_addr_1 = __return_addr
    void* const __return_addr_1 = __return_addr
    int32_t var_14 = 0xffffffff
    int32_t (* var_18)(void* arg1) = sub_5a12a8
    TEB* fsbase
    ...
    if (arg1[5] s<= 0)
        sub_489550(eax_4, &data_5b2591, "index >= 0 && index < mSize", 
            "d:\ax\trunk\ax2017\engine\xarray.h", 0xb5, "XArray<struct Mat4>::operator []")
    ...
    if (eax_5 s> 0)
        ...
        do
            ...
            void* esi_2 = *(eax_4 + 0x18) + ecx_1
            float xmm1_3 = edx_1[1]
            float xmm1_5 = edx_1[2]
            uint32_t eax_7
            float xmm0_6[0x4]
            eax_7, xmm0_6 =
                sub_41dbe0(xmm0_1 * xmm0_1 + xmm2_1 * xmm2_1 + xmm1_3 * xmm1_3 + xmm1_5 * xmm1_5)
            ...
            *edx_2 = _mm_div_ps(*edx_2, xmm0_7)
            ...
            if (esi_3 s>= var_3c)
                sub_489550(eax_7, &data_5b2591, "pStructBone->parentBoneIndex < i", 
                    "d:\ax\trunk\ax2017\engine\animation.cpp", 0x2b0, "AnimationCalcFinalPosition")
            ...
            if (esi_3 != 0xffffffff)
                ...
                if (arg2[esi_3 * 0xb + 0xa].b == 0)
                    int128_t* eax_14 = sub_4be7c0(eax_11, edx_2, &edx_2[7], var_408_2)
                    int128_t var_1f8_1 = *eax_14
                    int128_t var_1e8_1 = eax_14[1]
                    int128_t var_1d8_1 = eax_14[2]
                    int128_t var_1c8_1 = eax_14[3]
                    int128_t* eax_16 = sub_4c2cf0(&var_b8, edx_2, edx_2, &var_b8)
                    ...
                    int128_t* eax_12 = sub_4ddd60(eax_11, edx_2, edx_2, var_408_2)
                    var_b8 = *eax_12
                ...
                eax_9 = sub_497aa0(eax_13)
                edx_2 = var_34_1
            else
                eax_9 = sub_4ddd60(&var_b8, edx_2, edx_2, &var_b8)
            edx_1 = &edx_2[0xb]

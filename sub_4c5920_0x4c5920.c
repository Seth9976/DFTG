...
int32_t __fastcallsub_4c5920(int32_t* arg1)
{
    ...
    if (*arg1 != 0)
        ...
        if (ecx[1] != 0x15)
            ...
            var_2c = 0x33a
            var_30 = "d:\ax\trunk\ax2017\engine\sound.cpp"
            ecx_1 = "assetPtr->assetType == ASSET_TYPE_SOUND"
        label_4c5bd9:
            sub_489550(eax, &data_5b2591, ecx_1, var_30, var_2c, var_28_1)
        ...
        void* eax_1 = sub_4981f0(ecx)
        int32_t* esi_1 = data_114e838
        int32_t edx_1 = 0
        void* ecx_2 = nullptr
        void* ebx_1
        int32_t edi_1
    ...
    label_4c59b6:
        ...
        label_4c5a06:
            ...
            if (eax != temp0_1)
                if (eax u< temp0_1)
                    ...
                    if (eax u<= ebx_1)
                        ...
                        esi_1[3] = eax_17
                        int32_t* edi_4 = ebx_1 * 0x64 + ecx_5
                        _memset(edi_4, 0, 0x60)
                        edi_4[0x18] = esi_1[5] << 0x10 | ebx_1
                        esi_1[5] += 1
                        ...
                        *(edi_4 + 0x5b) = eax_25.b
                        eax_25.b = *(arg1 + 0x16)
                        edi_4[0x17].b = eax_25.b
                        eax_25.b = arg1[5].b
                        edi_4[0x16].b = eax_25.b
                        edi_4[8] = *(eax_1 + 0x10)
                        edi_4[0xf] = 0x3f800000
                        int32_t eax_27
                        eax_27.b = *(arg1 + 0x17)
                        *(edi_4 + 0x5d) = eax_27.b
                        void* eax_28
                        int32_t xmm0_3
                        eax_28, xmm0_3 = sub_4c5840(edi_4)
                        edi_4[0x12] = xmm0_3
                        edi_4[0x14] = 0x3f000000
                        float xmm0_4 = arg1[1]
                        xmm0_4 f- 0
                        eax_28:1.b = (xmm0_4 == 0f ? 1 : 0) << 6
                        ...
                        if (not(p_1))
                            ...
                            xmm0_5 = fconvert.s(sub_41f0d0(0x3f879c7d, xmm0_4))
                        
                        int32_t* ecx_7 = data_114e834
                        edi_4[0x13] = xmm0_5
                        
                        if ((*(*ecx_7 + 0xc))(edi_4, arg1) != 0)
                            int32_t result = edi_4[0x18]
                            edi_4[4] = xmm0
                            *(edi_4 + 0x5a) = 1
                            return result
                        
                        void* edx_3 = data_114e838
                        int32_t ecx_8 = *(edx_3 + 0xc)
                        *(edx_3 + 0xc) = zx.d(edi_4[0x18].w)
                        edi_4[0x18] = ecx_8
                        *(edx_3 + 0x10) -= 1
                        return 0
            ...
            sub_4892e0("Too many sounds, not playing %s")

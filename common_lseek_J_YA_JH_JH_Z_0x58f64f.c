...
int32_t??$common_lseek@_J@@YA_JH_JH@Z(int32_t arg1, int32_t arg2, int32_t arg3, enum SET_FILE_POINTER_MOVE_METHOD arg4)
{
    ...
    if (arg1 != 0xfffffffe)
        ...
        if (arg1 s< 0 || arg1 u>= data_6cfd08 || (*((&data_6cfb08)[ecx_2] + edx_1 + 0x28) & 1) == 0)
            *___doserrno() = 0
            *__errno() = 9
            ...
            int32_t var_8_1 = 0
            int32_t eax_6 = (&data_6cfb08)[ecx_2]
    ...
    fsbase->NtTib.ExceptionList = ExceptionList
    void* const __saved_ebp_2 = &data_58f750
    return result
}

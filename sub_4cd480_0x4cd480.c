...
uint32_t (* __convention("regparm")sub_4cd480(int32_t arg1, uint32_t (* arg2)[0x4], int32_t arg3, char arg4))[0x4]
{
    ...
    if (arg3 != 0)
        ...
        if (edx u>= data_6c9d94 || *(arg1 + edi_1 + 0x434) != arg3)
            ...
            if (ecx_1[1] == 0x1e)
                ...
                void* edi_3 = arg2 * 0x178 + *eax
                uint32_t (* result)[0x4] = sub_4ca090(eax, arg2, esi_2, &data_5b2591)
                ...
                if ((*result)[0x17] == 0)
                    xmm0 = _mm_cvtepi32_ps(zx.o(*(edi_3 + 0x70)))
                else
                    xmm0 = result[6][0]
    ...
    sub_489550(arg1, &data_5b2591, ecx, var_1c, var_18, var_14)

...
void* __convention("regparm")sub_4d5d60(int32_t arg1, void* arg2, int32_t* arg3, void* arg4)
{
            ...
            if ((ecx_3 & 8) == 0)
                ...
                if (eax_1 == 6)
                    ...
                    if (eax_3 == 0)
                        ...
                        var_38_7 = 0x6d
                        var_3c = "d:\ax\trunk\ax2017\engine\definition.cpp"
                        ecx_18 = "pDefMap->definitionSize != 0"
                    label_4d5fad:
                        sub_489550(eax_3, &data_5b2591, ecx_18, var_3c, var_38_7, var_34_6)
                            ...
                            if (__stricmp(esi_1[1], ecx_4) == 0)
                                ...
                                if (eax_9 == 0)
                                    ...
                                    if (eax_3 u<= 0x10)
                                        ...
                                        var_38_7 = 0x297
                                        var_3c = "d:\ax\trunk\ax2017\engine\defparsetree.cpp"
                                        ecx_18 = "!DefTypeIsBuiltIn(pField->pSubDefMap)"
                                        break
                                    
                                    sub_4d5fd0(eax_6, edx_1, edi_2, eax_6[2], 0)
                                else
                                    sub_4d4f40(eax_6, edx_1, edi_2, esi_1, eax_6)
                ...
                label_4d5e52:
                    ...
                    if (eax_1 == 0x13)
                        sub_4d5ac0(eax_1, esi_1, *esi_1 + arg3, arg4)
                    else if (eax_1 != 0x14)
                        eax_3 = eax_1 - 1
                        ...
                        sub_4d5fd0(eax_3, edx, *esi_1 + arg3, arg4, 0)
                    else
                        void* var_34_5 = arg4
                        sub_4d58a0(eax_1, *esi_1 + arg3, arg3, esi_1)
            ...
            for (int32_t j = 0; j != 0xffffffff; )
                ...
                if ((ecx_11 & 8) == 0)
                    ...
                    if (*(result + 0x10) != 6 && (ecx_11 & 0x40) == 0)
                        ...
                        if (result == 0)
                            result = sub_4d5bc0(result, edi_3, arg3, var_18_2)
                            edi = var_8
                            break

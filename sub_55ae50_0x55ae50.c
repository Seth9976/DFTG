...
int32_t __convention("regparm")sub_55ae50(int32_t arg1, int32_t arg2, void* arg3, float arg4 @ xmm3, long double arg5 @ st0, int32_t arg6, int32_t arg7, int32_t arg8)
{
    ...
    if (eax == 0)
        ...
        (&data_6cedac)[arg6 * 2](xmm1)
        top = 1
        ecx = arg7
        xmm1 = var_18
        int32_t eax_3
        int32_t edx
        edx:eax_3 = sx.q(int.d(sub_4369e0(fconvert.s(arg5 * fconvert.t(2f) / fconvert.t(var_18)))))
    ...
    int32_t ecx_1
    float xmm0_6
    ecx_1, xmm0_6 = sub_4369e0(var_30)
            ...
            if (edx_1 s> 0)
                ...
                do
                    ...
                    if (esi_1 s<= *(eax_9 + (edi_1 << 3) + 4))
                        ...
                        edx_1 = var_24
                        xmm1_1 =
                            *(ecx_1 + ((int.d(sub_4369e0(var_30_1)) * edi_1 + eax_11) << 2)) f+ var_2c_1
                        eax_9 = arg3
                        var_2c_1 = xmm1_1
            ...
            if (edx_1 s> 0)
                ...
                do
                    ...
                    if (esi_1 s<= *(eax_17 + (edi_2 << 3) + 4))
                        ...
                        ecx_1 = arg2
                        edx_1 = var_24
                        int32_t eax_24 = int.d(sub_4369e0(var_30_2)) * edi_2 + eax_19
    ...
    if (edx_1 s> 0)
        do
            ...
            while (true)
                ...
                (&data_6cedac)[arg6 * 2](xmm0_15)
                unimplemented  {fmul st0, dword [0x60c4b8]}
                float var_30_3 = fconvert.s(unimplemented  {fstp dword [ebp-0x20], st0})
                unimplemented  {fstp dword [ebp-0x20], st0}
                top_1 += 1
                ecx_1 = var_2c_3
                float xmm0_18 = *(arg2 + ((int.d(sub_4369e0(var_30_3)) * ecx_1 + esi_2) << 2))
                xmm0_18 f- 0
                int32_t eax_29
            ...
            *(arg3 + (ecx_1 << 3)) = eax_31
            ...
            if (ecx_4 s> 0)
                do
                    ...
                    (&data_6cedac)[arg6 * 2](xmm0_25)
                    unimplemented  {fmul st0, dword [0x60c4b8]}
                    float var_14_8 = fconvert.s(unimplemented  {fstp dword [ebp-0x4], st0})
                    unimplemented  {fstp dword [ebp-0x4], st0}
                    top_1 += 2
                    int32_t ecx_7 = int.d(sub_4369e0(var_14_8))
    ...
    if (edx_1 s> 0)
        if (edx_1 u>= 8 && data_6cf684 s>= 2)
            ...
            int32_t xmm4_2[0x4] = __psubd_xmmdq_memdq(xmm0_1, data_60c810)
            void* esi_4 = arg3 + 0xc

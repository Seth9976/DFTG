...
int32_t?fp_format_nan_or_infinity@@YAHW4__acrt_fp_class@@_NPADI1@Z(int32_t arg1, char arg2, char* arg3, int32_t arg4, char arg5)
{
    ...
    if (edx u>= zx.d(ebx.b) + 4)
        ...
        void* const var_48 = &data_5ab774
        void* const var_44_1 = &data_5ab774
        void* const var_40_1 = &data_5ab778
        void* const var_3c_1 = &data_5ab778
        int32_t edi
        int32_t var_58_1 = edi
        void* const var_30_1 = &data_5ab780
        void* const var_2c_1 = &data_5ab780
        int32_t edi_3 = (zx.d(arg5) ^ 1) * 2
        void* const var_1c_1 = &data_5ab780
        void* const var_c_1 = &data_5ab780
        void* const var_38_1 = &data_5ab77c
        void* const var_34_1 = &data_5ab77c
        void* const var_24_1 = &data_5ab77c
        char const* const var_20_1 = "nan(snan)"
        char const* const var_18_1 = "NAN(IND)"
        void* const var_14_1 = &data_5ab77c

...
int32_t __fastcallsub_53e340(int32_t* arg1, int32_t* arg2)
{
    ...
    if (arg1[1] == 3)
        ...
        int32_t var_2c_1 = 1
        int32_t var_28_1 = 1
        int32_t var_24_1 = sub_53a3b0(*(*eax_2 + 0x18))
        int32_t var_20_1 = 1
        int32_t var_1c_1 = 0
        int32_t var_18_1 = 3
        int32_t var_10_1 = 0x20000
        int32_t var_c_1 = 0
        int32_t* eax_7 = *(data_1151ae8 + 4)
        int32_t* var_38
        eax_1 = (*(*eax_7 + 0x14))(eax_7, &var_34, 0, &var_38)
        
        if (eax_1 s>= 0)
            int32_t* eax_8 = sub_4d2a30(arg1)
            void* ecx_7 = data_1151ae8
            void* const edx
            ...
            if (eax_1 s>= 0)
                ...
                if (not(cond:0_1))
                    ...
                    if (arg2[2] == edx_3)
                        sub_523b10(&var_58, arg2)
                        int32_t* eax_15 = *(data_1151ae8 + 8)
        ...
        var_70 = "d:\ax\trunk\ax2017\engine\windows\windowsdx11.cpp"
    else
        var_68 = "TextureGetDef"
        var_6c = 0x86
        var_70 = "d:\ax\trunk\ax2017\engine\texture.h"
        ecx = "assetPtr->assetType == ASSET_TYPE_TEXTURE"
    
    sub_489550(eax_1, &data_5b2591, ecx, var_70, var_6c, var_68)

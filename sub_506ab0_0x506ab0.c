...
int32_t __fastcallsub_506ab0(void* arg1, int32_t* arg2)
{
    // 第一条实际指令: void var_9c
    void var_9c
    ...
    if (eax_2 == 0)
        sub_489550(eax_2, &data_5b2591, "gpGameData", "d:\ax\trunk\ax2017\engine\game.h", 0x45, 
            "GetGameData")

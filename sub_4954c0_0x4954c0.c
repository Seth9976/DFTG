...
int32_t* __fastcallsub_4954c0(uint32_t arg1, uint32_t arg2)
{
    // 第一条实际指令: void var_a8
    void var_a8
    ...
    int128_t* eax_5 = sub_482820(&var_a0, arg2, &var_60, &var_a0)
    var_60 = *eax_5
    ...
    int32_t* result = sub_494ea0(eax_6, &var_60, *(arg1 + 4), edi, 0, eax_6)

...
int128_t* __convention("regparm")sub_4ec940(int32_t arg1, int32_t arg2, int32_t* arg3, int128_t* arg4, int32_t* arg5, float* arg6, void* arg7)
{
    ...
    if (arg2 == 0)
        ...
        if (arg2 == 1)
            ...
            float xmm0_14 = sub_41f120(xmm1_9)
            float xmm0_17 = (xmm0_2 - xmm1_3) * xmm0_14
            int32_t edx_3
            float xmm0_19
            edx_3, xmm0_19 = sub_41f100(xmm1_9)
            float xmm2_7 = arg6[3]
            float xmm4_1 = arg6[4]
            float xmm5_1 = arg6[5]
            ...
            void var_bc
            int64_t* eax_6 = sub_482720(&var_bc, edx_3, &var_14, &var_bc)
            int32_t var_c_2 = eax_6[1].d
            var_14 = *eax_6
            int128_t xmm0_46 = *sub_41e000(&var_88:0xc, &var_20, &var_14, &var_88:0xc)
        ...
        var_d4 = 0x48a
        ecx = "Halt"
    sub_489550(eax_1, &data_5b2591, ecx, "d:\ax\trunk\ax2017\engine\fabdef.cpp", var_d4, "DistBox")

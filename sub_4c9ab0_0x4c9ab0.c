...
int32_t __convention("regparm")sub_4c9ab0(int32_t arg1, int32_t* arg2, void* arg3, int32_t* arg4, int32_t arg5, int32_t* arg6, int128_t* arg7)
{
    // 第一条实际指令: void var_b8
    void var_b8
    ...
    if (edx_1 != 0 || edi_1 != 0)
        ...
        if (eax_4.b != 0)
            float var_30[0x4] = *(arg3 + 0x10)
            void var_40
            int128_t xmm0_6 = *sub_4c8d30(&var_40, &var_30, arg4, &var_40, arg3 + 0x20)
            eax_4 = data_aca1ec
            ...
            label_4c9c35:
                ...
                if (*(arg3 + 0x90) != 0)
                    int32_t eax_13
                    int32_t edx_5
                    eax_13, edx_5 = sub_426dd0(&var_a0)
                    int128_t xmm0_11 = data_5d3570
                    var_a0.d = eax_13
                    int128_t var_70
                    ...
                    "00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x80\x3f", 
                        0x24)
                    float xmm1_7[0x4] = data_5d3580
                    float xmm4_2 = arg4[3]
                    var_70.d = xmm0_11 f* xmm4_2
                    var_a0:4.d = edx_5
                    var_70:0xc.d = var_70:0xc.d * xmm4_2
                    float xmm3_6[0x4] = var_a0:4.d / xmm4_2
                    var_70:4.d = var_70:4.d * xmm4_2
                    float xmm2_3[0x4] = var_a0.d / xmm4_2
                    int128_t var_60
                    var_60.d = var_60.d * xmm4_2
                    var_60:0xc.d = var_60:0xc.d * xmm4_2
                    var_60:8.d = _mm_shuffle_ps(xmm1_7, xmm1_7, 0xaa) * xmm4_2
                    float* eax_16 = sub_4c22b0(&var_7c, &var_70, edi_1, xmm2_3, xmm3_6, 
                        xmm5_6 / xmm4_2, xmm7_4 / xmm4_2, &var_7c, 0, 0, 1, &data_5d2760, nullptr)
                ...
                if (not(cond:4_1))
                    ...
                    float xmm1_19 = ecx_10[3] f* ecx_10[2]
                    double xmm0_31[0x2] =
                        _mm_cvtepi32_pd(zx.q(eax_21)) f+ *((eax_21 u>> 0x1f << 3) + &data_60cbc0)
                    int32_t eax_23 = ecx_10[1]
                    float xmm3_12 = _mm_cvtpd_ps(xmm0_31)
                    int32_t ecx_12 = *(arg3 + 0x94)
                    float xmm3_13 = xmm3_12 * xmm1_19
                    float xmm0_36 = xmm7_6 - xmm2_6
                    float xmm2_12 = _mm_cvtpd_ps(_mm_cvtepi32_pd(zx.q(eax_23)) f+
                        *((eax_23 u>> 0x1f << 3) + &data_60cbc0)) * xmm1_19
                    float xmm1_22 = _mm_min_ss(xmm5_9 / xmm3_13, xmm0_36 / xmm2_12)
                    float xmm3_14 = xmm3_13 * xmm1_22
                    var_a0.d = xmm2_12 * xmm1_22
                    float eax_25
                    float edx_7
                    eax_25, edx_7 = sub_4eaaa0(ecx_12)
                ...
                eax_4 = sub_4c0210(&var_30, &var_a0, edi_1, &var_30, &var_7c, edx_1)

...
int32_t __stdcallsub_538bd0(int32_t arg1, SOCKADDR* arg2)
{
    ...
    if (result != 0xffffffff)
        ...
        label_538cca:
            sub_489550(result, &data_5b2591, ecx_1, 
                "d:\ax\trunk\ax2017\engine\windows\windowsnetwork.cpp", var_138_2, 
    ...
    sub_489550(result, &data_5b2591, ecx, "d:\ax\trunk\ax2017\engine\windows\windowsnetwork.cpp", 
        var_138, "WinsockNetworkInterface::TCPListenAccept")

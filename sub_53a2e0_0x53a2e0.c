...
uint32_t __thiscallsub_53a2e0(void* arg1, uint32_t arg2)
{
    ...
    if (result != 0)
        ...
        if (ecx u< *(arg1 + 0x3c))
            ...
            if (esi_2[0x92] == result)
                if (*esi_2 != 1)
                    sub_489550(result, &data_5b2591, "bufferData->mBufferType == DX11BUFFER_INDEX", 
                        "d:\ax\trunk\ax2017\engine\windows\windowsdx11.cpp", 0x1d7, 

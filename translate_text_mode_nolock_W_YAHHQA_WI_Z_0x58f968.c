...
void*??$translate_text_mode_nolock@_W@@YAHHQA_WI@Z(int32_t arg1, int16_t* arg2, int32_t arg3)
{
    ...
    int32_t var_c = ecx_1
    int32_t eax_2 = (&data_6cfb08)[ecx_1]
    int32_t var_2c = 0xa
    ...
    if (ebx u< eax_3)
        ...
        do
            ...
            if (eax_4 == var_18_1)
                int32_t ecx_7 = (&data_6cfb08)[ecx_1]
            ...
            label_58faf9:
                *esi = eax_4
                ...
                if ((*(edi_1 + (&data_6cfb08)[ecx_1] + 0x28) & 0x48) != 0)
                    uint16_t buffer_1 = buffer
                    
                    if (buffer_1 != 0xa)
                        *esi = 0xd
                        *(edi_1 + (&data_6cfb08)[ecx_1] + 0x2a) = buffer_1.b
                        *(edi_1 + (&data_6cfb08)[ecx_1] + 0x2b) = (buffer_1 u>> 8).b
                        *(edi_1 + (&data_6cfb08)[ecx_1] + 0x2c) = 0xa
                    else
                        *esi = 0xa

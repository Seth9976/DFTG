...
uint32_t __convention("regparm")sub_5032e0(int32_t arg1, void* arg2, void* arg3, void* arg4)
{
    ...
    if (xmm4 <= 0f)
        ...
        float xmm3_1[0x4] = data_aca2a0
        float eax_1 = data_aca2b8
        float xmm1_2 = *(arg2 + 0x1c) * 0.5f
        float xmm5_2 = xmm4 * 0.5f
        int64_t xmm0_13 = data_aca2b0
        ...
        float xmm0_28 = sub_4827e0(xmm1_10 / xmm4)
        ...
        *(arg3 + 0x1c) = xmm4_2 + xmm6_7
        float xmm0_47 = (sub_41dbe0(xmm0_39 * xmm0_39 + xmm0_35 * xmm0_35 + xmm4_2 * xmm4_2) - xmm1_2)
            / (xmm5_2 - xmm1_2)
        xmm1 = (zx.o(0)).d
        float xmm0_48
        ...
        if (not(0 f< xmm0_47))
            ...
            xmm0_48 = sub_41f140(1, xmm0_47, 1f, (zx.o(0)).d)
            xmm1 = (zx.o(0)).d
        else
            xmm0_48 = (zx.o(0)).d
    ...
    if (not(xmm2_14 <= xmm4_4))
        ...
        if (not(0 f< xmm0_51))
            ...
            xmm0_52 = sub_41f140(1, xmm0_51, xmm1, 1f)
            ecx_1 = arg4
        else
            xmm0_52 = 0x3f800000
    ...
    if (not(*(arg2 + 0x50) f<= *(arg2 + 0x4c)))
        int128_t var_40_2 = data_aca2a0
        int64_t xmm0_55 = data_aca2b0
        float xmm1_20 = *(arg3 + 0x1c) - data_aca2b8
        float xmm0_57 = *(arg3 + 0x18) f- xmm0_55:4.d
        float xmm2_22 = *(arg3 + 0x14) f- xmm0_55.d
        float xmm3_8 = (sub_41dbe0(xmm0_57 * xmm0_57 + xmm2_22 * xmm2_22 + xmm1_20 * xmm1_20) f-
            *(arg2 + 0x4c)) / (*(arg2 + 0x50) f- *(arg2 + 0x4c))
        int32_t xmm0_64 = 0x3f800000
        
        if (not(0 f>= xmm3_8))
            if (xmm3_8 < 1f)
                xmm0_64 = sub_41f140(1, xmm3_8, 1f, (zx.o(0)).d)
            else
                xmm0_64 = (zx.o(0)).d
    ...
    if (not(*(arg2 + 0x58) f<= *(arg2 + 0x54)))
        int128_t var_40_3 = data_aca2a0
        int64_t xmm0_68 = data_aca2b0
        float xmm1_24 = *(arg3 + 0x1c) - data_aca2b8
        float xmm0_70 = *(arg3 + 0x18) f- xmm0_68:4.d
        float xmm2_30 = *(arg3 + 0x14) f- xmm0_68.d
        float xmm3_11 = (sub_41dbe0(xmm0_70 * xmm0_70 + xmm2_30 * xmm2_30 + xmm1_24 * xmm1_24) f-
        ...
        if (0 f< xmm3_11)
            ...
            if (not(xmm3_11 >= 1f))
                xmm1_26 = sub_41f140(1, xmm3_11, (zx.o(0)).d, 1f)
        else
            xmm1_26 = (zx.o(0)).d

...
int32_t __convention("regparm")sub_4fa6b0(int32_t arg1, int32_t arg2, int32_t arg3, float arg4 @ xmm2, int32_t* arg5)
{
    ...
    float xmm0_3 = sub_4827e0(xmm1_3)
    float xmm2 = (zx.o(0)).d
    float xmm1_5
    ...
    *arg5 = esi
    ...
    sub_489550(esi + 1, &data_5b2591, ecx_1, "d:\ax\trunk\ax2017\engine\flanim.cpp", var_20, 
        "FlanimCalcFrameTime")

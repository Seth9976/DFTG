...
char* __fastcallsub_536750(int32_t* arg1, char** arg2)
{
    ...
    if (eax_3 == 0)
        sub_489550(eax_3, &data_5b2591, "file", "d:\ax\trunk\ax2017\engine\soundimport.cpp", 0xa1, 
            "ReadWav")
    ...
    if (_fread(&var_20, 0xc, 1, eax_3) == 1)
        ...
        label_5368b6:
            ...
            sub_4892e0("failed to read wav file (wave): %s")
            _fclose(eax_3)
            int32_t var_8_3 = 2
        else
            while (true)
                ...
                if (eax_6 != 0x20746d66)
                    if (eax_6 == 0x61746164)
                        if (arg1[6] != 0)
                            sub_489550(eax_6, &data_5b2591, "pSoundData->bits == NULL", 
                                "d:\ax\trunk\ax2017\engine\soundimport.cpp", 0xcd, "ReadWav")
                        ...
                        arg1[5] = var_b4
                        arg1[3] = var_b4
                        uint32_t (* eax_14)[0x4] = sub_4c2e40(var_b4)
                        arg1[6] = eax_14
                        
                        if (_fread(eax_14, arg1[5], 1, eax_3) != 1)
                            char* const result_11 = result_5
                            sub_4892e0("failed to read wav data: %s")
                        ...
                        if (result != 1)
                            if (result != 2)
                                ...
                                sub_4892e0("can't convert sound storage type %s")
                            else
                                sub_51bba0(arg1)
                    ...
                    if (_fseek(eax_3, var_b4, 1) != 0)
                        ...
                        sub_4892e0("failed to read unknown wav data: %s")
                        _fclose(eax_3)
                        int32_t var_8_6 = 6
                        break
                else
                    if (var_b4 u>= 0x90)
                        sub_489550(var_b4, &data_5b2591, "sizeof(WAVE_FMT_HEADER) > wave.SubchunkSize", 
                            "d:\ax\trunk\ax2017\engine\soundimport.cpp", 0xb8, "ReadWav")
                    ...
                    if (eax_8 != 1)
                        ...
                        sub_4892e0("failed to read wav format: %s")
                        _fclose(eax_3)
                        int32_t var_8_5 = 3
                        break
                    ...
                    if (var_b0 != eax_8.w)
                        ...
                        sub_4892e0("unsupported wav format: %s")
                        _fclose(eax_3)
                        int32_t var_8_4 = 4
                        break
        ...
        sub_4892e0("failed to read wav file (riff): %s")
        _fclose(eax_3)
        int32_t var_8_2 = 1

...
int32_t __convention("regparm")sub_53f370(int32_t arg1, int32_t* arg2, int32_t* arg3, void* arg4)
{
    // 第一条实际指令: int32_t* ebx = arg2
    int32_t* ebx = arg2
    int32_t* var_2c = ebx
    int32_t eax = sub_5233d0(*(arg4 + 0x30))
    ...
    if (result_5 s> 0)
        ...
        while (true)
            ...
            if (eax_13 s> 0)
                ...
                label_53f6b5:
                    sub_489550(eax_15, &data_5b2591, "atlasBytesPerPixel == 4", 
                        "d:\ax\trunk\ax2017\engine\editor\atlasmaker.cpp", 0x1b5, "AtlasGetPixel")

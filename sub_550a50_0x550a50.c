...
int32_tsub_550a50(int32_t arg1, int32_t arg2)
{
    ...
    if (ecx[1] == 0x1e)
        void* eax_2 = sub_4981f0(ecx)
        int32_t esi_1 = 0
        float xmm7_1 = data_126786c
        ...
        while (true)
            ...
            float xmm0_5 = (*(&var_58:4 + (esi_1 << 3)) f* xmm4_3 f+ xmm5_2 f- data_1267874) * xmm7_1
            float var_c0 = (*(&var_58 + (esi_1 << 3)) f* xmm3_3 f+ xmm2_1 f- data_1267870) * xmm7_1
            float var_bc_1 = xmm0_5
            void var_e0
            eax_1 = sub_4829a0(&var_e0, edx_1, &var_c0, &var_e0)
            ...
            if (not(xmm1_7 f< xmm0_6))
                ...
                if (not(xmm3_4 < xmm2_2))
                    ...
                    "00\x00\x00\x06\x00\x00\x00", 
                        0x30)
                    int128_t* eax_6 = sub_54de10(&var_98, edx_1, &var_b8, &var_98)
                    void* edi_1 = &var_88:4
                    ...
                    while (true)
                        ...
                        float xmm2_3 = data_126786c
                        float xmm0_13 = (*(&var_58:4 + (eax_7 << 3)) f* var_110_1.d
                            + var_120_1[0] f- data_1267874) * xmm2_3
                        float var_c8 = (var_f0_1.d f* *(&var_58 + (eax_7 << 3))
                            + var_100_1[0] f- data_1267870) * xmm2_3
                        float var_c4_1 = xmm0_13
                        void var_130
                        float xmm6_2[0x4] = *sub_4829a0(&var_130, &var_c0, &var_c8, &var_130)
                        var_b8 = xmm6_2
                        float xmm0_18 = (*(&var_58:4 + (var_9c_2 << 3)) f* var_110_1.d
                            + var_120_1[0] f- data_1267874) f* data_126786c
                        float var_d8 = (var_f0_1.d f* *(&var_58 + (var_9c_2 << 3))
                            + var_100_1[0] f- data_1267870) f* data_126786c
                        float var_d4_1 = xmm0_18
                        void var_140
                        eax_1 = sub_4829a0(&var_140, &var_d0, &var_d8, &var_140)
        ...
        var_15c = "d:\ax\trunk\ax2017\engine\rect.cpp"
    else
        var_154_1 = "UIDefGet"
        var_158 = 0x126
        var_15c = "d:\ax\trunk\ax2017\engine\uidef.cpp"
        ecx_1 = "ptr->assetType == ASSET_TYPE_UI"
    
    sub_489550(eax_1, &data_5b2591, ecx_1, var_15c, var_158, var_154_1)

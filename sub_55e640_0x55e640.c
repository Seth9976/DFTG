...
int32_t __fastcallsub_55e640(void* arg1, long double arg2 @ st0)
{
    // 第一条实际指令: void* var_38 = arg1
    void* var_38 = arg1
    int32_t eax = *(arg1 + 0x18)
    float xmm0 = *(arg1 + 0x3c)
    (&data_6cedac)[*(arg1 + 0x54) * 2](xmm0)
    ...
    while (ebx_1 s< eax_4)
        ...
        int32_t var_18
        int32_t var_8
        sub_55ab90(&var_8, &var_18, ebx_1, var_14, xmm0, *(arg1 + 0x34), &var_8, &var_20)
        
        if (var_8 s>= 0)
            int32_t edi_1 = var_18
            
            if (edi_1 s< eax)
                sub_55e540(arg1, edi_1)
                top -= 1
                unimplemented  {call 0x55e540}
                sub_55b7c0(arg1, ebx_1)
                ...
                if (eax_9 == 0)
                    sub_55c780(arg1, ebx_2)
                else
                    sub_55c450(arg1, ebx_2)
                ...
                ebx_1 = var_10
                sub_55e170(arg1, ebx_1)
        
        ebx_1 += 1
        var_10 = ebx_1
    
    int32_t result = sub_55e540(arg1, *(arg1 + 0x18))
    unimplemented  {call 0x55e540}
    return result
}

...
uint32_tsub_4e7b40()
{
    ...
    int32_t var_f0 = edi
    uint32_t result_1
    (*(*data_1150db8 + 0x14))(&result_1)
    float xmm3 = data_1150ebc.d
    float xmm0 = data_1150ebc:4
    float xmm7 = data_1150ebc:8
    float xmm6 = data_1150ebc:0xc
    float xmm4_1 = xmm0 * xmm0
    float xmm5_1 = xmm3 * xmm3
    float xmm1_1 = xmm0 * xmm3
    float xmm3_2 = xmm7 f* data_1150ebc:0xc
    float xmm6_1 = xmm6 * xmm6
    float xmm0_2 = xmm1_1 - xmm3_2
    float xmm2_1 = xmm7 * xmm7
    float var_90
    float xmm0_4 = var_90 + var_90
    float xmm4_3 = data_1150ebc:4 f* data_1150ebc:0xc
    float xmm3_7 = xmm5_1 + xmm6_1 - xmm4_1 - xmm2_1
    float xmm2_3 = xmm7 f* data_1150ebc.d
    ...
    float xmm1_3 = data_1150ebc:8 f* data_1150ebc:4
    float xmm0_14 = xmm6_1 - xmm5_1
    float xmm5_3 = data_1150ebc.d f* data_1150ebc:0xc
    ...
    float var_70
    float var_bc =
        var_70 * xmm7_11 + var_78 f* data_1150ebc:0xc + var_7c * xmm6_13 - var_74 f* data_1150ebc.d
    float var_b8_2 =
        var_70 * xmm6_13 + var_74 f* data_1150ebc:0xc + var_78 f* data_1150ebc.d - var_7c * xmm7_11
    float var_b4 =
        var_70 f* data_1150ebc:0xc - var_7c f* data_1150ebc.d - var_78 * xmm7_11 - var_74 * xmm6_13
    var_7c.o =
        (var_70 f* data_1150ebc.d + var_7c f* data_1150ebc:0xc + var_74 * xmm7_11 - var_78 * xmm6_13).o
    float var_6c
    float var_68
    float var_64
    float var_60
    float var_bc_1 =
        var_68 f* data_1150ebc:0xc + var_60 * xmm7_11 + var_6c * xmm6_13 - var_64 f* data_1150ebc.d
    float var_b8_3 =
        var_64 f* data_1150ebc:0xc + var_60 * xmm6_13 + var_68 f* data_1150ebc.d - var_6c * xmm7_11
    float var_b4_1 =
        var_60 f* data_1150ebc:0xc - var_6c f* data_1150ebc.d - var_68 * xmm7_11 - var_64 * xmm6_13
    var_6c.o =
        (var_6c f* data_1150ebc:0xc + var_60 f* data_1150ebc.d + var_64 * xmm7_11 - var_68 * xmm6_13).o
    
    if (result != 3 && result != 0)
        __builtin_memcpy(&data_1150e20, &result_1, 0x80)
        result = sub_4979c0(&data_1150e3c)
        int32_t var_fc
        ...
        label_4e814e:
            sub_489550(result, &data_5b2591, ecx_1, "d:\ax\trunk\ax2017\engine\vr.cpp", var_fc, var_f8)
        ...
        result = sub_4979c0(&data_1150e4c)

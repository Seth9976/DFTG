...
long double __convention("regparm")sub_589f3d(int32_t arg1, int16_t arg2 @ x87control, int16_t arg3 @ x87tag, long double arg4 @ st0, int32_t arg5, int32_t arg6, int32_t arg7)
{
    ...
    label_58a02a:
        ...
        if ((eax & 0x7ff00000) != 0 || ((arg5 & 0xfffff) | arg_4) != 0)
            ...
            label_589fb5:
                ...
                if (data_6cfd10 == 0)
                    return __startTwoArgErrorHandling(eax_1, 0x1d, result, &data_5ab000, var_4, 
                        __return_addr, arg_4)
            else
            label_589f8c:
                ...
                if (data_6cfd10 == 0)
                    ...
                    return __startTwoArgErrorHandling(eax_14, 0x1d, result, &data_5ab000, var_4, 
                        __return_addr, arg_4)

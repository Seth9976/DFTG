...
float __fastcallsub_4f03b0(float* arg1, int32_t arg2)
{
    // 第一条实际指令: void* const i = &data_5d3518
    void* const i = &data_5d3518
    float result
    ...
    do
        ...
        *(arg2 - &data_5d3518 + i) = _mm_unpacklo_ps(xmm2_14, arg1[1] f+ xmm0_32:4.d)
        *(arg2 - &data_5d3518 + i + 8) = result
        i += 0xc
    while (i s< &data_5d3570:8)

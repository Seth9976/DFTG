...
uint32_t (* __thiscallsub_53db30(void* arg1, int32_t arg2, int32_t* arg3))[0x4]
{
    ...
    *(arg1 + 0x60) = result
    ...
    if (*(arg1 + 0x10) == 0)
        int32_t var_70_1 = 0
        *(arg1 + 0x10) = sub_4d2c50(result, ecx_1, edi, 1, (ecx_2 << 1) + 3)
        result = sub_53e550(arg1 + 0x38)
        *result = 2
        int32_t* ecx_7 = *(arg1 + 0x10)
        
        if (ecx_7[1] == 3)
            void* eax_5 = sub_4981f0(ecx_7)
            uint32_t* edi_2 = &(*result)[7]
            uint32_t* var_48_2 = &result[3]
            *(eax_5 + 8) = (*result)[0x92]
            void* ecx_9 = data_aca1ec
            
            if (*(ecx_9 + 0x20) != 0)
                int32_t var_70_2 = 0
                int32_t* eax_6 =
                    sub_4d2c50(eax_5, *(ecx_9 + 0x18), *(ecx_9 + 0x14), 0x50, (ebx << 1) + 4)
                ecx_9 = data_aca1ec
                *(arg1 + 0x14) = eax_6
            ...
            if (result s>= 0)
                ...
                result = (*(*eax_9 + 0x24))(eax_9, 0, 0x60a280, edi_2)
            ...
            ecx_4 = "SUCCEEDED(hr)"
            var_78_1 = "d:\ax\trunk\ax2017\engine\windows\windowsdx11.cpp"
        else
            var_70 = "TextureGetDef"
            var_74 = 0x86
            var_78_1 = "d:\ax\trunk\ax2017\engine\texture.h"
    ...
    sub_489550(result, &data_5b2591, ecx_4, var_78_1, var_74, var_70)

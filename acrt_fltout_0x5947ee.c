    ...
    *arg3 = eax_7
    ...
    if ((arg1 & 0x7ff00000) != 0 || (ebx | (arg1 & 0xfffff)) != 0)
        ...
        label_595b1f:
            ...
            int80_t st0_1
            st0_1, ecx_14, x87control_1 = sub_597370(mxcsr, x87control, x87_r7_1)
            int32_t var_978_2 = ecx_14
            int32_t var_97c_1 = ecx_14
            var_97c_1.q = fconvert.d(st0_1)
            int32_t eax_22 = sub_5980b0(sub_597480(mxcsr, x87control_1, var_97c_1))
            ...
            if (var_76c_1 s< 0)
                ...
                if (eax_111 != 0)
                    while (true)
                        ...
                        uint32_t ecx_42 = zx.d(*((eax_111 << 2) + &data_5aa526))
                        uint32_t esi_28 = zx.d(*((eax_111 << 2) + &data_5aa527))
                        _memset(&var_574, 0, ecx_42 << 2)
                        sub_579300(&(&var_574)[ecx_42], 
                            (zx.d(*((eax_111 << 2) + &data_5aa524)) << 2) + &data_5a9c20, esi_28 << 2)
                ...
                if (ecx_41 != 0)
                    int32_t eax_139 = *((ecx_41 << 2) + &data_5aa5bc)
                ...
                if (eax_72 != 0)
                    ...
                    do
                        ...
                        uint32_t ecx_36 = zx.d(*((eax_72 << 2) + &data_5aa526))
                        uint32_t esi_23 = zx.d(*((eax_72 << 2) + &data_5aa527))
                        _memset(&var_574, 0, ecx_36 << 2)
                        sub_579300(&(&var_574)[ecx_36], 
                            (zx.d(*((eax_72 << 2) + &data_5aa524)) << 2) + &data_5a9c20, esi_23 << 2)
                ...
                if (ecx_35 != 0)
                    int32_t eax_105 = *((ecx_35 << 2) + &data_5aa5bc)
        ...
        arg3[1] = 0
        result, ecx_7, edx_2 = _strcpy_s(arg4, arg5, 0x5ae0f0)

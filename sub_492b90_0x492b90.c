...
void* __fastcallsub_492b90(int128_t* arg1)
{
    ...
    data_aca218 = xmm1
    data_aca228.q = arg1[3].q
    int64_t xmm0_3 = data_aca218:4.q
    float xmm1_1 = _mm_bsrli_si128(xmm1, 0xc)
    int128_t xmm0_4 = data_aca208:4.o
    int128_t var_80 = xmm0_4
    uint32_t eax_2 = sub_4979c0(&var_80)
    int32_t var_f8
    char* ecx_1
    ...
    if (eax_2.b != 0)
        ...
        int64_t xmm0_6 = data_1150e24
        float eax_4 = data_1150e2c
        int128_t var_40 = data_1150e3c
        eax_2 = sub_4979c0(&var_40)
        
        if (eax_2.b != 0)
            int64_t xmm0_8 = data_1150e30
            float eax_5 = data_1150e38
            int128_t var_60 = data_1150e4c
            eax_2 = sub_4979c0(&var_60)
    ...
    sub_489550(eax_2, &data_5b2591, ecx_1, "d:\ax\trunk\ax2017\engine\draw3d.cpp", var_f8, 
        "Draw3DSetCamera")

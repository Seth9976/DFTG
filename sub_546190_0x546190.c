...
int32_t* __fastcallsub_546190(int32_t* arg1, void* arg2)
{
    // 第一条实际指令: void var_b8
    void var_b8
    ...
    if (*(*(arg2 + 0x58) + 4) != 0x20 || result.b == 0)
        ...
        if (eax_4 == 3)
            ...
            if (eax_5 != 0 && *(eax_5 + 4) == 0x19)
                int16_t x87control_1 =
                    sub_51b1b0(eax_5, &data_1151b18, &var_40, &data_1151b0c, &data_5d22f4)
                void* esi_1 = data_aca1ec
                var_60 = 0f
                int32_t var_5c_1 = 0
                ...
                var_9c = xmm2_4 ^ (data_60cca0.o).d
                int32_t var_98_1 = xmm1_1 ^ (data_60cca0.o).d
                int64_t var_6c_1 = data_1151b0c.q
                int128_t var_7c_1 = var_3c
                int64_t* eax_8 = sub_4dad30(&var_60, &esi[4], &var_9c, &var_60)
                ...
                if (not(9.99999975e-06f f> sub_426e40(xmm1_6)))
                    ...
                    if (not(xmm2_5 < xmm1_11 * xmm1_6))
                        ...
                        float xmm1_13 = (xmm1_11 / xmm1_6) ^ (data_60cca0.o).d
                        ...
                        int32_t* eax_10
                        eax_10, mxcsr = sub_4fd190(ecx_2, &var_20)
                        
                        if (sub_489f20(0x10) != 0)
        ...
        if (*esi == 3)
            ...
            if (eax_15 != 0 && *(eax_15 + 4) == 2)
                int16_t x87control_2 =
                    sub_51b1b0(eax_15, &data_1151b18, &var_40, &data_1151b0c, &data_5d22f4)
                ...
                var_9c = xmm2_9 ^ (data_60cca0.o).d
                int32_t var_98_2 = xmm1_17 ^ (data_60cca0.o).d
                int64_t var_6c_2 = data_1151b0c.q
                int128_t var_7c_2 = var_3c
                int64_t* eax_18 = sub_4dad30(&var_40, &esi[4], &var_9c, &var_40)
                ...
                if (not(9.99999975e-06f f> sub_426e40(xmm6_10)))
                    float xmm1_23 = var_5c_2 * xmm2_10 + var_60 * xmm2_10 + xmm1_15 + -0f
                    
                    if (not(xmm2_10 < xmm1_23 * xmm6_10))
                        int32_t* ecx_5 = data_1151b48
                        float xmm1_25 = (xmm1_23 / xmm6_10) ^ (data_60cca0.o).d
                        var_40 = xmm3_7 * xmm1_25 + var_60
                        char** eax_19 = sub_4dcc00(ecx_5)
                        int64_t xmm0_50 = _mm_unpacklo_ps(var_40, xmm5_6 * xmm1_25 + var_5c_2)
                        int32_t eax_20 = eax_19[0x1a]
                        *(eax_19 + 8) = xmm0_50
                        eax_19[4] = xmm4_8 * xmm1_25 + xmm1_15
                        data_1151b70 = eax_20
                        void* eax_22 = *sub_4d4460(eax_19[1])
                        
                        if (eax_22 != 0 && *(eax_22 + 0x60) s> 0)
                            int32_t eax_23 = data_1151b74
                            
                            if (eax_23 != 0xffffffff)
                                sub_4f2cc0(eax_23, eax_19[1], eax_19, eax_23)
        
        result = sub_4dd900(data_1151b70)
        ...
        label_546731:
            ...
            if (*esi == 0 && esi[1] == 0x74)
                ...
                data_1151b18 = _mm_unpacklo_ps(xmm1_27, xmm1_27)
                data_1151b20 = 0
                data_1151b0c.q = _mm_unpacklo_ps(xmm1_27, 0x41000000)
                data_1151b14 = 0x40800000
                sub_5984f0()
                data_1151b24 = _mm_cvtpd_ps(zx.o(fconvert.d(fconvert.t(-4.0)))) ^ (data_60cca0.o).d
                result = sub_5984f0()
                data_1151b28 = _mm_cvtpd_ps(zx.o(fconvert.d(fconvert.t(4.0)))) ^ (data_60cca0.o).d
        else if (*esi == 0)
            if (esi[1] == 0x61)
                result = sub_4d4460(result_1[1])
                
                if (*(*result + 0x60) s> 0)
                    int32_t ecx_13 = data_1151b74 + 1
                    data_1151b74 = ecx_13
                    result = *result
                    
                    if (ecx_13 s< result[0x18])
                        result = sub_4f2cc0(result, result_1[1], result_1, ecx_13)
                    else
                        data_1151b74 = 0xffffffff
                        void* ecx_14 = result_1[0xb]
                        
                        if (ecx_14 != 0)
                            result = sub_4f13e0(ecx_14, 0)

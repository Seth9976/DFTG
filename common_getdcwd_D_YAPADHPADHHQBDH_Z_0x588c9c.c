// 函数名称: ??$common_getdcwd@D@@YAPADHPADHHQBDH@Z
// 虚拟地址: 0x588c9c
// 源二进制: E:/torrent/Cursor/Roll for the Galaxy/Roll.exe.bndb

void*??$common_getdcwd@D@@YAPADHPADHHQBDH@Z(int32_t arg1, char* arg2, int32_t arg3)
{
    // 第一条实际指令: if (arg3 s< 0)
    if (arg3 s< 0)
        *__errno() = 0x16
    ...
    if (arg2 == 0)
        ...
        sub_588b5f(&var_8, &var_20, __acrt_get_utf8_acp_compatibility_codepage())
        ...
        *arg2 = 0
        ...
        int32_t var_10_1 = 0
        char var_c = 0
        int32_t eax_7 = sub_588a60(&var_8, &var_20, __acrt_get_utf8_acp_compatibility_codepage())

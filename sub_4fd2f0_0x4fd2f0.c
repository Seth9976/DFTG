...
uint32_t __fastcallsub_4fd2f0(void* arg1)
{
    // 第一条实际指令: int32_t var_8 = 0xffffffff
    int32_t var_8 = 0xffffffff
    int32_t (* var_c)(void* arg1) = sub_5a189c
    TEB* fsbase
    ...
    while (*(esi + 0x10) != 0)
        ...
        if (eax_4 == 0)
            sub_489550(eax_4, &data_5b2591, "mpHead != NULL", "d:\ax\trunk\ax2017\engine\xlist.h", 
                0x53, "XList<struct ParticleEmitter>::GetHead")

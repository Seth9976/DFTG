...
int32_t __fastcallsub_488f90(int32_t arg1)
{
    // 第一条实际指令: int32_t __saved_ebp
    int32_t __saved_ebp
    int32_t eax_1 = __security_cookie ^ &__saved_ebp
    sub_4894d0("creating minidump")
    ...
    while (true)
        ...
        sub_41da20(&fileName, edx, ecx_1, &fileName, "%sminidump_%4d%02d%02d_%02d%02d%02d_%02d.dmp")
        ...
        if (esi s>= 0xa)
            sub_4894d0("Can't create minidump file handle")
            break
    ...
    int32_t result = sub_4894d0(eax_16)

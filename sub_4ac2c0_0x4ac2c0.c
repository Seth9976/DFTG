...
int32_tsub_4ac2c0(int32_t arg1, int32_t arg2)
{
    ...
    void var_140
    int32_t edx
    int128_t* eax_3 = sub_49abe0(&var_140, edx, data_642620, &var_140)
    int128_t var_58
    ...
    while (true)
        float xmm3_1 = data_642644
        float xmm1_5 = (*(&var_58 + (edi << 3)) * xmm5_1 f+ xmm2 f- data_642648) * xmm3_1
        float var_8c_1 = (*(&var_58:4 + (edi << 3)) * xmm0_4 f+ xmm4_1 f- data_64264c) * xmm3_1
        float var_120[0x4]
        int128_t var_98
        eax_5 = sub_4829a0(&var_120, &var_b0, &var_98:8, &var_120)
            ...
            if (edi s>= 8)
                ...
                if (not(xmm0_1 < xmm4_2))
                    ...
                    if (not(xmm0_3 < xmm6_1))
                        float xmm5_2 = data_642644
                        void* eax_7 = &var_88:4
                        void* var_a8_1 = &var_88:4
                        float xmm0_13 = (xmm0_3 f- data_64264c) * xmm5_2
                        int32_t edi_1 = 0
                        float var_8c_2 = 2.80259693e-45f
                        float xmm1_10[0x4] = (xmm0_1 f- data_642648) * xmm5_2
                        float xmm2_4 = (xmm4_2 f- data_642648) * xmm5_2
                        float xmm3_5 = (xmm6_1 f- data_64264c) * xmm5_2
                        var_c0[3] = xmm0_13
                        var_c0[0] = xmm2_4
                        var_c0[1] = xmm3_5
                        var_c0[2] = xmm1_10
                        ...
                        while (true)
                            ...
                            float xmm0_18 =
                                (*(&var_58:4 + (eax_8 << 3)) * xmm0_4 + xmm6_1 f- data_64264c) * xmm5_2
                            float var_d0 =
                                (var_9c f* *(&var_58 + (eax_8 << 3)) + xmm4_2 f- data_642648) * xmm5_2
                            float var_cc_1 = xmm0_18
                            void var_150
                            float xmm6_2[0x4] = *sub_4829a0(&var_150, &var_c8, &var_d0, &var_150)
                            var_120 = xmm6_2
                            float xmm0_23 = (*(&var_58:4 + (var_8c_2 << 3)) * xmm0_4
                                + var_110[0] f- data_64264c) f* data_642644
                            var_c0[2] = (*(&var_58 + (var_8c_2 << 3)) * var_9c f+ *eax_3 f- data_642648)
                                f* data_642644
                            var_c0[3] = xmm0_23
                            void var_160
                            eax_5 = sub_4829a0(&var_160, &var_d8, &var_c0[2], &var_160)
    ...
    sub_489550(eax_5, &data_5b2591, ecx_11, "d:\ax\trunk\ax2017\engine\rect.cpp", var_178, var_174_4)

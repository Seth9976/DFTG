...
int32_t __convention("regparm")sub_55eb30(int32_t arg1, int32_t arg2, int32_t* arg3, long double arg4 @ st0, long double arg5 @ st3, long double arg6 @ st7, int32_t arg7, uint32_t (* arg8)[0x4], void* arg9)
{
    // 第一条实际指令: long double x87_r1
    long double x87_r1
    long double x87_r2
    int32_t eax = sub_55e800(arg3, arg4, x87_r1, x87_r2)
    ...
    *arg3 = arg2
    ...
    arg3[0x17] = 1
    arg3[0x18] = 0
    int32_t eax_4 = sub_55a9d0(ecx_2, xmm1, arg5)
    float xmm1_1 = arg3[0xf]
    int32_t ecx_3 = arg3[0x15]
    arg3[0x20] = eax_4
    long double x87_r4
    int32_t eax_5 = sub_55a9d0(ecx_3, xmm1_1, x87_r4)
    float xmm1_2 = arg3[0xe]
    int32_t ecx_4 = arg3[0x14]
    arg3[0x21] = eax_5
    long double x87_r5
    int32_t eax_6 = sub_55a950(ecx_4, xmm1_2, x87_r5)
    ...
    int32_t ecx_6
    long double x87_r6
    eax_7, ecx_6 = sub_55a950(ecx_5, xmm1_3, x87_r6)
    float xmm1_4 = arg3[0xe]
    arg3[0x23] = eax_7
    int32_t var_2c_1 = ecx_6
    int32_t var_8 = (&data_6cedac)[arg3[0x14] * 2]
    int32_t eax_10
    eax_10.b = xmm1_4 > 1f
    long double x87_r7
    ...
    int32_t eax_32
    int32_t ecx_16
    eax_32, ecx_16 = sub_55b3a0(eax_31, edx_5, ecx_15, xmm3, x87_r1, var_38, xmm0_8, var_30, var_2c_7)
    int32_t var_34_3 = ecx_16
    int32_t ecx_18 = sub_55b3a0(eax_32, arg3[0x1c], arg3[0x1b], arg3[0xf], x87_r2, arg3[0x15], 
    ...
    if (eax_33 == 0)
        sub_55e640(arg3, arg5)
    else
        int32_t var_2c_9 = ecx_18
        (&data_6cedac)[arg3[0x15] * 2](1f / xmm1_6)
        int32_t i = 0
        int32_t i_1 = 0
        ...
        if (arg3[6] s> 0)
            do
                ...
                int32_t j_1 = 0
                float var_1c
                sub_55aac0(&j_1, &var_8, i, var_18_1, xmm1_6, xmm3_2, &j_1, &var_1c)
                int32_t edx_8 = arg3[0x2c]
                int32_t edi_2 = var_8
                
                if (edx_8 s< 0)
                label_55eebb:
                    sub_55cc60(arg3, edi_2)
                else

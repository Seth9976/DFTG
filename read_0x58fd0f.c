...
int32_t__read(int32_t arg1, wchar16* arg2, uint32_t arg3)
{
    ...
    int32_t var_8 = 0x61bff0
    int32_t (* var_10)(int32_t* arg1, void* arg2, void* arg3) = __except_handler4
    TEB* fsbase
    struct _EXCEPTION_REGISTRATION_RECORD* ExceptionList = fsbase->NtTib.ExceptionList
    uint32_t __security_cookie_1 = __security_cookie
    int32_t var_8_3 = 0x61bff0 ^ __security_cookie_1
    int32_t __saved_ebp
    int32_t var_34 = __security_cookie_1 ^ &__saved_ebp
    int32_t* var_1c = &var_34
    void* const var_38_2 = &data_58fd1b
    ...
    if (arg1 != 0xfffffffe)
        ...
        if (arg1 s< 0 || arg1 u>= data_6cfd08 || (*(ecx_1 + (&data_6cfb08)[ebx_2] + 0x28) & 1) == 0)
            *___doserrno() = 0
            *__errno() = 9
            ...
            if ((*(ecx_1 + (&data_6cfb08)[ebx_2] + 0x28) & 1) != 0)
    ...
    fsbase->NtTib.ExceptionList = ExceptionList
    void* const __saved_ebp_2 = &data_58fe18
    return result
}

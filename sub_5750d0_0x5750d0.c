...
void __fastcallsub_5750d0(int32_t* arg1)
{
    // 第一条实际指令: float xmm0 = arg1[4]
    float xmm0 = arg1[4]
    void* ebx = arg1[3]
    float xmm0_1 = arg1[5]
    float xmm0_2 = arg1[6]
    ...
    do
        ...
        eax, edx =
            sub_52f800(eax_1, edx, esi_1, xmm6_1, xmm7_1, var_c_1, xmm4_2, xmm5_2, esi_1[0x11], xmm0_31)
        i = i_1 + 1
        i_1 = i
    while (i s< arg1[1])
}

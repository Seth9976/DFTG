...
char*sub_4e69a0(int32_t arg1, int32_t arg2)
{
    // 第一条实际指令: int32_t var_8 = 0xffffffff
    int32_t var_8 = 0xffffffff
    int32_t (* var_c)(void* arg1) = sub_5a0e03
    TEB* fsbase
    ...
    while (true)
        char* const var_160 = &data_5b2591
        var_8_1.b = 1
        ...
        if (sub_4897d0(ecx_1, &findFileData).b != 0)
            while (true)

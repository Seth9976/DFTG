...
int32_t __thiscallsub_53cda0(void* arg1, float* arg2)
{
    // 第一条实际指令: int32_t var_8 = 0xffffffff
    int32_t var_8 = 0xffffffff
    int32_t (* var_c)(void* arg1) = sub_5a2e30
    TEB* fsbase
        ...
        if (ecx_4 u< *(arg1 + 0x3c))
            ...
            if (esi_2[0x92] == eax_4)
                *(arg1 + 0x54) = *ebx_1
                ...
                sub_53cc70((*(*eax_7 + 0x2c))(eax_7, esi_2[0xa], 0, 0), ebx_1, ebx_1, esi_2, arg2)
                int32_t* esi_3 = ebx_1[0xfc]
                int32_t** var_2c_2 = &var_18
                sub_4889e0(&var_14, esi_3, 4)
                int32_t var_8_3 = 1
                eax_4 = var_18[0xe]
                
                if (eax_4 == 0)
                    eax_4 = (*(*data_114ec78 + 0x44))(esi_3, 1)
                    var_18[0xe] = eax_4
                ...
                if (eax_4 != 0)
                    ...
                    if (ecx_11 u< *(arg1 + 0x3c))
                        ...
                        if (esi_5[0x92] == eax_4)
                            ...
                            sub_53cc70((*(*eax_11 + 0x24))(eax_11, esi_5[0xb], 0, 0), &ebx_1[0xfc], 
                                ebx_1, esi_5, arg2)
                            int32_t eax_13 = ebx_1[0x390]
                            void* edx_3 = data_1151ae8
                            int32_t* esi_6
                            ...
                            if (*esi_6 != 5)
                                sub_489550(eax_13, &data_5b2591, 
                                    ...
                                    "d:\ax\trunk\ax2017\engine\windows\windowsdx11.cpp", 0x843, 

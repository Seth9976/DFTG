...
int32_t* __convention("regparm")sub_4db4b0(int32_t arg1, int64_t* arg2, int32_t* arg3, int32_t* arg4)
{
    ...
    void var_e0
    int128_t* eax_5 = sub_4dbdc0(&var_e0, arg3, &var_60, &var_e0)
    var_38.o = *eax_5
    int128_t var_34 = eax_5[1]
    float var_80[0x4]
    int64_t* eax_7 = sub_4dbbe0(&var_80, arg3, &var_38, &var_80)
    ...
    float var_50_2
    var_50_2:8.q = xmm7_7
    int32_t* result = sub_4db7c0(xmm0_36, &var_60:8, &var_c0, arg4)

...
void*sub_571690(void* arg1, void* arg2, float arg3, float arg4, int32_t arg5)
{
    ...
    if (edi[0x1c] != 0)
        ...
        if (*ebx_1 f<= arg3)
            ...
            if (arg5 == 0)
                void* eax_11 = *edi
                edi[4] = (xmm2_1 f- *(eax_11 + 0x28)) * arg4 f+ *(eax_11 + 0x28)
                return eax_11
            
            edi[4] = (xmm2_1 f- edi[4]) * arg4 f+ edi[4]
        else
            if (arg5 == 0)
            ...
            if (arg5 == 1)
                void* eax_4 = *edi
                edi[4] = (*(eax_4 + 0x28) f- edi[4]) * arg4 f+ edi[4]
                return eax_4

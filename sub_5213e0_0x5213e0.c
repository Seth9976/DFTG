...
int32_t __fastcallsub_5213e0(void* arg1)
{
    // 第一条实际指令: int32_t var_8 = 0xffffffff
    int32_t var_8 = 0xffffffff
    int32_t (* var_c)(void* arg1) = sub_5a25e8
    TEB* fsbase
    ...
    int32_t** eax_4 = sub_4889e0(&arg_4, esi, 4)
    int32_t var_8_1 = 0
    void* ebx = arg_8
    void* edi = *(ebx + 8)
    int32_t result
    ...
    if (edi == 0)
        ...
        void* eax_5 = sub_521050(eax_4, *(edi + 0x38), 0x8b31, esi)
        arg_8 = eax_5
        
        if (eax_5 != 0)
            void* edi_1 = *(ebx + 0x30)
            eax_5 = sub_521050(eax_5, *(edi_1 + 0x38), 0x8b30, esi)
            
            if (eax_5 != 0)
                int32_t eax_6 = sub_520f60(arg_8, eax_5)
                
                if (eax_6 == 0)
                    result = 0
                else
                    int32_t* eax_7 = sub_523220(arg1 + 0x4240)
                    *eax_7 = eax_6
                    eax_7[1] = 3
                    sub_520cd0(eax_7, ebx + 0x28, eax_6, eax_7)
                    int32_t esi_2 = *eax_7
                ...
                sub_521050(eax_5, *(edi_1 + 0x48), 0x8b30, esi)
                result = 0
        else
            sub_521050(eax_5, *(edi + 0x48), 0x8b31, esi)
            result = 0

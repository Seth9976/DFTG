...
int32_t __convention("regparm")sub_561f00(int32_t arg1, uint32_t (* arg2)[0x4], int32_t* arg3, void* arg4, int32_t arg5)
{
    ...
    if (eax_3 u>= 0xff)
        ...
        ebx_2 -= edx
        eax_4 = (esi u>> (0x20 - edx.b) & *((edx << 2) + &data_5d3cb8)) + *(arg4 + (edx << 2) + 0x64c)
        arg3[0x11f0] = ebx_2
    ...
    label_562037:
        ...
        int32_t ecx_10 = *((eax_5 << 2) + &data_5d3cb8)
        arg3[0x11ef] = not.d(ecx_10) & esi_4
        arg3[0x11f0] = ebx_2 - var_8
        ebx_6 = (*((var_8 << 2) + &data_5d3c78) & not.d(edx_1 s>> 0x1f)) + (ecx_10 & esi_4)

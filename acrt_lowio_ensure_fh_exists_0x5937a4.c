...
int32_t___acrt_lowio_ensure_fh_exists(int32_t arg1)
{
    ...
    int32_t var_8 = 0x61c0d8
    int32_t (* var_10)(int32_t* arg1, void* arg2, void* arg3) = __except_handler4
    TEB* fsbase
    struct _EXCEPTION_REGISTRATION_RECORD* ExceptionList = fsbase->NtTib.ExceptionList
    uint32_t __security_cookie_1 = __security_cookie
    int32_t var_8_3 = 0x61c0d8 ^ __security_cookie_1
    int32_t __saved_ebp
    int32_t var_34 = __security_cookie_1 ^ &__saved_ebp
    int32_t* var_1c = &var_34
    void* const var_38_2 = &data_5937b0
    ...
    if (arg1 u< 0x2000)
        ...
        while (true)
            ...
            if ((&data_6cfb08)[edi_1] == 0)
                void* eax_3 = ___acrt_lowio_create_handle_array()
                (&data_6cfb08)[edi_1] = eax_3
    ...
    fsbase->NtTib.ExceptionList = ExceptionList
    void* const __saved_ebp_2 = &data_5937cf
    return result
}

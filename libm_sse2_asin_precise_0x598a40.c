    ...
    if ((arg1 & 0x7f80) == 0x1f80)
        ...
        if (eax_1.w == 0x7f)
            ...
            if ((0x7ffff & xmm0) - 0x3fb00 u< 0x3bb)
                ...
                *((((xmm0 & 0xfffc) - 0xfb00) << 1) + &data_60e5a0)
                uint64_t xmm2_1[0x2] = _mm_or_pd(xmm2, xmm5_1)
                _mm_shuffle_epi32(
                    _mm_xor_pd(*((((xmm0 & 0xfffc) - 0xfb00) << 2) + &data_60d6a0), 
            ...
            if ((0x7ffff & xmm0) - 0x3febb u< 0x43)
                ...
                double xmm7_3 = __andpd_xmmxuq_memxuq(xmm7, *0x60cf80)
                ...
                double xmm3_10[0x2] = __subpd_xmmpd_mempd(data_60cf50, *((edx_6 << 3) + &data_60d6a0))
            ...
            if ((0x7ffff & xmm0) - 0x3c300 u< 0x3800)
                ...
                double xmm6_12[0x2] = data_60cfa0
                double xmm1_13[0x2] = _mm_unpacklo_pd(xmm1, xmm7_9)
                double xmm2_8[0x2] = data_60cfb0
                double xmm4_8[0x2] = data_60cfc0
            ...
            double xmm5_10[0x2] = data_60cfb0
            double xmm0_21[0x2] = data_60cfc0
            ...
            uint32_t xmm0_22[0x4] = data_60cf50

...
int32_t __convention("regparm")sub_562110(int32_t arg1, int32_t arg2, int32_t* arg3, void* arg4, int32_t arg5)
{
    ...
    if (i != 0)
        ...
        if (arg3[0x11f6] != 0)
            ...
            if (ebx_1 != 0)
                ...
                do
                    uint32_t eax_35 = zx.d(*(i + 0x5d3c28))
            ...
            while (true)
                ...
                if (eax_43 u>= 0xff)
                    ...
                    ebx_15 = ebx_6 - edx_13
                    eax_43 = (edx_11 u>> (0x20 - edx_13.b) & *((edx_13 << 2) + &data_5d3cb8))
                        + *(arg4 + (edx_13 << 2) + 0x64c)
                ...
                if (eax_49 != 0)
                    ...
                    if (edx_16 != 0)
                        ...
                        int32_t ecx_41 = *((edx_16 << 2) + &data_5d3cb8)
                ...
                do
                    uint32_t eax_64 = zx.d(*(i + 0x5d3c28))
                    i += 1
            ...
            while (true)
                ...
                if (ecx_3 == 0)
                    ...
                    if (eax_11 u>= 0xff)
                        ...
                        var_14_1 = ebx_7
                        eax_11 = (var_10_1 u>> (0x20 - edx_6.b) & *((edx_6 << 2) + &data_5d3cb8))
                            + *(arg4 + (edx_6 << 2) + 0x64c)
                        edx_5 = var_14_1
                        arg3[0x11f0] = ebx_7
                    ...
                    if (eax_17 != 0)
                        void* edi_1 = i + ecx_15
                        uint32_t ecx_16 = zx.d(*(edi_1 + 0x5d3c28))
                        i = edi_1 + 1
                        ...
                        *(arg2 + (ecx_16 << 1)) = (((not.d(ebx_4 s>> 0x1f)).w
                        ...
                        if (ecx_15 u< 0xf)
                            ...
                            if (ecx_15 != 0)
                                ...
                                int32_t edi_3 = *((ecx_15 << 2) + &data_5d3cb8)
                    ...
                    uint32_t eax_7 = zx.d(*(edi + 0x5d3c28))
                    i = edi + 1

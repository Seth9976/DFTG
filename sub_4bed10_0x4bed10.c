...
uint32_t (*sub_4bed10())[0x4]
{
    ...
    if (esi != 0)
        ...
        if (*(ecx + 0x3c) == 0)
            ...
            var_380_1 = 0xd9
            var_384_1 = "d:\ax\trunk\ax2017\engine\sprite.cpp"
            ecx_1 = "gpSpriteAppData->pLockedVerts"
        label_4beef0:
            sub_489550(result, &data_5b2591, ecx_1, var_384_1, var_380_1, var_37c_1)
        ...
        result = (*(*data_114ec78 + 0x68))(ebx_1, esi * 0x60)
        void* esi_1 = data_114e814
        ...
        *(esi_1 + 0x3c) = 0
        ...
        if (result == 0)
            ...
            var_380_1 = 0x53
            ecx_1 = "mpHead != NULL"
            var_384_1 = "d:\ax\trunk\ax2017\engine\xlist.h"
            goto label_4beef0
    ...
    label_4bee30:
        ...
        if (ecx_5 != 0)
            sub_4efc60(eax_5, 0x53, eax_5, ecx_5)
        
        void var_2e8
        (*(*data_114ec78 + 0x7c))(&var_2e8)
        (*(*data_114ec78 + 0x40))(&var_368)
        void* esi_2 = data_114e814
        int32_t edx_3 = *(esi_2 + 0x18)
        (*(*data_114ec78 + 0x3c))(4, ebx_1, *(esi_2 + 0x14), 1, edx_3 * 2, edx_3 << 2, 0, 0)
        void* ecx_10 = data_114e814

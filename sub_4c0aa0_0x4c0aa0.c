...
int32_t __fastcallsub_4c0aa0(float* arg1)
{
    // 第一条实际指令: void var_fc
    void var_fc
    ...
    int32_t edx_1
    int32_t xmm0_5
    edx_1, xmm0_5 = sub_41f100(-0.785398185f)
    int32_t var_18 = xmm0_5
    void var_68
    int128_t* eax_5 = sub_4c2cf0(&var_68, edx_1, &var_24, &var_68)
    var_f0 = *eax_5
    int128_t var_e0 = eax_5[1]
    int128_t var_d0 = eax_5[2]
    int128_t var_c0 = eax_5[3]
    float* eax_7 = sub_497e60(&var_68, &var_f0, &var_b0, &var_68)
    int128_t xmm1_2 = *(eax_7 + 0x10)
    int128_t xmm2 = *(eax_7 + 0x20)
    int128_t xmm3 = *(eax_7 + 0x30)
    void* eax_8 = data_114ec70
    *(eax_8 + 0xa4) = *eax_7
    *(eax_8 + 0xe4) = 1
    *(eax_8 + 0xb4) = xmm1_2
    *(eax_8 + 0xc4) = xmm2
    *(eax_8 + 0xd4) = xmm3
    int32_t result = sub_496500(&arg1[5])

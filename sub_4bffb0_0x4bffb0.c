...
int32_t __convention("regparm")sub_4bffb0(int32_t arg1, float* arg2, int32_t* arg3, float* arg4, int32_t* arg5, int32_t* arg6)
{
    ...
    if (*(eax_2 + 0xe7) == 0)
        ...
        eax_3 = sub_4bef10(arg4, &var_4c, &var_2c, edx, 0, arg3, arg6)
    else
        float xmm1_3 = (arg2[2] - *arg2) * 6.5f f/ *(eax_2 + 0xec)
        float xmm1_4
        ...
        if (edi_1 s> 0)
            ...
            do
                ...
                eax_6 = sub_4bef10(eax_5, &var_2c, &var_4c, edx, 0, arg3, arg6)
                xmm0_2 = var_58
                ebx_1 += 1
                arg3 = var_5c
                edx = var_60

...
void* __convention("regparm")sub_48a180(int32_t arg1, int32_t arg2, int32_t* arg3, char arg4)
{
    ...
    if (eax_3 == 0 || *eax_3 == 0)
        eax_8 = sub_48a0e0(arg3, arg2)
    else
        char* eax_4 = sub_48a080(arg3)
        void* ecx = *(eax_4 + 8)
        ...
        if (arg4 != 0)
            eax_8 = sub_579300(*arg3, esi_1, ecx)
        ...
        if (data_aca1f4 != 0 && esi_1 != 0 && *esi_1 != 0)
            ...
            *(eax_8 + 4) -= 1
            ...
            if (temp1_1 == 1)
                int32_t eax_9 = sub_4984f0(eax_8, *(eax_8 + 0xc) + 0x10)
                fsbase->NtTib.ExceptionList = ExceptionList
                return eax_9

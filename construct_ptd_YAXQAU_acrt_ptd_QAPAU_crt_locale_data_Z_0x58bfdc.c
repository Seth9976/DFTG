// 函数名称: ?construct_ptd@@YAXQAU__acrt_ptd@@QAPAU__crt_locale_data@@@Z
// 虚拟地址: 0x58bfdc
// 源二进制: E:/torrent/Cursor/Roll for the Galaxy/Roll.exe.bndb

int32_t?construct_ptd@@YAXQAU__acrt_ptd@@QAPAU__crt_locale_data@@@Z(int32_t* arg1)
{
    // 第一条实际指令: arg1[6] = 1
    arg1[6] = 1
    *arg1 = 0x5ab010

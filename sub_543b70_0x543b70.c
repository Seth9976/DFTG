...
int32_t __fastcallsub_543b70(char* arg1)
{
    // 第一条实际指令: int32_t var_8 = 0xffffffff
    int32_t var_8 = 0xffffffff
    int32_t (* var_c)(void* arg1) = sub_5a3227
    TEB* fsbase
    ...
    char* hFindFile_3
    sub_4e5700(&hFindFile_3, arg1)
    int32_t var_8_1 = 0
    int32_t* ecx_1 = data_1150b90
    int32_t* hFindFile_2 = &hFindFile_3
    sub_48a560(ecx_1, hFindFile_2)
    int32_t var_8_2 = 1
    ...
    if (data_aca1f4 != 0)
        ...
        if (hFindFile_4 != 0 && *hFindFile_4 != 0)
            char* eax_3 = sub_48a080(&hFindFile_3)
    ...
    if (sub_4897d0(arg1, &var_29c) != 0)
        ...
        do
            if (((var_29c.dwFileAttributes u>> 4).b & 1) == 0)
                ...
                hFindFile_2 = &var_270
                char* var_2c0_1 = arg1
                int32_t xmm0_1[0x4] = sub_48a910(&var_2a0, "%s%s")
                ...
                if (esi_1 != 0)
                    ...
                    edi_1 = &data_5b2591
                label_543c7f:
                    hFindFile_2 = &data_5f8548
                    void* eax_7
                    int32_t xmm0_2[0x4]
                    eax_7, xmm0_2 = _strstr(xmm0_1, edi_1, hFindFile_2)
                    
                    if (eax_7 == 0)
                        hFindFile_2 = &data_5f854c
    ...
    sub_48a2c0(&var_2a0, &data_5b2591)
    int32_t var_8_7 = 6
    int32_t* ecx_13 = data_1150b90
    hFindFile_2 = &var_2a0
    sub_48a560(ecx_13, hFindFile_2)
    int32_t var_8_8 = 7
    ...
    if (data_aca1f4 != 0)
        ...
        if (eax_16 != 0 && *eax_16 != 0)
            char* eax_17 = sub_48a080(&var_2a0)
    ...
    char result = sub_4897d0(arg1, &var_158)
        ...
        do
            if (((var_158.dwFileAttributes u>> 4).b & 1) != 0 && var_158.cFileName[0] != 0x2e)
                ...
                if (data_aca1f4 != 0 && esi_2 != 0 && *esi_2 != 0)
                    char* eax_20 = sub_48a080(&var_2a0)

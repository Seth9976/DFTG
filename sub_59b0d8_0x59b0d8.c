...
void __convention("regparm")sub_59b0d8(int32_t arg1, int16_t arg2 @ x87control, long double arg3 @ st0, int32_t arg4)
{
    // 第一条实际指令: int32_t edx
    int32_t edx
    int32_t var_4 = edx
    ...
    if (z)
        ...
        if (data_6cfd10 == 0)
            __startOneArgErrorHandling(1, 0x12, data_5abfb0, 0x60edb0, var_4)
            return 
    else
        int16_t x87control
        int16_t x87status_1
        ...
        if (test_bit(arg1:1.b, 2))
            ...
            long double x87_r0_1 = data_5abffa
        ...
        if (data_6cfd10 == 0)
            ...
            if (arg1.w != 0x27f)
                ...
                if (arg1.w != 0)
                    ...
                    if (arg1.w != 0)
                        __startOneArgErrorHandling(8, 0x12, x87_r0, 0x60edb0, var_4)
                        return 

...
int32_t __convention("regparm")sub_561b60(int32_t arg1, uint32_t (* arg2)[0x4], int32_t* arg3, void* arg4, void* arg5, int32_t arg6, int32_t arg7, int16_t* arg8)
{
    ...
    if (eax_4 u>= 0xff)
        ...
        if (edx_1 == 0x11)
            ...
            eax_6 = (edi u>> (0x20 - edx_1.b) & *((edx_1 << 2) + &data_5d3cb8))
                + *(arg4 + (edx_1 << 2) + 0x64c)
        ...
        label_561c51:
            ...
            if (ebx_3 == 0)
                ...
                int32_t ecx_10 = *((ebx_3 << 2) + &data_5d3cb8)
                arg3[0x11ef] = not.d(ecx_10) & edi_4
                int32_t ebx_5 = *((ebx_3 << 2) + &data_5d3c78) & not.d(edx_2 s>> 0x1f)
            ...
            while (true)
                ...
                if (ecx_18 == 0)
                    ...
                    if (eax_36 u>= 0xff)
                        ...
                        ebx_10 = ebx_1 - edx_9
                        eax_36 = (var_10_1 u>> (0x20 - edx_9.b) & *((edx_9 << 2) + &data_5d3cb8))
                            + *(arg5 + (edx_9 << 2) + 0x64c)
                    ...
                    if (edx_11 != 0)
                        ...
                        uint32_t ecx_32 = zx.d(*(eax_42 + 0x5d3c28))
                        arg4 = eax_42 + 1
                    ...
                    arg4 = edx_6 + 1
                    int16_t* edx_8 = zx.d(*(edx_6 + 0x5d3c28)) * 2

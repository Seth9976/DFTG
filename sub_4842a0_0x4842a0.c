...
char** __convention("regparm")sub_4842a0(int32_t arg1, int32_t arg2, char** arg3, int32_t* arg4, char arg5)
{
    ...
    int32_t var_1c = 0
    int32_t esi = *arg4
    int32_t edi = **(data_632804 + esi * 0xc + 0x8c4)
    int32_t var_30 = sub_482da0(sub_480c10(esi, 0), *(*(data_632804 + esi * 0xc + 0x8c4) + 0x10))
    int32_t var_34 = edi
    int32_t var_38 = arg2

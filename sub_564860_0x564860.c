...
int32_t __fastcallsub_564860(int32_t* arg1, int32_t arg2)
{
    ...
    if (eax s>= 0xb)
        ...
        label_5648b8:
            ...
            if (ecx_1 == 8)
                uint32_t eax_3 = sub_561390(esi)
                esi[1] = eax_3
                
                if (eax_3 != 0)
                    uint32_t eax_4 = sub_561390(esi)
                    *esi = eax_4
                                ...
                                if (ecx_7 s> 0)
                                    ...
                                    do
                                        ...
                                        *(edi_1 - 4) = ecx_9
                                        ...
                                        if (esi[2] == 3 && ecx_9 == zx.d(*(edx + &data_60b76c)))
                                            ebx[0x11fb] += 1
                                                ...
                                                if (esi[2] s> 0)
                                                    ...
                                                    while (true)
                                                        ...
                                                        *(ebx_2 + 0xc) = edi_7
                                                        ...
                                                        return sub_5647e0(eax_54, var_14_2 + 1, var_c, 
                                                            0)

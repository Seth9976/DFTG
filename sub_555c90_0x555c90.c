...
HWND __convention("regparm")sub_555c90(int32_t arg1, int32_t arg2, HWND arg3, int32_t arg4, int16_t arg5)
{
    // 第一条实际指令: int32_t __saved_ebp
    int32_t __saved_ebp
    int32_t eax_1 = __security_cookie ^ &__saved_ebp
    int32_t ecx = *(data_1511868 + 0x24)
    ...
    *(data_1511868 + 0x40) = 1
    *(data_1511868 + 0x4c) = rect.top
    *(data_1511868 + 0x50) = rect.bottom
    *(data_1511868 + 0x44) = arg4

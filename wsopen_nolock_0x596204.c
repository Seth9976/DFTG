...
int32_t__wsopen_nolock(int32_t* arg1, int32_t* arg2, int32_t arg3, int32_t arg4, int32_t arg5, char arg6)
{
    ...
    int32_t ecx
    int32_t edx
    __builtin_memcpy(&var_30, sub_595f48(&var_48, edx, ecx, &var_48, arg4, arg5, arg6), 0x18)
    int32_t var_24
            ...
            *arg1 = 1
            ...
            label_59632b:
                ...
                if (eax_22 != FILE_TYPE_UNKNOWN)
                    ...
                    var_30 = edx_1.b
                    *((&data_6cfb08)[ecx_10 s>> 6] + (ecx_10 & 0x3f) * 0x30 + 0x28) = edx_1.b
                    int32_t ecx_13 = *arg2
                    int32_t ecx_15 = (ecx_13 & 0x3f) * 0x30
                    int32_t eax_33 = (&data_6cfb08)[ecx_13 s>> 6]
                    *(eax_33 + ecx_15 + 0x29) = 0
                    ...
                    int32_t eax_36 =
                        sub_595c6a(&var_6, edx_1, __builtin_memcpy(&var_74, &var_30, 0x18), *arg2)
                    int32_t edx_2 = *arg2
                    ...
                    *(ecx_24 + edx_5 + 0x2d) ^= ((arg4 u>> 0x10).b ^ *(ecx_24 + edx_5 + 0x2d)) & 1
                    ...
                    if (eax_46 != 0xffffffff)
                        int32_t ecx_32 = *arg2
                        *((&data_6cfb08)[ecx_32 s>> 6] + (ecx_32 & 0x3f) * 0x30 + 0x18) = eax_46
                        return 0
                    
                    ___acrt_errno_map_os_error(GetLastError())
                    int32_t ecx_28 = *arg2
                    int32_t ecx_30 = (ecx_28 & 0x3f) * 0x30
                    int32_t eax_50 = (&data_6cfb08)[ecx_28 s>> 6]
                    *(eax_50 + ecx_30 + 0x28) &= 0xfe
                    ...
                    int32_t eax_26 = (&data_6cfb08)[ecx_7 s>> 6]
            ...
            label_5962ff:
                ...
                int32_t eax_20 = (&data_6cfb08)[ecx_3 s>> 6]

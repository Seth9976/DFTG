...
int32_t __fastcallsub_566760(uint32_t arg1)
{
    ...
    while (true)
        ...
        while (true)
            ...
            if (eax_6 == 0)
                eax_7, arg1 = sub_5666a0(esi, &esi[8])
            else
                arg1 = eax_6 u>> 9
            ...
            if (eax_7 s>= 0x100)
                ...
                int32_t eax_11 = (&data_5d3724)[eax_7]
                int32_t i_1 = esi[2]
                void* i_7 = (&data_5d37a4)[eax_7]
                ...
                if (eax_26 s>= 0)
                    int32_t edi_11 = *((eax_26 << 2) + &data_5d3aa8)
                    int32_t eax_27 = *((eax_26 << 2) + &data_5d3a28)

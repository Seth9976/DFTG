...
struct _EXCEPTION_REGISTRATION_RECORD**___std_fs_remove@4()
{
    ...
    int32_t (* var_c)(void* arg1) = sub_59cc48
    TEB* fsbase
    ...
    int32_t var_8_1 = 0
    char* var_20
    sub_48a2c0(&var_20, "Roll")
    var_8_1.b = 1
    int32_t eax_5 = *(sub_437f10(*(data_6d00d8 + 0xbe4)) + 0x22c)
    char* var_1c
    sub_48a2c0(&var_1c, "-Steam")
    var_8_1.b = 2
    var_8_1.b = 3
    char* const var_18
    sub_48a560(&var_24, sub_48a860(&var_20, &var_18, &var_1c))
    var_8_1.b = 4
    ...
    int32_t var_44 = *(data_aca1ec + 0x10)
    char* const var_48 = ecx_13
    int32_t var_4c = eax_5
    char* var_14
    sub_48a9d0(&var_14, "v=1&tid=UA-34292269-5&cid=%d&t=screenview&an=%s&av=%s&aid=%s&cd=%s")
    var_8_1.b = 6
    ...
    char* ecx_15
    int32_t edx_5
    eax_14, ecx_15, edx_5 = sub_48b280()
    char* const var_3c_3 = ecx_14
    *eax_14 = data_6cfe58
    *(eax_14 + 0x14) = 1
    *(eax_14 + 0x24) = 1
    *(eax_14 + 0x28) = 2
    sub_48d6e0(eax_14, edx_5, eax_14, ecx_15)
    var_8_1.b = 7
    char* eax_15

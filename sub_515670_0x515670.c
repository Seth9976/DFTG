...
LRESULTsub_515670()
{
    ...
    int32_t (* var_c)(void* arg1) = sub_5a2240
    TEB* fsbase
    ...
    if (data_1152b94 != 0)
        ...
        if (result != 0)
            ...
            char* const var_13c_1 = &data_5b2591
            char const* const var_140 = "Model"
            SendMessageA(hWnd, 0x180, 0, &lParam)
            var_174_4.q = _mm_cvtps_pd(*(result + 0x18))
            HWND var_17c_3
            var_17c_3.q = _mm_cvtps_pd(*(result + 0x14))
            int64_t var_184_1 = _mm_cvtps_pd(*(result + 0x10))
            char const* const var_188_1 = "%g %g %g"
            char* const var_118
            sub_48a9d0(&var_118, "%g %g %g")
            char* eax_7 = var_118
            ...
            char* const var_124_3 = &data_5b2591
            ...
            var_174_5.q = _mm_cvtps_pd(*(result + 0x24))
            HWND var_17c_4
            var_17c_4.q = _mm_cvtps_pd(*(result + 0x20))
            int64_t var_184_2 = _mm_cvtps_pd(*(result + 0x1c))
            ...
            char* const var_124_4 = &data_5b2591
            int32_t var_174_6 = 0
            ...
            if (data_aca1f4 != 0)
                ...
                if (eax_11 != 0 && *eax_11 != 0)
                    char* eax_12 = sub_48a080(&var_118)
            ...
            var_174_6.q = _mm_cvtps_pd(*(result + 0x30))
            HWND var_17c_5
            var_17c_5.q = _mm_cvtps_pd(*(result + 0x2c))
            int64_t var_184_3 = _mm_cvtps_pd(*(result + 0x28))
            ...
            char* const var_124_5 = &data_5b2591
            int32_t var_174_7 = 0
            ...
            if (data_aca1f4 != 0)
                ...
                if (eax_14 != 0 && *eax_14 != 0)
                    ecx_11 = &var_118
                    char* eax_15 = sub_48a080(ecx_11)
                    int32_t temp2_1 = *(eax_15 + 4)
                    *(eax_15 + 4) -= 1
                    
                    if (temp2_1 == 1)
                        ecx_11 = sub_4984f0(eax_15, *(eax_15 + 0xc) + 0x10)
                        var_118 = &data_5b2591
            ...
            switch (*result - 1)
                case 0
                    ...
                    var_184_3:4.d = "Image"
                    sub_515500(&var_140, "Image", hWnd)
                case 1
                    void* eax_32 = *(result + 0x88)
                    ...
                    void* const var_134_3 = &data_5eb458
                    var_140 = "Choose UI"
                    char const* const var_138_3 = "UI (*.ui)"
                    var_184_3:4.d = &data_5f911c
                    sub_515500(&var_140, &data_5f911c, hWnd)
                case 2
                    void* eax_18 = *(result + 0x60)
                    char* const ecx_13
                    ...
                    var_184_3:4.d = "Model"
                    void* const var_134_2 = &data_605d28
                    var_140 = "Choose Model"
                    char const* const var_138_2 = "Model (*.fbx)"
                    int32_t eax_21
                    int32_t ecx_15
                    eax_21, ecx_15 = sub_515500(&var_140, "Model", hWnd)
                    int32_t var_170_9 = 0
                    int32_t var_174_9 = *(result + 0x68)
                    int32_t var_178_8 = 0
                    int32_t var_17c_8 = ecx_15
                    var_184_3:4.d = "Animation"
                    int32_t eax_22 = sub_515500(eax_21, "Model", hWnd)
                    int32_t* ecx_17 = *(result + 0x60)
                    
                    if (ecx_17[1] != 2)
                        char const* const var_170_23 = "StructureGetDef"
                        int32_t var_174_23 = 0x559
                        char const* const var_178_22 = "d:\ax\trunk\ax2017\engine\structure.cpp"
                        sub_489550(eax_22, &data_5b2591, "assetPtr->assetType == ASSET_TYPE_STRUCTURE", 
                    ...
                    if (*(eax_23 + 0x58) s> 0)
                        ...
                        do
                            char* eax_25 = *(ecx_18 + *(eax_23 + 0x50))
                            char* ecx_19 = eax_25
                            void* eax_26
                            ...
                            if (eax_28 u>= &var_14)
                                ...
                                sub_489550(eax_28, &data_5b2591, "cur + lenName + 1 < buffer + maxLen", 
                                    "d:\ax\trunk\ax2017\engine\windows\editorwindow.cpp", 0x132d, 
                                    "GetModelLooks")
                            ...
                            sub_579300(edx_9, eax_25, ecx_20 + 1)
                            var_118 = &var_118[0x18]
                            edx_9 = eax_28
                            cond:8_1 = var_150_1 + 1 s< *(var_154_1 + 0x58)
                            ecx_18 = var_118
                            var_150_1 += 1
                            eax_23 = var_154_1
                        while (cond:8_1)
                    ...
                    *edx_9 = 0
                    ...
                    int32_t var_174_11 = *(result + 0x80)
                    int32_t var_178_10 = 1
                    char* const var_17c_9 = ecx_18
                    var_184_3:4.d = "Look"
                    sub_515500(&var_114, "Model", hWnd)
                case 4
                    if (*(result + 0xb0) s< 1)
                        int32_t var_170_13 = 0
                        char* const* var_174_13 = ecx_11
                        int32_t* eax_35 = sub_4cf8e0(data_12bac0c, 0xa8)
                        sub_518870(eax_35, eax_35, result, 0)
                    
                    void* eax_37 = **(result + 0xa8)
                    char* const ecx_24
                    ...
                    void* const var_134_4 = &data_605d74
                    var_140 = "Choose Fab"
                    char const* const var_138_4 = "Fab (*.fab)"
                    int32_t ecx_26 = sub_515500(&var_140, "Distribute", hWnd)
                    uint128_t xmm1_1 = zx.o(*(result + 0x98))
                    uint128_t xmm2_1 = zx.o(*(result + 0x94))
                    float xmm0_20[0x2] = _mm_cvtepi32_ps(zx.o(*(result + 0x9c)))
                    var_184_3.d = ecx_26
                    ...
                    int32_t ecx_27 = sub_48a9d0(&var_118, "%g %g %g")
                    ...
                    sub_515500(eax_40, "Distribute", hWnd)
                    int32_t var_8_7 = 3
                    ...
                    if (data_aca1f4 != 0)
                        ...
                        if (eax_41 != 0 && *eax_41 != 0)
                            char* eax_42 = sub_48a080(&var_118)
                ...
                case 5
                    void* const eax_47 = &data_5d30b0
                    int32_t ecx_31 = *(result + 0xb4)
                    char* const eax_48
                    ...
                    sub_515500(eax_48, "Light", hWnd)
                    var_174_18.q = _mm_cvtps_pd(*(result + 0xc4))
                    void* const var_178_17 = &data_5f2124
                    int32_t ecx_33 = sub_48a9d0(&var_118, &data_5f2124)
                    ...
                    if (data_aca1f4 != 0)
                        ...
                        if (eax_50 != 0 && *eax_50 != 0)
                            char* eax_51 = sub_48a080(&var_118)
                ...
                case 7
                    ...
                    sub_515500(&var_140, "Particle", hWnd)

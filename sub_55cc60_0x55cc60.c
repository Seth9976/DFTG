...
int32_t __fastcallsub_55cc60(void* arg1, int32_t arg2)
{
    // 第一条实际指令: sub_55b7c0(arg1, arg2)
    sub_55b7c0(arg1, arg2)
    ...
    *(arg1 + 0xac) = arg2
    ...
    if (eax == 0)
        ...
        return sub_55c780(arg1, edi_1) __tailcall
    ...
    _memset(edi, 0, esi_1)
    return sub_55c450(arg1, edi) __tailcall
}

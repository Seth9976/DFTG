...
int32_tsub_5683f0(int32_t arg1 @ esi, int32_t arg2 @ edi)
{
    ...
    if (sub_5671a0(esi) != 0)
        while (true)
            uint32_t ebx_3 = (sub_561390(esi) << 0x10) + sub_561390(esi)
            uint32_t eax_6 = sub_561390(esi)
            uint32_t ecx_6 = sub_561390(esi) + (eax_6 << 0x10)
            char var_1420
            char var_418[0x3f4]
            var_417
            var_416
            ...
            label_568b67:
                ...
                if (var_1401 == 0)
                    ...
                    if (ecx[4] != 0x10)
                        if (ecx_42 s> 0)
                            do
                                (&var_1420)[i] = sub_561390(esi) * *(ecx[4] + 0x5d38d0)
                                i += 1
                            while (i s< esi[2])
            ...
            if (ecx_6 == 0x49484452)
                ...
                uint32_t eax_21 = sub_561390(esi)
                uint32_t eax_23 = sub_561390(esi) + (eax_21 << 0x10)
                *esi = eax_23
                
                if (eax_23 u> 0x1000000)
                    break
                
                uint32_t eax_24 = sub_561390(esi)
                uint32_t eax_26 = sub_561390(esi) + (eax_24 << 0x10)
                esi[1] = eax_26
                ...
                if (sub_5612f0(ecx, ecx[1] + var_1428, esi, var_14) == 0)
                    break
                ...
                if (var_1418 == 0)
                    ...
                    if (ebx_4 != 0)
                        ...
                        if (eax_9 == 0)
                            ...
                            if (sub_567020(&var_1400, edx_1) == 0)
                                var_14 = eax_9
                                _free(var_14)
                                eax_14 = nullptr
                            else
                        ...
                        if (eax_14 != 0)
                            ...
                            int32_t* eax_60
                            void* ecx_63
                            eax_60, ecx_63 = sub_5680d0(eax_59, ebx_8[2], ebx_8, edi_8, eax_59, 

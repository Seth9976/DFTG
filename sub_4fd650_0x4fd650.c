...
float* __fastcallsub_4fd650(void* arg1, int32_t* arg2)
{
    ...
    if (esi[2] != 1 || p_2)
        ...
        float xmm0_2 =
            sub_526200(esi, edx_3, xmm1_1, (((eax_8 u>> 0x10 ^ eax_8) & 0x7fffff) | 0x3f800000) - 1f)
        esi = arg2[2]
        var_8_1 = xmm0_2
        edi = *(arg1 + 0x30)
    ...
    if (esi[2] != 1 || p_4)
        ...
        result, xmm0_3 = sub_526200(esi, *(edi + 0x2f4), *(edi + 0x2e8), 

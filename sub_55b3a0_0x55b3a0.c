...
int32_t __convention("regparm")sub_55b3a0(int32_t arg1, int32_t arg2, int32_t* arg3, float arg4 @ xmm3, long double arg5 @ st0, int32_t arg6, float arg7, int32_t* arg8, void* arg9)
{
    ...
    if (eax == 0)
        ...
        (&data_6cedac)[edi * 2](xmm0)
        top = 1
        float xmm0_2
        x87control, xmm0_2 = sub_4369e0(fconvert.s(arg5 * fconvert.t(2f) / fconvert.t(var_74)))
        arg3 = arg8
        xmm0 = var_74
        int32_t eax_3
        int32_t edx
    ...
    int32_t eax_6 = (&data_6cedac)[edi * 2]
    ...
    if (eax != 0)
        ...
        do
            ...
            int16_t x87control_1 = sub_59aa00(mxcsr, x87control, var_88)
            unimplemented  {call 0x59aa00}
    ...
    if (esi s> 0)
        do
            ...
            float xmm0_23
            x87control_2, xmm0_23 = sub_4369e0(var_58_2)
            int32_t eax_16
            int32_t edx_2
            ...
            var_88.q = fconvert.d(unimplemented  {fstp qword [esp], st0})
            unimplemented  {fstp qword [esp], st0}
            int16_t x87control_3 = sub_59aa00(mxcsr, x87control_2, var_88)
            unimplemented  {call 0x59aa00}
            ...
            var_88.q = fconvert.d(unimplemented  {fstp qword [esp], st0})
            unimplemented  {fstp qword [esp], st0}
            st0 = sub_59aa00(mxcsr, x87control_3, var_88)
            unimplemented  {call 0x59aa00}
            ...
            top_10 += 2
            int32_t edi_2 = 0
            int32_t edx_3 = arg2 + ((int.d(sub_4369e0(var_58_4)) * ebx_1) << 2)
            ecx_2 = ebx
    ...
    return sub_55ae50(eax_13, arg2, ebx, var_74, st0, edi, arg8, arg9)
}

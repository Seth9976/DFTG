...
char** __convention("regparm")sub_4854c0(int32_t arg1, int32_t arg2, char** arg3, char arg4)
{
    ...
    *arg3 = &data_5b2591
    ...
    if (ecx s> 0)
        ...
        char* eax_6 = *sub_48a9d0(&var_14, "{normal_log}%s settles with %d %s {die_any}.{br}")
    ...
    if (ebx[0x745] s> 0)
        ...
        do
            ...
            char* eax_8 = *sub_4840f0(eax_3, arg2, &var_14, ebx_1, arg4)

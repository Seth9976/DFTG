...
int128_t* __convention("regparm")sub_548330(int32_t arg1, int32_t* arg2, int32_t* arg3, int128_t* arg4)
{
    ...
    if (p_1)
    label_5484fa:
        int128_t* eax_3 = sub_4f0710(&var_2c:4)
        float xmm0_27[0x4] = *eax_3
        int64_t xmm0_28 = eax_3[1].q
        int128_t* eax_4 = sub_4f0710(&var_2c:4)

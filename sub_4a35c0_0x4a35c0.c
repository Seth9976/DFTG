...
int64_t*sub_4a35c0(int64_t* arg1)
{
    ...
    int32_t var_4c = data_aca218:0xc
    float xmm1_1 = _mm_cvtepi32_ps(xmm1)
    float var_34 = xmm1_1
    int64_t xmm1_2 = data_aca218:4.q
    float xmm3_3 = xmm3_1 / xmm1_1 * xmm2
    int128_t var_74 = var_40.o
    float var_7c = xmm3_3
    float var_84 = xmm3_3 ^ (data_60cca0.o).d
    int32_t var_80 = xmm2 ^ (data_60cca0.o).d
    float var_78 = xmm2
    int128_t var_64 = data_aca208:4.o
    int64_t var_54 = xmm1_2
    void var_48
    void arg_8
    int64_t* eax_5 = sub_4dad30(&var_48, &arg_8, &var_84, &var_48)
    ...
    bool cond:0 = 9.99999975e-06f > sub_426e40(xmm6_3)
    ...
    if (cond:0 || 0 f< xmm1_7 * xmm6_3)
        ...
        xmm1_9 = (xmm1_7 / xmm6_3) ^ (data_60cca0.o).d

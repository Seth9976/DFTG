...
int128_t* __convention("regparm")sub_41e000(int32_t arg1, int32_t* arg2, float* arg3, int128_t* arg4)
{
    // 第一条实际指令: void var_3c
    void var_3c
    ...
    float xmm1_10 =
        1f / (sub_41dbe0(xmm1_5 f* xmm1_5 + xmm7_2 * xmm7_2 + xmm6_2 * xmm6_2) + 9.99999975e-06f)
    float var_18 = xmm6_2 * xmm1_10
    var_20 = _mm_unpacklo_ps(var_20.d * xmm1_10, xmm7_2 * xmm1_10)
    void var_30
    *arg4 = *sub_41de50(&var_30, 0x5d22a0, 0x5d22ac, &var_30, arg3, &var_20)

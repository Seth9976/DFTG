...
int64_t* __convention("regparm")sub_4dad30(int32_t arg1, int32_t* arg2, float* arg3, int64_t* arg4)
{
    ...
    *arg4 = *(arg3 + 0x30)
    ...
    float xmm1_23 =
        1f / (sub_41dbe0(xmm4_7 * xmm4_7 + xmm7_14 * xmm7_14 + xmm2_10 * xmm2_10) + 9.99999975e-06f)

...
uint32_t __convention("regparm")sub_490ee0(int32_t arg1, int32_t* arg2, int128_t* arg3)
{
    ...
    uint32_t result = sub_490490(xmm4_60, &var_b8, &var_70, arg3)

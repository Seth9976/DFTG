...
int32_t __stdcallsub_4890e0(int32_t* arg1)
{
    ...
    if (data_a9fb7c == 0)
        ...
        sub_4893e0("Generating steam mini dump\n")
        ...
        sub_4893e0("Exception during exception processing.\n")

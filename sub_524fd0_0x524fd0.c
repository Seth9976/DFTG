...
uint32_t __fastcallsub_524fd0(int32_t* arg1, float arg2 @ xmm1, float arg3 @ xmm2)
{
    // 第一条实际指令: void var_b4
    void var_b4
    ...
    int80_t st0
    st0, x87control_1 = sub_59aa00(mxcsr, x87control, fconvert.d(fconvert.t(_mm_cvtps_pd(xmm0_3))))
    double var_70
    ...
    float xmm1 = var_70.d
    float var_80_1 = fconvert.s(sub_59aa00(mxcsr, x87control_1, fconvert.d(fconvert.t(var_80.q))))
    float xmm0_11
    ...
    uint32_t xmm5[0x4] = data_60cc60
    int128_t xmm3_1 = data_60c9a0

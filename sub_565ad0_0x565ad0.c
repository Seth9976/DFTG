...
int32_t __convention("regparm")sub_565ad0(int32_t arg1, int32_t* arg2, int32_t* arg3, int32_t* arg4, void** arg5)
{
    ...
    int32_t* var_cc = ebx
    *(*ebx + 8) = 0
    int32_t eax_5 = sub_564e40(arg3)
    int32_t* result_9 = *ebx
    int32_t result_5 = result_9[2]
    
    if (eax_5 == 0)
        sub_5647e0(eax_5, result_5, ebx, eax_5)
    ...
    if (result_2 == 0)
        sub_5647e0(result_1, result_6[2], ebx, result_2)
        @__security_check_cookie@4(eax_1 ^ &__saved_ebp)
        return 0

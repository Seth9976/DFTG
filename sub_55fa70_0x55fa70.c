...
char* __convention("regparm")sub_55fa70(int32_t arg1, int32_t arg2, int32_t arg3, void* arg4, int32_t arg5, char* arg6, char* arg7, char* arg8, char* arg9)
{
    // 第一条实际指令: int32_t ebx = arg2
    int32_t ebx = arg2
    char* edx = arg6
    int32_t esi = 0x6ceea4
    
    if (edx == 0)
        esi = 0x6cee90
    
    char* i_1 = *(esi + (arg8 << 2))
    int32_t esi_1 = data_126b8c8
    arg6 = i_1
    void* ecx_2

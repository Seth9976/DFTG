...
void* __convention("regparm")sub_55f1f0(int32_t arg1, int32_t arg2, void* arg3, void** arg4)
{
    ...
    int32_t edx_1 = sub_55f100(eax, edx, &i_16, 1)
    void* i_29 = i_16
    *(i_29 + *(i_29 - 4)) = 0x78
    *(i_29 - 4) += 1
    ...
    *(i_29 - 4) += 1
    int32_t i_17 = 1
    void* eax_6 = sub_55f160(&i_17, &var_10, i_29, &i_17)
    int32_t i_44 = i_17
    var_10 |= 1 << (i_44 u% 0x20)
    i_17 = i_44 + 2
    int32_t edx_5 = eax
    void* var_14 = sub_55f160(eax_6, &var_10, eax_6, &i_17)
    void* ebx = nullptr
    ...
    if (edi_6 - 3 s> 0)
        while (true)
            ...
            if (edx_6 != 0 && *(edx_6 - 4) == 0x10)
                sub_579a90(edx_6, &edx_6[0x20], 0x20)
                *(*edi_2 - 4) = 8
                ecx_16 = *edi_2
            ...
            *(eax_37 - 4) += 1
            ...
            label_55f6aa:
                ...
                var_10 |= edx_30
                i_17 = i_38
                var_14 = sub_55f160(&i_17, &var_10, var_14, &i_17)
                i_28 = 1
            else
                void* edx_9 = var_1c
                void* esi_3 = var_18
                ...
                if (i_4 s> 3)
                    ...
                    do
                        eax_56 = zx.d(*((esi_8 << 1) + &data_60bc04))
                        esi_8 += 1
                ...
                var_10 |= edx_14
                i_17 = i_31
                void* edi_4 = sub_55f160(&i_17, &var_10, var_14, &i_17)
                void* eax_68
                eax_68.b = *(esi_8 + 0x60bbe0)
                void* var_14_1 = edi_4
                
                if (eax_68.b != 0)
                    int32_t i_34 = i_17
                    var_10 |= (i_16 - zx.d(*((esi_8 << 1) + &data_60bc00))) << i_34.b
                    i_17 = i_34 + zx.d(eax_68.b)
                    var_14_1 = sub_55f160(&i_17, &var_10, edi_4, &i_17)
                ...
                if (i_9 s> 1)
                    ...
                    do
                        eax_73 = zx.d(*((esi_9 << 1) + &data_60bba4))
                        esi_9 += 1
                ...
                i_17 = i_35 + 5
                void* eax_78 = sub_55f160(&i_17, &var_10, var_14_1, &i_17)
                char edx_26 = *(esi_9 + 0x60bb80)
                var_14 = eax_78
                
                if (edx_26 != 0)
                    int32_t i_36 = i_17
                    var_10 |= (i_9 - zx.d(*((esi_9 << 1) + &data_60bba0))) << i_36.b
                    i_17 = i_36 + zx.d(edx_26)
                    var_14 = sub_55f160(&i_17, &var_10, eax_78, &i_17)
    ...
    var_10 = var_10
    i_17 = i_43
    void* esi_10 = sub_55f160(&i_17, &var_10, var_14, &i_17)
    int32_t i_14 = i_17
    ...
    if (i_14 != 0)
        do
            i_17 = i_14 + 1
            esi_10 = sub_55f160(&i_17, &var_10, esi_10, &i_17)
            i_14 = i_17
        while (i_14 != 0)
    ...
    *arg4 = edx_49
    sub_579a90(edi_11, esi_10, edx_49)
    return edi_11
}

...
floatsub_4c90a0(float arg1, float arg2, float arg3, float arg4, float arg5, float arg6, float arg7, float arg8, float arg9, float arg10, float arg11, float arg12)
{
    ...
    if (not(arg7 >= 0f) && arg8 f< 0)
        sub_489550(eax_1, &data_5b2591, "minSpacing.x >= 0 || minSpacing.y >= 0", 
            "d:\ax\trunk\ax2017\engine\uidef.cpp", 0x227, "CalcSpacing")

...
int32_t __thiscallsub_5218e0(int32_t* arg1, int32_t arg2)
{
    ...
    if (temp1 != 1)
        ...
        int32_t var_48_1 = 0x12fa
        char const* const var_4c = "d:\ax\trunk\ax2017\engine\openglgraphics.cpp"
    ...
    if (eax_4 == 0)
        ...
        result = sub_4892e0("OpenGL failed to set monitor render target")

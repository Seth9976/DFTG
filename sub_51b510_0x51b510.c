...
int32_t __convention("regparm")sub_51b510(int32_t arg1, int32_t arg2, float* arg3, void* arg4, void* arg5, int128_t arg6)
{
    ...
    while (true)
        ...
        var_d0 = xmm1
        int32_t eax_5 =
            sub_51b270(&var_d0, &var_8c, &var_70, var_d0, var_c0_1, var_bc_1, var_b8_1, var_b4_1)
        int32_t var_68_1
        int32_t ecx_1
        ...
        if (eax_5.b == 0)
            ...
            *esi = var_70
            ...
            if (xmm5_1 f< xmm0_1 || xmm4_1 f< xmm6_1)
                ...
                var_b8_3 = 0xa4
                var_bc_3 = "d:\ax\trunk\ax2017\engine\rect.cpp"
                ecx_6 = "RectIsNormalized(r)"
            label_51b936:
                sub_489550(eax_5, &data_5b2591, ecx_6, var_bc_3, var_b8_3, var_b4_3)
            ...
            if (xmm3_1 f< xmm0_1 || var_6c f< xmm6_1 || xmm5_1 f< xmm3_1 || xmm4_1 f< var_6c)
                var_b4_3 = "ClipRect"
                var_b8_3 = 0xa0
                var_bc_3 = "d:\ax\trunk\ax2017\engine\clipping2.cpp"
    ...
    var_d0 = var_a0
    char eax_10 = sub_51b270(&var_d0, &var_8c, &var_70, var_d0, var_c0_2, var_bc_2, var_b8_2, var_b4_2)
    (&var_50)[ebx][0] = var_70
    var_4c
    *(&var_4c + (ebx << 3)) = var_6c

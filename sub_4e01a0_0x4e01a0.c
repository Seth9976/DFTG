...
HWND __fastcallsub_4e01a0(HINSTANCE arg1)
{
    ...
    int32_t eax_23 = MultiByteToWideChar(0xfde9, 0, *(data_aca1ec + 0xc), 0xffffffff, &var_110, 0x80)
    int32_t var_150_4
    char* ecx_8
    
    if (eax_23 != 0)
        int32_t eax_24 = data_114ec74
        var_114
        ...
        label_4e038e:
            HWND hwnd = CreateWindowExW(WS_EX_LEFT, GameWindowClass", &var_110, dwStyle, 0x80000000, 
                data_1150b88, rect.right - rect.left, rect.bottom - rect.top, nullptr, nullptr, arg1, 
                nullptr)
    ...
    sub_489550(eax_23, &data_5b2591, ecx_8, "d:\ax\trunk\ax2017\engine\windows\windowsapp.cpp", 
        var_150_4, "CreateMainWindow")

...
int32_t?translate_ansi_or_utf8_nolock@@YAHHQADIQA_WI@Z(int32_t arg1, uint8_t* arg2, int32_t arg3, wchar16* arg4, int32_t arg5)
{
    ...
    if (result != 0)
        ...
        int32_t eax_2 = (&data_6cfb08)[edx_2]
        ...
        if (*(edi_1 + eax_2 + 0x29) != 0)
            ...
            if (ecx_1.b s< 0)
                ...
                ecx_1.b = *esi_1
                int32_t eax_6 = sx.d(*(zx.d(ecx_1.b) + 0x61f2e0))
                    ...
                    if (eax_6 + 1 == edx_3)
                        ...
                        *(edi_1 + eax_2 + 0x2a) = ecx_1.b
                        ...
                        if (edx_3 u>= 2)
                            ...
                            eax_9.b = *esi_2
                            esi_2 = &esi_2[1]
                            *(edi_1 + (&data_6cfb08)[edx_2] + 0x2b) = eax_9.b
                        
                        if (edx_3 == 3)
                            int32_t eax_10
                            eax_10.b = *esi_2
                            esi_2 = &esi_2[1]
                            *(edi_1 + (&data_6cfb08)[edx_2] + 0x2c) = eax_10.b
            ...
            label_58fc3c:
                ...
                if (eax_13 != 0)
                    int32_t edx_6 = (&data_6cfb08)[edx_2]
                    int32_t eax_15

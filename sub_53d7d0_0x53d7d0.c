...
void* __thiscallsub_53d7d0(void* arg1, int32_t arg2, int32_t arg3, uint32_t arg4, int32_t arg5, int32_t arg6, int32_t arg7, int32_t arg8)
{
    // 第一条实际指令: int32_t edi
    int32_t edi
    int32_t var_18 = edi
    void* result = sub_53b920(arg5)
    
    if (result != 0)
        int32_t* ecx_1 = *(arg1 + 8)
        (*(*ecx_1 + 0x44))(ecx_1, result)
        void* eax = data_114ec70
        *(eax + 0x10) += 1
        ...
        label_53d99e:
            sub_489550(eax_2, &data_5b2591, ecx_4, "d:\ax\trunk\ax2017\engine\windows\windowsdx11.cpp", 

...
char* __fastcallsub_526690(void** arg1, void* arg2)
{
    ...
    if (sub_4cfba0(&var_10).b != 0)
        int32_t* edi_1 = var_10
        _fseek(edi_1, 0, 2)
        int32_t* var_2c_1 = edi_1
        int32_t eax_1 = sub_587c01()
        uint32_t (* eax_2)[0x4] = sub_4c2e40(eax_1 + 1)
        *arg1 = eax_2
        int32_t var_c
        int32_t ebx_1

...
char* __fastcallsub_5431c0(int32_t* arg1, int32_t** arg2)
{
    // 第一条实际指令: int32_t var_8 = 0xffffffff
    int32_t var_8 = 0xffffffff
    int32_t (* var_c)(void* arg1) = sub_5a3170
    TEB* fsbase
    ...
    if (arg1[4] s> 0)
        do
            ...
            sub_542600(eax_5, arg2, *(eax_5 + (i << 3)), &i_8)
            i += 1
        while (i s< arg1[4])
    ...
    if (arg1[4] s<= 0 || var_60 s<= 0)
        ...
        do
            ...
            sub_48a9d0(&lpFileName_8, "%s-%s-%d.png")
            ...
            if (GetFileAttributesExA(lpFileName, GetFileExInfoStandard, &fileInformation) == 0)
                ...
                if (data_aca1f4 != 0)
                    ...
                    if (lpFileName_10 != 0 && *lpFileName_10 != 0)
                        char* eax_10 = sub_48a080(&lpFileName_8)
            ...
            if (data_aca1f4 != 0)
                ...
                if (lpFileName_9 != 0 && *lpFileName_9 != 0)
                    char* eax_9 = sub_48a080(&lpFileName_8)
        ...
        if (edi_1 != 0 || var_4c_1 != 0)
            ...
            if (var_20 u>= edi_1 && (var_20 u> edi_1 || var_24 u>= var_4c_1))
                sub_4892e0("AtlasMaker: rebuilding page because atlasmaker file is new")
                var_3d_1 = 0
            ...
            while (i_2 != 0)
                ...
                if (*(esi_1 + 8) != 0)
                    bool cond:4_1 = sub_4e6cc0(esi_1) != 0
                    char* eax_14 = *(esi_1 + 0x20)
                    
                    if (cond:4_1)
                        char* ecx_23 = &data_5b2591
                        
                        if (eax_14 != 0)
                            ecx_23 = eax_14
                        
                        char* var_88_11 = ecx_23
                    ...
                    sub_4e5da0(&lpFileName_8, edx_5)
                    char* lpFileName_6 = lpFileName_8
                    char* lpFileName_2 = &data_5b2591
                    ...
                    label_5434f3:
                        ...
                        if (data_aca1f4 != 0)
                            ...
                            if (lpFileName_12 != 0 && *lpFileName_12 != 0)
                                char* eax_21 = sub_48a080(&lpFileName_8)
                    ...
                    if (data_aca1f4 != 0)
                        ...
                        if (lpFileName_11 != 0 && *lpFileName_11 != 0)
                            char* eax_18 = sub_48a080(&lpFileName_8)
                    ...
                    char* const var_88_5 = ecx_7
                    sub_4892e0("AtlasMaker: unknown asset '%s'")
            
            if (var_3d_1 == 0)
                goto label_543536
            
            sub_4892e0("AtlasMaker: atlas is up to date.")
            var_8_1.b = 0xb
        else
        label_543536:
            int32_t edi_2 = 0
            var_54.d = sub_498490(var_60 << 2)
            var_54:4.d = 0
                ...
                if (eax_24.b != 0)
                    if (edi_2 s>= var_60)
                        sub_489550(eax_24, &data_5b2591, "mSize < mSizeReserved", 
                            "d:\ax\trunk\ax2017\engine\xarray.h", 0x96, 
                            "XArray<struct XAsset *>::Append")
            ...
            uint32_t var_88_9 = sub_498220(&performanceCount_1)
            sub_4892e0("AtlasMaker: match and load assets time %d ms")
            int32_t i_4 = sub_541a00(&result_2, &var_54, arg1, &result_2)
            ...
            while (i_4 s< 0x64)
                ...
                if (GetFileAttributesA(lpFileName_3) == 0xffffffff)
                    ...
                    if (data_aca1f4 != 0)
                        ...
                        if (lpFileName_15 != 0 && *lpFileName_15 != 0)
                            char* eax_31 = sub_48a080(&lpFileName_8)
                ...
                if (data_aca1f4 != 0)
                    ...
                    if (lpFileName_14 != 0 && *lpFileName_14 != 0)
                        char* eax_30 = sub_48a080(&lpFileName_8)

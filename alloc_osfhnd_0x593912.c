...
int32_t__alloc_osfhnd()
{
    ...
    if (edi s< 0x80)
        CRITICAL_SECTION* lpCriticalSection_2 = (&data_6cfb08)[edi]
        int32_t result_1
        ...
        if (lpCriticalSection_2 != 0)
            ...
            while (true)
                ...
                if ((lpCriticalSection->__offset(0x28).b & 1) == 0)
                    ...
                    if ((lpCriticalSection->__offset(0x28).b & 1) == 0)
                        ...
                        *((&data_6cfb08)[edx_3] + ecx_5 + 0x28) = 1
                        *((&data_6cfb08)[edx_3] + ecx_5 + 0x18) = 0xffffffff
                        result = result_2
                        break
            ...
            if (eax != 0)
                ...
                *((&data_6cfb08)[result s>> 6] + 0x28) = 1
                result_1 = result
    
    int32_t var_8_2 = 0xfffffffe
    $LN17()
    fsbase->NtTib.ExceptionList = ExceptionList
    void* const __saved_ebp_2 = &data_593993
    return result
}

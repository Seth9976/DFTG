...
char* __convention("regparm")sub_518b90(int32_t arg1, int32_t* arg2, int32_t* arg3, int32_t arg4, int32_t arg5)
{
    ...
    if (arg4 s< 0 || arg4 s>= ecx)
        ...
        if (eax_3 s< 0 || eax_3 s>= ecx)
            ...
            if (eax_3 != arg4)
                ...
                sub_579300(var_28_1, var_24_2, var_20_2)
                char* result = sub_579300(edi_3, &__saved_edi, eax_4)
    ...
    sub_489550(eax_3, &data_5b2591, ecx_1, "d:\ax\trunk\ax2017\engine\defeditor.cpp", var_24, 

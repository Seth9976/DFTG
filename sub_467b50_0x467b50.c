...
int32_t __fastcallsub_467b50(int32_t* arg1, int32_t* arg2)
{
    ...
    if (*esi == 2)
        ...
        if (esi[0x12] != 0 || *esi == 2)
            ...
            int32_t var_2c8_1 = 1
            sub_4744b0(eax_3, esi, ebx)
            uint32_t var_200
            void var_170
            __builtin_memcpy(&var_200, sub_461720(&var_170, eax_2, ebx, &var_170, edi), 0x90)
        ...
        var_2c4_1 = "ShipActionTrayMoveConsume"
        var_2c8 = 0x4c3c
    else
        var_2c4_1 = "TrayIsAt"
        var_2c8 = 0x4bfe

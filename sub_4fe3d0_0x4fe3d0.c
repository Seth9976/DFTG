...
uint32_t __convention("regparm")sub_4fe3d0(int32_t arg1, void* arg2, int32_t arg3, int32_t arg4, float arg5)
{
    ...
    void var_5c
    void* ecx
    int128_t* eax_3 = sub_5020f0(&var_5c, arg2, ecx, &var_5c)
    int32_t edx = 0x10
    ...
    label_4fe4e1:
        ...
        if (ecx_1 - edx + 1 s> 0)
            sub_579a90(arg2 + 0x44, arg2 + (((ecx_1 - edx + 1) * 9 + 0x11) << 2), 
        ...
        *(arg2 + 0x284) = ecx_1
        ...
        if (edx s< 2)
            sub_489550(edx - 1, &data_5b2591, "trailNumSegments >= 2", 
                "d:\ax\trunk\ax2017\engine\particle.cpp", 0x386, "RibbonUpdate")
    ...
    *(arg2 + (ecx_4 << 2) + 0x34) =
    ...
    if (result == edx - 1 && result s>= 2)
        ...
        float xmm0_17
        result, xmm0_17 = sub_41dbe0(xmm0_13 * xmm0_13 + xmm1_7 * xmm1_7 + xmm2_9 * xmm2_9)

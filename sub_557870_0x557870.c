...
LRESULT __fastcallsub_557870(int32_t arg1, void* arg2)
{
    // 第一条实际指令: int32_t __saved_ebp
    int32_t __saved_ebp
    int32_t eax_1 = __security_cookie ^ &__saved_ebp
    LRESULT result = data_1511868
    HWND hWnd = *(arg2 + 0x14)
    ...
    if (hWnd == *(result + 0x14) && wParam != 0xffffffff && (*(arg2 + 0xc) & 1) != 0)
        ...
        if (result_1 != 0xffffffff && result_1 != 0)
            ...
            label_557c3b:
                ...
                sub_553f50(eax_44, &lprc_3, *(arg2 + 0x18), 6, eax_44)
            else
                ...
                if (wParam == SendMessageA(*(arg2 + 0x14), 0x188, 0, 0) && *(data_1511868 + 0x38) != 0)
            ...
            if (*(result_1 + 0x14) != 0x63)
                ...
                if (eax_49 == 4)
                    uint32_t color_2 = sub_554060(*(result_1 + 0x10))
                    HDC hDC = *(arg2 + 0x18)
            ...
            sub_553f50(eax_54, &lprc_2, *(arg2 + 0x18), 2, eax_54)
            ...
            if (eax_55 != 8)
                ...
                if (*(result_1 + 0x14) != 5)
                    ...
                    int32_t xmm1_12[0x4] = _mm_add_epi32(data_60c880, lprc_1)
                    ...
                    *(result_1 + 0x10)
                    ...
                    if (esi_3 s> 0)
                        ...
                        sub_553d20(&lpchText, 0x104, "%s %d")
                        void* ecx_14 = &lpchText
                        int32_t xmm1_10[0x4] = _mm_add_epi32(data_60c880, lprc_1)
            ...
            result = sub_553f50(eax_61, &lprc_1, *(arg2 + 0x18), 2, eax_61)

...
int32_t __thiscallsub_53d610(void* arg1, int32_t arg2)
{
    // 第一条实际指令: int32_t var_8 = 0xffffffff
    int32_t var_8 = 0xffffffff
    int32_t (* var_c)(void* arg1) = sub_5a2eb8
    TEB* fsbase
    ...
    if (ecx_8 != 0)
        int32_t* eax_14 = sub_4d2a30(ecx_8)
        void* esi_2 = data_1151ae8
        uint32_t ecx_9

...
int32_t* __fastcallsub_4e9430(int32_t* arg1, char* arg2)
{
    // 第一条实际指令: int32_t var_8 = 0xffffffff
    int32_t var_8 = 0xffffffff
    int32_t (* var_c)(void* arg1) = sub_5a0f48
    TEB* fsbase
    ...
    if (*(edi + 0x14) != 0)
        ...
        while (ecx_1.b != 0)
            ...
            char* var_1c = esi
            uint32_t i_1 = sub_4eae80(&var_1c)
            char edx = *esi
            uint32_t i = i_1
            var_1c = esi
            ...
            if (edx u>= 0x80 && (edx & 0xe0) != 0xc0)
                ...
                if (i_1.b != 0xe0 && (edx & 0xf8) != 0xf0)
                    sub_489550(i_1, &data_5b2591, "!Xutf8_is_invalid_lead_char(str)", 
            ...
            if (ecx_5 u>= 0x80)
                ...
                if (eax_4.b != 0xc0)
                    ...
                    if (eax_4.b != 0xe0 && (ecx_5 & 0xf8) != 0xf0)
                        sub_489550(eax_4, &data_5b2591, "!Xutf8_is_invalid_lead_char(str)", 
                            "d:\ax\trunk\ax2017\engine\xutf8.cpp", 0x213, "Xutf8_peek_next")
            ...
            var_1c = esi
            uint32_t eax_5 = sub_4eae80(&var_1c)
            void* edi_1 = var_14
            eax_3, ecx_1 = sub_4e87f0(eax_5, var_20_1, edi_1, i)

...
int32_t __convention("regparm")sub_4ca7f0(int32_t arg1, char* arg2, void* arg3, char* arg4, char arg5, char arg6)
{
    ...
    *(arg4 + 8) = 0xffffffff
    ...
    if (arg2.b != 0 || ebx.b != 1 || eax_1:1.b != ebx.b)
        ...
        if (ebx_1 != 0)
            sub_4c5670(ebx_1, &var_3c)
            eax_1, arg3 = sub_4c5920(&var_3c)
            arg3.b = arg4[2]
            eax_1.b = arg4[3]
    ...
    if (eax_1.b == 0 && *arg4 == eax_1.b && arg4[1] == 1)
        int32_t* edi_1 = *(var_40 + 0x158)
        arg3.b = eax_1.b
        
        if (edi_1 != 0)
            sub_4c5670(edi_1, &var_3c)
            sub_4c5920(&var_3c)
            arg3.b = arg4[3]
            result = result_1

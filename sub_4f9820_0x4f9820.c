...
void* __fastcallsub_4f9820(int32_t* arg1, float arg2 @ xmm1)
{
    ...
    if (ecx[1] != 0x18)
        ...
        var_218_1 = 0x2ec
        var_21c_1 = "d:\ax\trunk\ax2017\engine\assetutils.cpp"
        ecx_1 = "assetPtr->assetType == ASSET_TYPE_FLANIM"
    label_4f9e8d:
        sub_489550(eax_6, &data_5b2591, ecx_1, var_21c_1, var_218_1, var_214_1)
    ...
    if (*(result + 0x28) s> 0)
        ...
        do
            int32_t* eax_9 = esi[0x1a] + 0x64 + ecx_2
            
            if (*eax_9 != 0)
                void var_17c
                sub_4fa6b0(&var_17c, esi[4], esi[3], esi[1], &var_17c)
                ...
                mxcsr_1, x87control_1 = sub_4fb640(&var_17c, i_2, result_1, &var_17c, &var_a0)
                float var_90
                ...
                void var_e0
                float* eax_13 = sub_497e60(&var_e0, &esi[8], &var_130, &var_e0)
                ...
                float var_f0[0x4]
                int128_t xmm0_46 = *sub_41dc00(&var_f0, edx_4, &var_a0, &var_f0)
                int32_t ecx_8 = *eax_9
                var_1bc_1.o = xmm0_46
                int128_t var_60 = var_1c0.o
                int128_t var_50_1 = xmm0_12.o
                void* eax_17 = sub_51bb40(ecx_8)
                ...
                if (eax_17 != 0)
                    ...
                    do
                        sub_4ddac0(&j[4], &var_60, &var_1c0, &j[4])
                        int32_t eax_19 = *j
                        ...
                        if (eax_19 != 1)
                            ...
                            if (eax_19 != 2)
                                ...
                                var_218_1 = 0x15c
                                var_21c_1 = "d:\ax\trunk\ax2017\engine\attachment.cpp"
                                ecx_1 = "Halt"
                                goto label_4f9e8d
                            
                            void* eax_21 = sub_4f9740(j[2])
                            
                            if (eax_21 == 0)
                                goto label_4f9e1e
                            
                            *(eax_21 + 0x60) = data_63c284
                            *(eax_21 + 0x64) = data_63c288
                            int128_t* eax_23 = sub_482820(&var_e0, eax_21, &var_40, &var_e0)
                        ...
                        label_4f9e1e:
                            *edi_1 = j[3]
                            ...
                            float xmm1_11 = data_620d84
                            *(eax_24 + 0x2c) = var_1c0.o
                            *(eax_24 + 0x3c) = xmm0_12.o
                            sub_501f70(eax_24, xmm1_11)
                        label_4f9e0d:

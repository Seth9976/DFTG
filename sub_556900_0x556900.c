...
int32_t* __convention("regparm")sub_556900(int32_t arg1, WPARAM arg2, HWND arg3, int16_t arg4, int16_t arg5)
{
    ...
    label_556ab2:
        ...
        if (arg2 == 0x20 || arg2 == 0xd)
            eax_3 = __Cnd_wait(edx, "T")
            
            if (eax_3 == 0)
                void* const ecx_2 = &data_60b264
                
                if (__Cnd_wait(*(*(data_1511868 + 4) + 0x10), U"T") != 0)
                    ecx_2 = &data_60b558
                
                enum REDRAW_WINDOW_FLAGS flags_1 = RDW_INVALIDATE | RDW_ERASE | RDW_UPDATENOW
                HRGN hrgnUpdate_1 = nullptr
                *(*(data_1511868 + 4) + 0x10) = ecx_2
            ...
            label_5569f0:
                ...
                switch (lpString)
                    case 0, 4
                        ...
                        var_78.o = xmm0_4
                        eax_3 = sub_5564d0(&var_78, lpString, arg3, var_78)
                        goto label_556a96
                    case 1, 2
                        uint128_t xmm0_5
                        ...
                        if (lpString != 1)
                            if (ecx[7] == 0)
                                *(data_1511868 + 0x1c) =
                                    sub_555540(xmm0_5:0xc.d + 0x64, arg3, *ecx, 0x7d9, 1)
                                ecx = data_1511868
                        else if (ecx[7] == 0)
                            *(data_1511868 + 0x1c) =
                                sub_555540(xmm0_5:0xc.d + 0x64, arg3, *ecx, 0x7d8, 0)
                            ecx = data_1511868
                    ...
                    case 8
                        if ((0x8000 & GetKeyState(0x10)) == 0)
                            bool cond:5_1 = __Cnd_wait(*(*(data_1511868 + 4) + 8), U"T") != 0
                            void* eax_55 = *(data_1511868 + 4)
                            
                            if (cond:5_1)
                                *(eax_55 + 8) = &data_60b558
                            else
                                *(eax_55 + 8) = &data_60b264
                    ...
                    case 9
                        ...
                        if (ecx[7] == 0)
                            ...
                            if (InitCommonControlsEx(&picce) != 0)
                                ...
                                if (hWnd_2 != 0)
                                    ...
                                    SetWindowLongA(hWnd_2, 0xfffffffc, sub_5545a0)
                            else
                                hWnd_2 = nullptr
                            
                            edx_6 = xmm0_7:8.d
                            *(data_1511868 + 0x1c) = hWnd_2
                            ecx = data_1511868
                            eax_29 = xmm0_7:0xc.d
                        ...
                        var_10 = 0
                        var_78 = &var_1c
                        sub_48d8d0(&var_1c, edx_8, ecx_12, lpString, "%hhu.%hhu.%hhu.%hhu")
                        LPARAM lParam_8 = (((((var_1c << 8) + var_18) << 8) + var_14) << 8) + var_10
                        WPARAM wParam_7 = 0
                        uint32_t Msg_10 = 0x465
                        var_78 = *(data_1511868 + 0x1c)
                    ...
                    case 0xa, 0xb, 0xc
                        ...
                        var_78.o = xmm0_9
                        eax_3 = sub_5565f0(&var_78, lpString, arg3, var_78)
                        goto label_556a96
                    default
                        uint128_t xmm0_10
                        ...
                        if (ecx[7] == 0)
                            ...
                            HMENU hMenu_1 = 0x7d4
                            var_78 = arg3
                            HWND eax_63 = CreateWindowExA(WS_EX_LEFT, "Button", &data_60b2d0, 
                                0x50000000, 0x80000000, 0x80000000, 0x80000000, 0x80000000, var_78, 
                                hMenu_1, hInstance, lpParam_1)
                            
                            if (eax_63 != 0)
                                SetWindowTheme(eax_63, &data_60b2b0, &data_60b2b0)
                                LPARAM lParam_7 = 0
                                ...
                                SetWindowLongA(eax_63, 0xfffffffc, sub_554980)
                            
                            *(data_1511868 + 0x1c) = eax_63
                            ecx = data_1511868
                            dwICC = picce.dwICC

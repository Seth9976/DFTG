...
uint32_t __convention("regparm")sub_4c7c10(int32_t arg1, int32_t* arg2, void** arg3, void* arg4)
{
    ...
    if (edi u> 0x24)
        sub_489550(eax_1, &data_5b2591, "assetType >= 0 && assetType < ASSET_TYPE_COUNT", 
    ...
    void* edi_2 = *((edi << 5) + data_114ec7c + 0x1c)
    ...
    if (sub_4c7b90(arg2, &var_18).b != 0 && var_10 == 1
            && sub_4c6110(&var_c0, 0xa8, arg2, &var_c0).b != 0)
        if (var_bc == *(edi_2 + 0x18))
            void* eax_7 = sub_4dfc30(var_c0)
            int32_t var_b8
            ...
            label_4c7d12:
                ...
                int32_t* eax_12 = sub_4c2e40(ebx_1 + 0x10)
                
                if (_fseek(*var_c4, *(arg4 + 0x10), 0) == 0)
                    eax_3 = _fread(&eax_12[4], ebx_1, 1, *var_c4)
                    
                    if (eax_3 == 1
                            && sub_4c7140(eax_3, &eax_12[4], &eax_12[4], edi_2, nullptr, ebx_1).b != 0)
                        *arg3 = eax_12
                        *eax_12 = &eax_12[4]
                        *(*arg3 + 8) = 1
                        *(*arg3 + 0xc) = edi_2

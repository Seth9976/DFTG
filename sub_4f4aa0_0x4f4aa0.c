...
int128_t* __convention("regparm")sub_4f4aa0(int32_t arg1, int32_t* arg2, int64_t* arg3, int128_t* arg4)
{
    ...
    if (9.99999975e-06f <= xmm2_4)
        ...
        float xmm0_17 =
            sub_41dbe0(xmm1_3 * xmm1_3 + xmm2_4 * xmm2_4 + xmm3_5 * xmm3_5 + xmm5_2 * xmm5_2)
        float var_18_1 = xmm2_4 / xmm0_17
        var_24 = xmm1_3 / xmm0_17
        float var_20_1 = xmm3_5 / xmm0_17
        float var_1c_2 = xmm5_2 / xmm0_17
    else if (_mm_cvtpd_ps(__andps_xmmxud_memxud(_mm_cvtps_pd(xmm5), data_60cc80))
            f<= _mm_cvtpd_ps(__andps_xmmxud_memxud(_mm_cvtps_pd(xmm4), data_60cc80)))
        int32_t xmm4_1 = xmm4[0] ^ (data_60cca0.o).d
        var_24.q = _mm_unpacklo_ps(zx.o(0), xmm3.q)
        int32_t var_1c_1 = xmm4_1
    else
        var_24.q = _mm_unpacklo_ps(xmm3 ^ data_60cca0.o, 0)
        int32_t var_1c = xmm5

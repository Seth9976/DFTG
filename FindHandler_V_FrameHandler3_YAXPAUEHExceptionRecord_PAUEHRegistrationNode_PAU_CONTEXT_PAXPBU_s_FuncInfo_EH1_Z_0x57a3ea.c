        ...
        label_57a53b:
            ...
            if (*esi_1 != 0xe06d7363 || esi_1[4] != 3
                                ...
                                if (eax_17 != 0)
                                    ...
                                    while (true)
                                        ...
                                        if (i_3 s> 0)
                                            ...
                                            do
                                                if (TypeMatchHelper<struct _s_HandlerType const>(
                                                        var_14_1, *ecx_7, esi_1[7]) != 0)
                ...
                if (((edi[8] u>> 2).b & 1) == 0)
                    ...
                    *(sub_57a0a4() + 0x10) = esi_1
                    *(sub_57a0a4() + 0x14) = var_10_1
                    void** eax_36 = arg8
                    
                    if (eax_36 == 0)
                        eax_36 = arg2
                    
                    sub_578858(eax_36, esi_1)
            ...
            esi_1 = *(sub_57a0a4() + 0x10)
            var_2c = 1
            var_10_1 = *(sub_57a0a4() + 0x14)
                    ...
                    if (*eax_6 s> 0)
                        ...
                        do
                            if (type_info::operator==(*(ecx_2 + eax_6[1] + 4), 
                                ...
                                __CxxThrowException@8(&var_54, 0x61bbac)
                                noreturn

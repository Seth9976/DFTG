...
float* __convention("regparm")sub_56ca10(int32_t arg1, int32_t* arg2, void* arg3, int32_t* arg4, int32_t* arg5)
{
    ...
    void var_40c
    void* edi = sub_56c7b0(arg3, &var_40c)
    ...
    if (eax_6 == 0 || eax_9 == 0)
        char* eax_10 = sub_56c7b0(esi, &var_40c)
        char* var_418 = eax_10
        ...
        if (*eax_10 != 0)
            ...
            if (ebx != 0)
                char* eax_13 = sub_56c7b0(esi, &var_40c)
                var_418 = eax_13
                int32_t eax_14
                int32_t edx_6
                ...
                if (eax_14 == 0)
                    ...
                    if (eax_18 == 0)
                        ...
                        *arg4 = edi_1
                        ...
                        int32_t eax_22 = sub_5602e0(eax_21, edi_1, i_6, 3)
                        
                        if (eax_22 != 0)
                            float* result
                            int32_t edx_10
                            result, edx_10 = sub_560340(eax_22, edi_1, i_6, 3)
                            ...
                            label_56cc80:
                                ...
                                if (ecx_14:1.b != 2 || edx_10.b != ecx_14:1.b || ebx_2.b s< 0)
                                    ...
                                    sub_56c8d0(eax_26.b, &var_414, result, 3)
                                    edi_8 = 1
                                    ebx_4 = 0
                                    i_7 = _free(result_3)
                                    
                                    do
                                        sub_5612f0(i_7, &var_438, esi, 4)
                                        int32_t eax_47 = (ebx_4 * i_6 + edi_8) * 3
                                        sub_56c8d0(eax_47.b, &var_438, &result[eax_47], 3)
                                        i_7 = i_6
                                        edi_8 += 1
                                    label_56d0be:
                                    while (edi_8 s< i_7)
                                        ...
                                        label_56cf51:
                                            ...
                                            if (edx_11 s>= 4)
                                                if (i_8 s> 0)
                                                    ...
                                                    do
                                                        result_6 = sub_56c8d0(result_6.b, result_7, 
                                                            result_4, 3)
                                                        result_4 = &result_4[3]
                                                        result_7 = &result_7[1]
                                                        i_2 = i_5

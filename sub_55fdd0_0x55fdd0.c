...
char* __convention("regparm")sub_55fdd0(int32_t arg1, int32_t arg2, int32_t arg3, void* arg4, int32_t arg5, char* arg6, void** arg7)
{
        ...
        if (ebx_3 != 0)
            ...
            if (esi s> 0)
                ...
                do
                    ...
                    do
                        sub_55fa70(i_3, var_3c, arg3, arg4, esi, edx_1, arg6, i, ebx_3)
                        int32_t esi_1 = 0
                        void* j = nullptr
                        int32_t var_58_1 = 0
                        
                        if (edi_1 s> 0 && edi_1 u>= 8 && data_6cf684 s>= 2)
                    ...
                    if (i != i_3)
                        sub_55fa70(i_3, var_3c, arg3, arg4, esi, edx_1, arg6, i_3, ebx_3)
                        i = i_2
                    
                    *i_5 = i.b
                    sub_579a90(i_5 + 1, ebx_3, edi_1)
                    i_3 = edi_1 + 1
                    i_5 += i_3
                    edx_1 = &var_30_1[1]
                    var_30_1 = edx_1
            ...
            _free(ebx_3)
            void* eax_35 = sub_55f1f0(&var_54, eax_4, i_6, &var_54)
            _free(i_6)
            ...
            if (eax_35 != 0)
                ...
                if (result != 0)
                    ...
                    *esi_5 = (ebx_6 s>> 0x18).b
                    ...
                    sub_579a90(&esi_5[8], eax_35, ebx_6)
                    var_28 = &esi_5[8] + ebx_6
                    _free(eax_35)
                    sub_55fa00(&var_28, ebx_6)
                    char* eax_57 = var_28
                    *eax_57 = 0

...
long doublesub_588f50(int32_t arg1 @ mxcsr, int16_t arg2 @ x87control, double arg3, int16_t arg4, uint64_t (* arg5)[0x2])
{
    ...
    if (data_151768c != 0)
        ...
        if (not(cond:0_1))
            ...
            *ecx = xmm0_4
            uint64_t xmm0_6[0x2] =
                __cmppd_xmmpd_mempd_immb(__andpd_xmmxuq_memxuq(xmm0_4, data_5aa860), data_5aa890, 4)
            ...
            var_14:4.d = 0x3ef
            var_14.d = &var_c
            sub_590d14(&arg3, &arg5, var_14, var_c, arg1)
        ...
        *esi = fconvert.d(fconvert.t(-nan(ind).0))
        ...
        label_590ca3:
            ...
            *esi = fconvert.d(x87_r6_2)
            ...
            int32_t var_3c_1 = 8
            return sub_58e91d(8, 0x1c, (fconvert.d(x87_r7_12)).d)

...
int32_t __convention("regparm")sub_524c50(int32_t arg1, int128_t* arg2, int32_t arg3, int32_t arg4, int32_t arg5)
{
    ...
    if (arg5 == 1)
        ...
        eax_1, ecx = sub_4c2e40(var_1c:0xc.d * var_1c:8.d)
        ebx = eax_1
        var_1c.d = ebx
    
    int32_t var_2c = arg4
    char result = sub_524b30(eax_1, &var_1c, ecx, arg3)
    ...
    if (arg5 != 1)
        ...
        *(arg2 + 0xc) = temp0_3
        void var_64
        sub_55ef50(temp0_3, ebx, ecx_4, var_1c:4.d, var_1c:8.d, ecx_4, var_70_1, temp0_1, ecx_4, 
            var_64, 0f)

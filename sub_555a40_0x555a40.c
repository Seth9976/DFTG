...
uint32_t __fastcallsub_555a40(HWND arg1)
{
    ...
    if (*(eax_2 + 4) != 0)
        ...
        label_555b9c:
            ...
            eax_2 = zx.d(lookup_table_555c24[eax_4])
            ...
            switch (eax_2)
                case 0
                    ...
                    label_555bda:
                        ...
                        eax_2 = SetFocus(*(data_1511868 + 0x1c))
                    else
                        eax_2 = SetFocus(*(edx_1 + 0x14))
                case 2
                    *(ecx + 8) = &data_60b558
                ...
                case 3
                    ...
                    if (hWnd_1 == 0 || *(edx_1 + 0x20) == 0)
                        ...
                        MoveWindow(*(data_1511868 + 0x20), X_2, Y_1, xmm1:8.d - X_2, xmm1:0xc.d - Y_1, 
                            1)

...
void* __convention("regparm")sub_4c6300(int32_t* arg1, int32_t** arg2, char* arg3, int32_t* arg4)
{
    ...
    if (edx != 0)
        ...
        if (arg1 == 0 || *arg1 == 0)
            ...
            if (arg1:1.b == 0)
                sub_579300(*arg4 + edi_2, edx, arg3 - edi_1 + 1)
    ...
    sub_489550(arg1, &data_5b2591, ecx, "d:\ax\trunk\ax2017\engine\defbin.cpp", var_1c_1, 

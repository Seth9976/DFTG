...
int32_t __convention("regparm")sub_521050(int32_t arg1, char* arg2, int32_t arg3, void* arg4)
{
    // 第一条实际指令: int32_t var_8 = 0xffffffff
    int32_t var_8 = 0xffffffff
    int32_t (* var_c)(void* arg1) = sub_5a25b8
    TEB* fsbase
    ...
    if (result_1 == 0)
        ...
        if (eax_4 != 0)
            xmm0_1 = sub_48a670(&var_1c, "#version 140\n#define VERSION_130\n")
        
        _strstr(xmm0_1, arg2, "#define NEED_ANDROID_SAMPLEREXTERNALOES")
        int32_t eax_5 = sub_48a670(&var_1c, "#define GLSL\n")
        char const* const var_40_1
        
        if (arg3 != 0x8b31)
            if (arg3 != 0x8b30)
                sub_489550(eax_5, &data_5b2591, "Halt", "d:\ax\trunk\ax2017\engine\openglgraphics.cpp", 
                    0x10f4, "GLLoadShader")
        ...
        sub_48a670(&var_1c, var_40_1)
        
        if (data_115107d != 0)
            sub_48a670(&var_1c, "#define HAVE_ADRENO420\n")
        
        int32_t eax_6 = data_1150db4
        
        if (eax_6 == 3)
            sub_48a670(&var_1c, "#define HAVE_RIFT\n")
            eax_6 = data_1150db4
        
        if (eax_6 == 5)
            sub_48a670(&var_1c, "#define HAVE_OPENVR\n")
        ...
        char* const var_18
        char* eax_12 = *sub_48a9d0(&var_18, "pre glShaderSource error in %s")
        ...
        char* eax_19 = *sub_48a9d0(&var_18, "glShaderSource error in %s")
        ...
        label_52136e:
            ...
            if (&var_3c != 0)
                ...
                sub_4892e0("Could not compile %s shader %s:\n%s\n")

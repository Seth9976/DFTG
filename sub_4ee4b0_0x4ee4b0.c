...
int32_t __fastcallsub_4ee4b0(int32_t arg1, int32_t* arg2)
{
    // 第一条实际指令: void* const __return_addr_1 = __return_addr
    void* const __return_addr_1 = __return_addr
    int32_t __saved_ebp
    int32_t eax_1 = __security_cookie ^ &__saved_ebp
    int32_t* eax_3 = sub_4eeb50(arg1)
    int32_t* ecx = *eax_3
    ...
    if (eax_4[2] s> 0)
        ...
        do
            if (*(edi_1 + *eax_4 + 0x39) == 0)
                void var_e8
                int128_t* eax_7 = sub_4ee3c0(&var_e8, i, arg1, &var_e8)
                int64_t xmm0_1 = eax_7[2].q
                float xmm6_1[0x4] = *eax_7
                float xmm7_1[0x4] = eax_7[1]
                int128_t var_b0_1 = data_63c274
                float xmm5_1 = arg2[1]
                ...
                float xmm0_37 = 1f f/ data_63c264.d
                ...
                if (xmm4_8 f< 0 || xmm2_9 f< 0 || xmm1_18 f< 0 || xmm3_6 < xmm4_8
                    ...
                    if (sub_4db4b0(&var_70, &var_3c, arg2, &var_70) == 0)
                        result = result_1
                    else

...
int32_t __convention("regparm")sub_518ab0(int32_t arg1, int32_t* arg2, int32_t arg3, int32_t arg4, uint32_t arg5)
{
    ...
    if (arg4 s< 0 || arg4 s>= *esi_1)
        ...
        var_1c_1 = 0x85
        var_20_1 = "d:\ax\trunk\ax2017\engine\defeditor.cpp"
        ...
        if (arg1 != 0)
            ...
            sub_4ce780(arg1, arg2, ebx_2, arg5)
            int32_t edx = *esi_1
            ...
            if (edx != 1)
                ...
                if (eax_4 s> 0)
                    sub_579300(ebx_2, ebx_2 + arg1, eax_4)
                    edx = *esi_1
        ...
        var_1c_1 = 0x6d
        var_20_1 = "d:\ax\trunk\ax2017\engine\definition.cpp"
        ecx_1 = "pDefMap->definitionSize != 0"
    
    sub_489550(arg1, &data_5b2591, ecx_1, var_20_1, var_1c_1, var_18)

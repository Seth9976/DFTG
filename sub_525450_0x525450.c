...
int32_t __fastcallsub_525450(int32_t arg1, int128_t* arg2)
{
    ...
    uint32_t eax = sub_5234e0(0x400, performanceCount_4)
    uint32_t var_34 = eax
    ...
    if (eax != 0x1000)
        ...
        var_a8 = 0x4d9
        var_ac = "d:\ax\trunk\ax2017\engine\textureimport.cpp"
        ecx = "processedImage.pitch == imageWidth * (int)sizeof(uint32)"
    label_5257d8:
        sub_489550(eax, &data_5b2591, ecx, var_ac, var_a8, var_a4_1)
    ...
    void* eax_2 = sub_4c2e40(sub_5235a0(eax, 0x1800, 0x400, performanceCount_4))
    int32_t i = 0
    void* var_40_1 = eax_2
    ...
    do
        ...
        do
            ...
            do
                ...
                float xmm0_11
                eax, xmm0_11 = sub_41dbe0(xmm1_1.d f* xmm1_1 + xmm2_7.d f* xmm2_7 + xmm3_2 * xmm3_2)
                
                if (xmm0_11 <= 9.99999975e-06f)
                    var_a4_1 = "Norm"
                    var_a8 = 0x12e
                    var_ac = "d:\ax\trunk\ax2017\engine\vec3.cpp"
                    ecx = "length > EPSILON"
                    goto label_5257d8
                ...
                float xmm0_22 = sub_41dbe0(var_88_2 * var_88_2 + var_84_2 * var_84_2)
                float xmm2_10
                ...
                k += 1
                xmm0_6 = var_4c_1
                *ecx_6 = sub_524fd0(arg2, var_80_4.d, xmm2_10)
                var_70_1 = &ecx_6[1]
            while (k s< 0x400)
    ...
    *arg2 = var_40_1.o
    ...
    int32_t var_5c
    int32_t var_44
    uint32_t var_ac_1 = sub_489b30(performanceCount_3 - performanceCount_1, 
        sbb.d(var_5c, var_44, performanceCount_3 u< performanceCount_1))
    return sub_4892e0("ProcessCylinderCubeMap time %d ms")
}

...
uint32_t __fastcallsub_490620(int128_t* arg1, float* arg2)
{
    ...
    void var_b0
    void* edx = &var_b0
    sub_495590(sub_497c60(arg1, edx), edx, arg2, 8)
    int64_t xmm0 = 0
    float xmm6 = arg2[4]
    float xmm3 = arg2[2]
    ...
    uint32_t result = sub_490490(xmm0_109, &var_50, &var_b0, 0x5d2378)

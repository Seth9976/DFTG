...
void* __convention("regparm")sub_50ebb0(int32_t arg1, int32_t arg2, int32_t* arg3, int32_t arg4)
{
    // 第一条实际指令: *arg3 = 0
    *arg3 = 0
    arg3[1] = 0
    ...
    if (eax != 0)
        ...
        if (*(eax + 8) s> 0)
            do
                ...
                int32_t eax_1
                int32_t edx_1
                eax_1, edx_1 = sub_50cdf0(i, edx.b)
                int32_t eax_3
                int32_t edx_2
                ...
                int32_t eax_10
                int32_t edx_3
                eax_10, edx_3 = sub_50cdf0(i, edx_2.b)
                int32_t eax_12
        ...
        int128_t var_20
        int128_t xmm0_1 = *sub_50cd80(&var_20)
        eax = xmm0_1
        var_20 = xmm0_1

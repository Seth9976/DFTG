...
void __convention("regparm")sub_55cd40(int32_t arg1, int32_t arg2, void* arg3, void* arg4, int32_t* arg5, void* arg6, void* arg7, int32_t arg8)
{
                        ...
                        if (j_12 u>= 4)
                            ...
                            if (var_a4_4 u> var_a0_5 - 4 + edi || var_ac_3 - 2 + ecx_22 u< var_b8_1)
                                ...
                                do
                                    ...
                                    int64_t xmm5_1 = (data_60cb80).q
                                    uint32_t xmm1_11[0x4] = _mm_cmpeq_ps(xmm2_7, zx.o(0), 1)
                                    j_2 += 4
                                    int64_t xmm5_2 = (data_60cb80).q
                                    ...
                                    *(eax_63 - 4) = _mm_shuffle_epi32(
                                        _mm_shufflehi_epi16(
                                            _mm_shufflelo_epi16(
                                                _mm_cvttpd_epi32(__addpd_xmmpd_mempd(
                                                    _mm_cvtps_pd(_mm_mul_ps(xmm3_6, (data_60cc40).q)), 
                                                    data_60cba0)), 
                                                0xd8), 
                                            0xd8), 
                                        0xd8)
                                    ...
                                    *eax_63 = _mm_shuffle_epi32(
                                        _mm_shufflehi_epi16(
                                            _mm_shufflelo_epi16(
                                                _mm_cvttpd_epi32(__addpd_xmmpd_mempd(
                                                    _mm_cvtps_pd(_mm_mul_ps(xmm3_9, (data_60cc40).q)), 
                                                    data_60cba0)), 
                                                0xd8), 
                                            0xd8), 
                                        0xd8)
                        ...
                        do
                            ...
                            if (0 f<= xmm1_18)
                                ...
                                if (0.00313080009f < xmm0_68)
                                    edx_6 = arg4
                                    xmm0_67 = fconvert.s(
                                        sub_41f0d0(xmm0_68, 0x3ed55555) * fconvert.t(1.05499995f)
                    ...
                    if (j_12 s> 0)
                        ...
                        do
                            ...
                            st0_2, eax_79, x87control, xmm6 =
                                sub_598351(x87control, fconvert.d(xmm4) * 4294967295.0 + 0.5, xmm6)
                            xmm4 = (zx.o(0)).d
                            *esi_12 = eax_79
                            esi_12 += 4
                            j_4 = j_7
                    ...
                    if (esi_2 s> 0)
                        do
                            ...
                            if (not(0 f> xmm0_80) && 0.00313080009f f< xmm4)
                                long double st0_3
                                st0_3, x87control, xmm6 = sub_41f0d0(xmm4, 0x3ed55555)
                                xmm1_19 = 0.5
                            ...
                            st0_4, eax_82, x87control, xmm6 =
                                sub_598351(x87control, fconvert.d(xmm4_1) * xmm3_11 + xmm1_19, xmm6)
                            xmm4 = (zx.o(0)).d
                            xmm1_19 = 0.5
                            xmm3_11 = 4294967295.0
                    ...
                    if (esi_2 s> 0)
                        ...
                        do
                            ...
                            if (0.00313080009f < xmm0_88)
                                ...
                                edx_9 = var_9c_7
                                xmm0_89 = fconvert.s(
                                    sub_41f0d0(xmm0_88, 0x3ed55555) * fconvert.t(1.05499995f)
                                    - fconvert.t(0.0549999997f))
                            else

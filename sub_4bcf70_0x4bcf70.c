...
int32_t __convention("regparm")sub_4bcf70(int32_t arg1, int32_t* arg2, int128_t* arg3, float arg4 @ xmm3, int64_t* arg5)
{
    ...
    if (*(arg3 + 0x7c) + xmm1 f+ *(arg3 + 0x78) <= arg4)
        ...
        *arg3 = *(arg3 + 0x3c)
        ...
        void var_4c
        int32_t* eax_4 = sub_4bcae0(sub_4bc5c0(arg3, arg4), &var_4c)
        int128_t xmm1_3 = *(eax_4 + 0x10)
    ...
    *(arg3 + 0x5c) = *(arg2 + 0x20)
    *(arg3 + 0x6c) = *(arg2 + 0x30)
    int32_t eax_7 = arg2[0xe]
    *(arg3 + 0x78) = *arg5
    *(arg5 + 4)
    *arg5
    *(arg3 + 0x74) = eax_7
    int32_t eax_8 = arg5[1].d
    arg3[8].d = eax_8
    *(arg3 + 0x84) = arg4
    *(arg3 + 0x8c) = arg4
    return eax_8

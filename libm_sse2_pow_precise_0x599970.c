...
void*__libm_sse2_pow_precise(int32_t arg1 @ esi, int32_t arg2 @ edi, int32_t arg3 @ mxcsr, int16_t arg4 @ x87control, double arg5 @ xmm0)
{
    ...
    if ((arg3 & 0x7f80) == 0x1f80)
        ...
        if (eax_1.w == 0x7f)
            ...
            uint64_t xmm7_2[0x2] = xmm7_1 f* *((eax_5 << 2) + &data_5ae118)
            double xmm5 = *((eax_5 << 2) + &data_5ae118)
            double xmm6[0x2] = *(eax_5 * 8 + &data_5ae530)
            int64_t var_18
            int32_t eax_50
            int32_t eax_53
            int32_t ecx_3
            ...
            if (((ecx - 0x10) | (0x7fef - ecx)) u>= 0x80000000)
                ...
                if (ecx_7 u< 0x7ff00000)
                    if ((xmm1_12 | ecx_7) == 0)
                        ...
                        return sub_590d14(&var_10, &var_8, &var_18, edx_17)
                    ...
                    label_599e3d:
                        ...
                        label_599ecc:
                            ...
                            if ((var_8:4.d & 0x80000000) != 0)
                                ...
                                return sub_590d14(&var_10, &var_8, &var_18, 0x1b)
                            ...
                            if (zx.d(eax_31) == 0xff)
                                ...
                                eax_47 = zx.d(_mm_movemask_epi8(_mm_cmpeq_epi32(
                                    _mm_sll_epi64(xmm1_24, 
                                        _mm_sub_epi32(
                                            _mm_srli_epi64(__andpd_xmmxuq_memxuq(xmm1_24, data_60d3f0), 
                                                0x34), 
                                            0x3f4)), 
                                    zx.o(0))))
                        ...
                        if (zx.d(eax_31) == 0xff)
                            ...
                            ecx_3 = (0x3ff01 + zx.d(_mm_movemask_epi8(_mm_cmpeq_epi32(
                                _mm_sll_epi64(xmm1_17, 
                                    _mm_sub_epi32(
                                        _mm_srli_epi64(__andpd_xmmxuq_memxuq(xmm1_17, data_60d3f0), 
                                            0x34), 
                                        0x3f4)), 
                        ...
                        if (eax_37 != 0)
                            ...
                            return sub_590d14(&var_10, &var_8, &var_18, 0x1c)
                        
                        if ((eax_37 & 0x7fffffff) == 0)
                            goto label_599ecc
                    uint64_t xmm7_15[0x2] = _mm_and_pd(xmm7_2, xmm0)
                    xmm4 = xmm0.q
                    xmm0 = _mm_srli_epi64(__andpd_xmmxuq_memxuq(xmm0, data_60d3f0), 0x2c)
                    int32_t eax_41 = (zx.d(_mm_extract_epi16(xmm0, 0)) + 1) & 0x1fe
                    xmm7_2 = _mm_or_pd(xmm7_15, xmm2_25) f* *((eax_41 << 2) + &data_5ae118)
                    xmm5 = *((eax_41 << 2) + &data_5ae118)
                    xmm6 = *(eax_41 * 8 + &data_5ae530)
                    edx_1 = 0x43e7f
                    goto label_599a30
                ...
                label_59a014:
                    var_18 = xmm4 f+ xmm4
                    return sub_590d14(&var_10, &var_8, &var_18, 0x3ee)
            else
                ecx_3 = 0
                edx_1 = 0x3fe7f
            label_599a30:
                ...
                uint64_t xmm4_1[0x2] = __andpd_xmmxuq_memxuq(xmm4, data_60d3d0)
                int32_t eax_10 = (zx.d(eax_7) + 1) & 0x1fe
                uint64_t xmm3_2[0x2] = xmm7_2.q f* *((eax_10 << 2) + &data_5aed40)
                double xmm5_1 = xmm5 f* *((eax_10 << 2) + &data_5aed40)
                double xmm6_1 = __addpd_xmmpd_mempd(xmm6, *(eax_10 * 8 + &data_5af150))
                uint64_t xmm4_2[0x2] = __orpd_xmmxuq_memxuq(xmm4_1, data_60d3e0)
                ...
                uint64_t xmm5_2[0x2] = xmm5_1 f* *((eax_15 << 2) + &data_5af960)
                double xmm2_2 = xmm3_2.q f* *((eax_15 << 2) + &data_5af960)
                double xmm6_3 = __addpd_xmmpd_mempd(xmm6_1 + xmm0_3, *((eax_15 << 3) + &data_5b0170))
                ...
                if (eax_17 u< 0x7ff0)
                    ...
                    if (((0x40a0 - eax_19) | (eax_19 - 0x3c70)) u< 0x80000000
                        ...
                        if (((0x1ff7f - eax_21) | (eax_21 + 0x1e1ff)) s> 0)
                            ...
                            double xmm3_11[0x2] = *(eax_28 + 0x5b11a0)
                            double xmm6_8[0x2] = data_60d400
                            ...
                            uint32_t xmm1_11[0x4] = _mm_shuffle_epi32(
                                ...
                                0x44)
                            double xmm7_10[0x2] = data_60d410
                        ...
                        label_59a22d:
                            ...
                            double xmm3_22[0x2] = *(eax_64 * 0x10 + 0x5b11a0)
                            double xmm6_12[0x2] = data_60d400
                            ...
                            double xmm7_20[0x2] = data_60d410

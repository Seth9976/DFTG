...
char* __fastcallsub_542a70(int32_t* arg1, int32_t** arg2)
{
    // 第一条实际指令: int32_t var_8 = 0xffffffff
    int32_t var_8 = 0xffffffff
    int32_t (* var_c)(void* arg1) = sub_5a3120
    TEB* fsbase
    ...
    int32_t var_8_1 = 0
    int32_t* i_7 = *arg1
    sub_4892e0("AtlasMaker: making page %s")
    int32_t var_54
    i_7 = &var_54
    QueryPerformanceCounter(i_7)
    int32_t var_84 = var_54
    int32_t var_50
    ...
    if (arg1[4] s> 0)
        do
            uint32_t eax_5 = arg1[2]
            i_7 = &i_8
            sub_542600(eax_5, arg2, *(eax_5 + (i << 3)), i_7)
            i += 1
        while (i s< arg1[4])
    ...
    if (arg1[4] s<= 0 || var_58 s<= 0)
        i_7 = *arg1
        sub_4892e0("AtlasMaker: not enough textures for atlas page: '%s'")
        var_8_1.b = 0xb
    else
        int32_t* i_1 = nullptr
        int64_t var_4c = 0
        int32_t edi_1 = var_4c:4.d
        ...
        do
            ...
            sub_48a9d0(&lpFileName_6, "%s-%s-%d.png")
            PSTR lpFileName_3 = lpFileName_6
            PSTR lpFileName = &data_5b2591
            ...
            if (GetFileAttributesExA(lpFileName, GetFileExInfoStandard, i_7) == 0)
                ...
                if (data_aca1f4 != 0)
                    ...
                    if (lpFileName_8 != 0 && *lpFileName_8 != 0)
                        char* eax_10 = sub_48a080(&lpFileName_6)
                        int32_t temp2_1 = *(eax_10 + 4)
                        *(eax_10 + 4) -= 1
                        
                        if (temp2_1 == 1)
                            sub_4984f0(eax_10, *(eax_10 + 0xc) + 0x10)
                            lpFileName_6 = &data_5b2591
                
                var_8_1.b = 2
                break
            
            if (var_20 u>= edi_1 && (var_20 u> edi_1 || var_24 u> var_4c:4.d))
                edi_1 = var_20
                var_4c:4.d = var_24
                var_50_1 = edi_1
            ...
            if (data_aca1f4 != 0)
                ...
                if (lpFileName_7 != 0 && *lpFileName_7 != 0)
                    char* eax_9 = sub_48a080(&lpFileName_6)
        ...
        if (edi_1 != 0 || esi != 0)
            ...
            while (i_2 != 0)
                ...
                if (*(esi_1 + 8) != 0)
                    bool cond:3_1 = sub_4e6cc0(esi_1) != 0
                    char* i_18 = *(esi_1 + 0x20)
                    
                    if (cond:3_1)
                        char* i_16 = &data_5b2591
                        
                        if (i_18 != 0)
                            i_16 = i_18
                        
                        i_7 = i_16
                        sub_4892e0("AtlasMaker: rebuilding page for: '%s'")
                        goto label_542dd6
                    
                    char* i_21 = &data_5b2591
                    
                    if (i_18 != 0)
                        i_21 = i_18
                    
                    sub_4e5da0(&lpFileName_6, i_21)
                    PSTR lpFileName_5 = lpFileName_6
                    PSTR lpFileName_2 = &data_5b2591
                    ...
                    if (GetFileAttributesExA(lpFileName_2, GetFileExInfoStandard, i_7) == 0)
                        ...
                        int32_t* i_12 = &data_5b2591
                        
                        if (i_20 != 0)
                            i_12 = i_20
                        
                        i_7 = i_12
                        sub_4892e0("AtlasMaker: rebuilding page because no xbin for: '%s'")
                        var_8_1.b = 8
                    label_542d9f:
                        ...
                        if (data_aca1f4 != 0)
                            ...
                            if (lpFileName_10 != 0 && *lpFileName_10 != 0)
                                char* eax_17 = sub_48a080(&lpFileName_6)
                    ...
                    if (var_20 u> var_50_1 || (var_20 u>= var_50_1 && var_24 u>= var_4c:4.d))
                        int32_t* i_19 = *(esi_1 + 0x20)
                        int32_t* i_11 = &data_5b2591
                        
                        if (i_19 != 0)
                            i_11 = i_19
                        
                        i_7 = i_11
                        sub_4892e0("AtlasMaker: rebuilding page because image is new: '%s'")
                        var_8_1.b = 9
                        goto label_542d9f
                    ...
                    if (data_aca1f4 != 0)
                        ...
                        if (lpFileName_9 != 0 && *lpFileName_9 != 0)
                            char* eax_16 = sub_48a080(&lpFileName_6)
                    ...
                    char* const i_10 = &data_5b2591
                    
                    if (i_17 != 0)
                        i_10 = i_17
                    
                    i_7 = i_10
                    sub_4892e0("AtlasMaker: unknown asset '%s'")
        ...
        label_542dd6:
            int32_t esi_2 = var_58 << 2
            uint32_t (* var_70)[0x4] = sub_498490(esi_2)
            int32_t edi_2 = 0
            int32_t var_6c_1 = 0
            var_8_1.b = 0xe
            uint32_t (* var_7c)[0x4] = sub_498490(esi_2)
            int32_t var_78_1 = 0
            int32_t* i_3 = i_9
            var_8_1.b = 0xf
            ...
            while (i_3 != 0)
                int32_t* eax_23 = *i_3
                i_3 = i_3[1]
                int32_t eax_24 = sub_5429a0(eax_23)
                
                if (eax_24.b != 0)
                    if (edi_2 s>= var_58)
                        i_7 = "XArray<struct XAsset *>::Append"
                        sub_489550(eax_24, &data_5b2591, "mSize < mSizeReserved", 
                            "d:\ax\trunk\ax2017\engine\xarray.h", 0x96, i_7)
                    ...
                    (*var_70)[edi_2] = eax_23
                    edi_2 += 1
                    int32_t var_6c_2 = edi_2
            
            i_7 = sub_498220(&var_84)
            int32_t* i_13 = sub_4892e0("AtlasMaker: match and load assets time %d ms")
            int32_t* ebx_1 = &var_70
            ...
            for (i_4 = nullptr; i_4 s< 0x64; )
                ...
                if (result_4 != 0 && *result_4 != 0)
                    result_4 = sub_48a080(&i_7)
                    *(result_4 + 4) += 1
                
                i_13 = sub_541fd0(result_4, i_4, arg1, ebx_1, esi_3)
            ...
            while (i_5 s< 0x64)
                ...
                sub_48a2c0(&var_4c:4, edx_10)
                var_8_1.b = 0x10
                char* const edx_11 = &data_5b2591
                char* esi_4 = var_4c:4.d
                char* result_7 = &data_5b2591
                ...
                if (GetFileAttributesA(i_7) == 0xffffffff)
                    ...
                    if (data_aca1f4 != 0)
                        ...
                        if (lpFileName_12 != 0 && *lpFileName_12 != 0)
                            char* eax_37 = sub_48a080(&lpFileName_6)
                ...
                if (data_aca1f4 != 0)
                    ...
                    if (lpFileName_11 != 0 && *lpFileName_11 != 0)
                        char* eax_33 = sub_48a080(&lpFileName_6)
                ...
                if (data_aca1f4 != 0 && esi_4 != 0 && *esi_4 != 0)
                    char* eax_34 = sub_48a080(&var_4c:4)
            ...
            if (data_aca1f4 != 0)
                uint32_t (* ecx_25)[0x4] = var_7c
                
                if (ecx_25 != 0)
                    sub_4984f0(ecx_25, var_58 << 2)
            
            var_8_1.b = 0x16
            
            if (data_aca1f4 != 0)
                uint32_t (* ecx_26)[0x4] = var_70
                
                if (ecx_26 != 0)
                    sub_4984f0(ecx_26, var_58 << 2)
            
            var_8_1.b = 0x17
    
    char* result = sub_436340(&i_8)
    var_8_1.b = 0x18

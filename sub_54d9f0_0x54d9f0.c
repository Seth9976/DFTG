...
long double __convention("regparm")sub_54d9f0(int32_t arg1, int32_t arg2, int32_t* arg3, float* arg4)
{
    ...
    *arg4 = xmm0_6 * 360f / 6.28318548f
    ...
    float xmm3_1 = _mm_cvtpd_ps(__andps_xmmxud_memxud(xmm4_2, data_60cc80))
    int32_t mxcsr
    uint64_t xmm5[0x2]
    int64_t xmm6

...
int32_t*?write_double_translated_ansi_nolock@@YA?AUwrite_result@?A0x17268360@@HQBDI@Z(int32_t* arg1, int32_t arg2, char* arg3, void* arg4)
{
    ...
    int32_t edi
    int32_t var_50 = edi
    HANDLE hFile = *(ebx + (&data_6cfb08)[ecx_1] + 0x18)
    ...
    *(edi_2 + 4) = 0
    ...
    if (arg3 u< eax_6)
        ...
        while (true)
            ...
            int32_t edx_1 = (&data_6cfb08)[ecx_1]
            ...
            if ((ecx_2.b & 4) == 0)
                ...
                if (*(____mb_cur_max_func(ecx_2) + (zx.d(var_1d_1) << 1)) s>= 0)
                    var_54_1 = 1
                    var_58_1 = edi_5
                    goto label_58de31
                
                if (var_28_1 u>= eax_6)
                    *(ebx + (&data_6cfb08)[ecx_1] + 0x2e) = var_1d_1
                    int32_t eax_25 = (&data_6cfb08)[ecx_1]
                    *(ebx + eax_25 + 0x2d) |= 4
                    result[1] += 1
                    break
                
                if (__mbsnicoll(&var_1c, edi_5, 2) == 0xffffffff)
                    break
            ...
            label_58de31:
                ...
                if (__mbsnicoll(&var_1c, var_58_1, var_54_1) == 0xffffffff)
                    break

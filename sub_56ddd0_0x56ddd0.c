...
void*sub_56ddd0(void* arg1, void* arg2, float arg3, float arg4, int32_t arg5)
{
    ...
    if (edi[0x1b] != 0)
        ...
        if (*ebx_1 f<= arg3)
            ...
            switch (eax_1)
                case 0
                    void* eax_12 = *edi
                    edi[5] = xmm2_1 * arg4 f+ *(eax_12 + 0x10)
                    edi[6] = xmm3_2 * arg4 f+ *(eax_12 + 0x14)
                    return eax_12
                case 1, 2
                    void* eax_13 = *edi
                    edi[5] = (*(eax_13 + 0x10) + xmm2_1 f- edi[5]) * arg4 f+ edi[5]
                    edi[6] = (*(eax_13 + 0x14) + xmm3_2 f- edi[6]) * arg4 f+ edi[6]
                    return eax_13
                case 3
                    float xmm3_11 = xmm3_2 * arg4 f+ edi[6]
                    edi[5] = xmm2_1 * arg4 f+ edi[5]
                    edi[6] = xmm3_11
        else
            if (arg5 == 0)
                void* ecx_1 = *edi
            ...
            if (arg5 == 1)
                void* eax_4 = *edi
                edi[5] = (*(eax_4 + 0x10) f- edi[5]) * arg4 f+ edi[5]
                edi[6] = (*(eax_4 + 0x14) f- edi[6]) * arg4 f+ edi[6]
                return eax_4

...
int32_t __convention("regparm")sub_520cd0(int32_t arg1, void* arg2, int32_t arg3, void* arg4)
{
    ...
    *(ebx + 0x20) = esi_1
    ...
    if (ecx s> 0)
        do
            ...
            if (data_62473c s> 0)
                ...
                do
                    ...
                    if (eax_8 == 0)
                        ...
                        if (edx s< 0 || edx s>= data_624744)
                            var_100_7 = "AttribTagGetField"
                            var_104_5 = 0x8b
                            ecx_7 = "(int)tag >= 0 && (int)tag < pAttribTable->lookupTableSize"
                        label_520f3d:
                            sub_489550(eax_8, &data_5b2591, ecx_7, 
                                "d:\ax\trunk\ax2017\engine\attribmap.cpp", var_104_5, var_100_7)
            ...
            sub_4892e0("Unknown shader constant '%s'")
        label_520e36:
            result = result_1 + 1
            result_1 = result

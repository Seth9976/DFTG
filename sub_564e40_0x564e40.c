...
int32_t __fastcallsub_564e40(int32_t* arg1)
{
    ...
    if (sub_564d40(arg1, 0) == 0)
        return 0
    
    uint32_t eax_2 = zx.d(sub_5634c0(ebx))
    ...
    if (eax_2 != 0xd9)
        while (true)
            if (eax_2 == 0xda)
                ...
                if (sub_563e60(ebx, eax_2) == 0)
                    return 0
            else
                uint32_t eax_14 = sub_561390(*ebx)
                uint32_t eax_15 = sub_561390(*ebx)

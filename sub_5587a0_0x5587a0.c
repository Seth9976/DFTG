...
LRESULT __fastcallsub_5587a0(LRESULT arg1, void* arg2)
{
    ...
    if (*(arg2 + 0x14) != 0x63)
        ...
        LRESULT lParam = SendMessageA(*(data_1511868 + 0x18), 0x199, arg1, 0)
        ...
        switch (eax_3)
            ...
            case 4
                ...
                eax_3 = sub_553d20(&var_114, 0x104, "%d,%d,%d")
                edi_1 = &var_114
            case 5
                eax_3 = sub_555630(*(arg2 + 0x10))
                edi_1 = &data_15168a8
            case 6
                sub_5556b0(*(arg2 + 0x10))
                *(arg2 + 8) = 0x1517030
                eax_3 = *(arg2 + 0x10)
                edi_1 = *(eax_3 + 4)
            case 8
            ...
            case 9
                ...
                eax_3 = sub_553d20(&var_114, 0x104, "%d.%d.%d.%d")
                edi_1 = &var_114
            case 0xa
        ...
        char** lParam_1 =
            sub_553dd0(eax_3, *(arg2 + 4), *lParam, edi_1, *(arg2 + 8), *(arg2 + 0xc), *(arg2 + 0x14))
        
        if (SendMessageA(*(data_1511868 + 0x18), 0x19a, wParam, lParam_1) != 0xffffffff)
            WPARAM wParam_1 = SendMessageA(*(data_1511868 + 0x14), 0x18f, 0, lParam)
            
            if (wParam_1 != 0xffffffff)
                LRESULT wParam_2 = SendMessageA(*(data_1511868 + 0x14), 0x19a, wParam_1, lParam_1)
                HWND hWnd = *(data_1511868 + 0x14)
                wParam = wParam_2
                RedrawWindow(hWnd, nullptr, nullptr, RDW_INVALIDATE | RDW_ERASE | RDW_UPDATENOW)
                LRESULT result = wParam
                
                if (result != 0xffffffff)
                    void* eax_21 = data_1511868

...
int32_t __fastcallsub_50cdf0(int32_t arg1, char arg2)
{
    // 第一条实际指令: int32_t ebx
    int32_t ebx
    ebx.b = arg2
    ...
    if (eax != 0)
        if (arg1 s>= 0 && arg1 s< *(eax + 8))
            data_1151090 - data_1151094
            float* esi_2 = (arg1 << 4) + *eax
            void var_1c
            uint128_t xmm1_1 = *sub_50cd80(&var_1c)
    ...
    sub_489550(eax, &data_5b2591, ecx, "d:\ax\trunk\ax2017\engine\windows\editorwindow.cpp", var_34, 
        "EditorGetNodePoint")

...
float* __convention("regparm")sub_4cdb60(int32_t arg1, int128_t* arg2, float* arg3, float arg4, int128_t* arg5, float arg6)
{
    ...
    if (p_1 || p_3)
        ...
        if (xmm5_2 < xmm7_4 || xmm1_11 < xmm6_4)
            sub_489550(eax_1, &data_5b2591, "RectIsNormalized(r)", 

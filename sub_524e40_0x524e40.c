...
void* __convention("regparm")sub_524e40(int32_t arg1, void* arg2, void* arg3, int32_t arg4)
{
    ...
    if (result == *(arg2 + 8))
        ...
        if (result == *(arg2 + 4))
            int32_t eax = sub_5233d0(*(esi + 0x10))
            result = sub_5233d0(*(arg2 + 0x10))
            void* i = nullptr
                ...
                do
                    ...
                    if (ecx_3 s> 0)
                        ...
                        do
                            ...
                            char* eax_5 =
                                sub_523670(*(esi + 0xc) * i + *esi + var_c_1, *(var_14 + 0x10))
                            sub_5238f0(arg2, *(arg2 + 0x10), esi_5, eax_5)
                            esi = var_14
                            result = result_2 + 1
                            var_c_1 += eax
                            ecx_3 = *(esi + 4)
    ...
    label_524fa5:
    sub_489550(result, &data_5b2591, ecx, "d:\ax\trunk\ax2017\engine\textureimport.cpp", var_30, 

...
int32_t__libm_sse2_exp_precise(int32_t arg1 @ mxcsr, int16_t arg2 @ x87control, int64_t arg3 @ xmm0)
{
    ...
    if ((arg1 & 0x7f80) == 0x1f80)
        ...
        if (eax_1.w == 0x7f)
            ...
            double xmm1[0x2] = data_60d130
            double xmm6[0x2] = data_60d110
            double xmm2[0x2] = data_60d140
            double xmm3[0x2] = data_60d150
            ...
            if (((0x408f - eax_3) | (eax_3 - 0x3c90)) u>= 0x80000000)
                ...
                uint64_t xmm7_4[0x2] =
                    _mm_slli_epi64(_mm_add_epi64(xmm1_2 & data_60d0f0, data_60d100), 0x2e)
                ...
                double xmm6_5 =
                    _mm_or_pd(data_60d0e0 & not.o(xmm2_4), _mm_slli_epi64(zx.o(eax_7 + 0x3ff), 0x34))
            ...
            var_12 = xmm0_10
            return sub_590d14(&var_8, &var_8, &var_12:2, edx_7)
    
    var_8 = arg3
    int32_t eax_14 = sub_59b1ab()
    long double x87_r0

...
HWND __convention("regparm")sub_5487c0(int32_t arg1, int32_t* arg2, int32_t* arg3, float* arg4)
{
    ...
    if ((0x8000 & eax_3) != 0 && *(data_aca1f0 + 0x18) != 0 && (eax_5 == data_1150b8c || eax_5 == 0)
            && (*(data_114e840 + 0xc) & 2) != 0 && *(data_aca1f0 + 0x18) != 0)
    ...
    if ((0x8000 & GetKeyState(0x53)) != 0 && *(data_aca1f0 + 0x18) != 0)
        HWND eax_10 = GetFocus()
        
        if ((eax_10 == data_1150b8c || eax_10 == 0) && (*(data_114e840 + 0xc) & 2) != 0
                && *(data_aca1f0 + 0x18) != 0)
            var_24_1 = var_24_1 - xmm2_2
            var_2c = var_2c - xmm4_5
            var_28 = var_28 - xmm0_8
    
    if ((0x8000 & GetKeyState(0x41)) != 0 && *(data_aca1f0 + 0x18) != 0)
        HWND eax_15 = GetFocus()
        
        if ((eax_15 == data_1150b8c || eax_15 == 0) && (*(data_114e840 + 0xc) & 2) != 0
                && *(data_aca1f0 + 0x18) != 0)
    ...
    if ((0x8000 & eax_18) != 0 && *(data_aca1f0 + 0x18) != 0)
        eax_20 = GetFocus()
    
    float xmm0_44
    float xmm1_4
    
    if ((0x8000 & eax_18) != 0 && *(data_aca1f0 + 0x18) != 0 && (eax_20 == data_1150b8c || eax_20 == 0)
            && (*(data_114e840 + 0xc) & 2) != 0)
        xmm1_4 = var_28
        
        if (*(data_aca1f0 + 0x18) == 0)
            xmm0_44 = var_2c
        else
    ...
    if (not(xmm3_5 <= 9.99999975e-06f))
        ...
        if ((0x8000 & eax_23) != 0 && *(data_aca1f0 + 0x18) != 0)
            eax_25 = GetFocus()
        
        if ((0x8000 & eax_23) != 0 && *(data_aca1f0 + 0x18) != 0
            && (eax_25 == data_1150b8c || eax_25 == 0))
        label_548b46:
            
            if ((0x8000 & GetKeyState(0x11)) != 0 && *(data_aca1f0 + 0x18) != 0)
                HWND eax_31 = GetFocus()
                
                if (eax_31 == data_1150b8c || eax_31 == 0)
                    var_30_2 = 0.00400000019f
        else if ((0x8000 & GetKeyState(0xa1)) != 0 && *(data_aca1f0 + 0x18) != 0)
            HWND eax_28 = GetFocus()
            
            if (eax_28 == data_1150b8c || eax_28 == 0)
                goto label_548b46
        
        int16_t eax_32 = GetKeyState(0xa0)
        HWND eax_34
        
        if ((0x8000 & eax_32) != 0 && *(data_aca1f0 + 0x18) != 0)
            eax_34 = GetFocus()
        
        if ((0x8000 & eax_32) != 0 && *(data_aca1f0 + 0x18) != 0
                && (eax_34 == data_1150b8c || eax_34 == 0))
            var_30_2 = var_30_2 * 10f
        else if ((0x8000 & GetKeyState(0xa1)) != 0 && *(data_aca1f0 + 0x18) != 0)
            HWND eax_37 = GetFocus()
            
            if (eax_37 == data_1150b8c || eax_37 == 0)
                var_30_2 = var_30_2 * 10f
        ...
        float xmm1_5 = 1f / (sub_41dbe0(xmm3_5) + 9.99999975e-06f)
    ...
    if ((0x8000 & eax_41) != 0 && *(data_aca1f0 + 0x18) != 0)
        eax_43 = GetFocus()
    
    if ((0x8000 & eax_41) != 0 && *(data_aca1f0 + 0x18) != 0 && (eax_43 == data_1150b8c || eax_43 == 0))
    label_548cdf:
        
        if ((0x8000 & GetKeyState(0x11)) != 0 && *(data_aca1f0 + 0x18) != 0)
            HWND eax_49 = GetFocus()
            
            if (eax_49 == data_1150b8c || eax_49 == 0)
                var_28_1 = 0.00039999999f
    else if ((0x8000 & GetKeyState(0xa1)) != 0 && *(data_aca1f0 + 0x18) != 0)
        HWND eax_46 = GetFocus()
        
        if (eax_46 == data_1150b8c || eax_46 == 0)
            goto label_548cdf
    
    int16_t eax_50 = GetKeyState(0xa0)
    HWND eax_52
    
    if ((0x8000 & eax_50) != 0 && *(data_aca1f0 + 0x18) != 0)
        eax_52 = GetFocus()
    
    if ((0x8000 & eax_50) != 0 && *(data_aca1f0 + 0x18) != 0 && (eax_52 == data_1150b8c || eax_52 == 0))
        var_28_1 = var_28_1 * 10f
    else if ((0x8000 & GetKeyState(0xa1)) != 0 && *(data_aca1f0 + 0x18) != 0)
        HWND eax_55 = GetFocus()
        
        if (eax_55 == data_1150b8c || eax_55 == 0)
            var_28_1 = var_28_1 * 10f
    
    if ((0x8000 & GetKeyState(0x11)) != 0 && *(data_aca1f0 + 0x18) != 0)
        HWND eax_58 = GetFocus()
        
        if (eax_58 == data_1150b8c || eax_58 == 0)
            var_28_1 = var_28_1 * 0.100000001f
    
    float var_24_2 = 0f
    
    if ((0x8000 & GetKeyState(0x28)) != 0 && *(data_aca1f0 + 0x18) != 0)
        HWND eax_61 = GetFocus()
        
        if (eax_61 == data_1150b8c || eax_61 == 0)
            var_24_2 = -1f
    
    HWND eax_62
    float xmm0_64
    
    if ((0x8000 & GetKeyState(0x26).w) == 0 || data_aca1f0->__offset(0x18).b == 0)
        xmm0_64 = var_24_2
    else
        eax_62 = GetFocus()
        
        if (eax_62 == data_1150b8c || eax_62 == 0)
            xmm0_64 = var_24_2 + 1f
        else
            xmm0_64 = var_24_2
    ...
    if (not(p_1))
        ...
        float xmm0_67 = sub_41f120(xmm0_66)
        float xmm0_68 = xmm0_67 * 0f
        float xmm0_70 = sub_41f100(xmm0_66)
        ebx_1 = arg4
        float xmm6_1 = *ebx_1
    ...
    if ((0x8000 & GetKeyState(0x25)) != 0 && *(data_aca1f0 + 0x18) != 0)
        HWND eax_65 = GetFocus()
        
        if (eax_65 == data_1150b8c || eax_65 == 0)
            var_24_4 = 1f
    
    HWND result
    float xmm0_79
    
    if ((0x8000 & GetKeyState(0x27).w) == 0 || data_aca1f0->__offset(0x18).b == 0)
        xmm0_79 = var_24_4
    else
        result = GetFocus()
    ...
    if (p_3)
        ...
        float xmm0_82 = sub_41f120(xmm0_81)
        float xmm0_83 = xmm0_82 * 0f
        float xmm0_85
        result, xmm0_85 = sub_41f100(xmm0_81)
        float xmm7_3 = *ebx_1

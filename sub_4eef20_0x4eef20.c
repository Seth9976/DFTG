...
int32_t __convention("regparm")sub_4eef20(int32_t arg1, float* arg2, int128_t* arg3, uint64_t (* arg4)[0x2] @ edi, float arg5 @ xmm3, float* arg6)
{
    ...
    long double st0
    st0, x87control_1 = sub_588f50(mxcsr, x87control, xmm2_1 * xmm1 + xmm0_3, &var_c0, arg4)
    float var_c4 = fconvert.s(st0)
    int16_t x87control_2
    long double st0_1
    st0_1, x87control_2 = sub_588f50(mxcsr, x87control_1, xmm3_3, &var_c0)
    ...
    sub_41da40(&var_74, &var_b0, &var_100, &var_74)
    int32_t result
    int32_t result_1 = result
    var_b0 = var_100
    float var_a0_1[0x4] = xmm3_4
    sub_41da40(&var_50, &var_b0, &var_100, &var_50)
    *arg3 = var_100
    arg3[1] = xmm3_4
    arg3[2].d = result

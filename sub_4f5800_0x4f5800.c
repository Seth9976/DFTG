...
uint32_t (* __fastcallsub_4f5800(void* arg1))[0x4]
{
    ...
    if (*(arg1 + 8) s> 0)
        ...
        while (true)
            ...
            sub_489550(eax_2, &data_5b2591, ecx_5, "d:\ax\trunk\ax2017\engine\attribmapregistry.cpp", 
                var_24_6, "AttribTableInit")
    ...
    uint32_t (* eax_5)[0x4] = sub_4c2e40(esi_3)

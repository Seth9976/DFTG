...
int32_t* __convention("regparm")sub_53e8e0(int32_t arg1, int32_t arg2, int32_t* arg3, int32_t* arg4, int32_t arg5)
{
    ...
    if (i_1 + ecx_2 s> i)
        ...
        do
            ...
            uint32_t eax_7 = sub_53e800(eax_6, i_2, ecx_2, eax_6, i_1)
    ...
    if (arg3[4] == 1)
        ...
        do
            ...
            uint32_t eax_22 = sub_53e800(&var_2c, i_4, i_4, j, i_1)

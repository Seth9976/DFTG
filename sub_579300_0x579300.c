...
char*sub_579300(char* arg1, char* arg2, void* arg3)
{
    ...
    label_5797fb:
        ...
        if (count u>= 0x80)
            ...
            if (((edi ^ esi) & 0xf) == 0 && test_bit(data_61f080, 1))
                void* eax_16 = esi & 0xf
            ...
            if (not(test_bit(data_6cf688, 0)) || (edi & 3) != 0)
                goto label_579527
            ...
            switch (count)
                ...
                case 3
                    goto label_57959c
        else if (test_bit(data_61f080, 1))
        label_5797cd:

...
floatsub_496b80(int64_t arg1, float arg2, int64_t arg3, float arg4, int64_t arg5, float arg6, int64_t arg7, float arg8, int32_t* arg9, int64_t* arg10, int32_t arg11, int32_t arg12, int32_t arg13, int32_t arg14, int32_t arg15, int32_t arg16)
{
    ...
    float xmm1_7 = arg7.d
    float xmm1_11 = 1f / (sub_41dbe0(xmm7 * xmm7 + xmm1_7 * xmm1_7 + arg8 * arg8) + 9.99999975e-06f)
    ...
    float xmm1_16 =
        1f / (sub_41dbe0(xmm0_24 * xmm0_24 + xmm1_12 * xmm1_12 + var_48_1 * var_48_1) + 9.99999975e-06f)
    var_98 = var_50_1.d * xmm1_16
    float xmm0_33 = var_50_1:4.d * xmm1_16
    float xmm0_35 = var_48_1 * xmm1_16
    int32_t eax_8
    int32_t edx
    eax_8, edx = sub_4eaaa0(5)
    var_50_1.d = eax_8
    int32_t* eax_9 = *arg9
    var_50_1:4.d = edx
    ...
    float xmm1_18 = ecx_3[3] f* ecx_3[2]
    int32_t eax_13 = ecx_3[1]
    int64_t var_30
    var_30.o = _mm_cvtpd_ps(float.d(eax_11) f+ *((eax_11 u>> 0x1f << 3) + &data_60cbc0)) * xmm1_18
    float xmm1_19[0x4] = arg13
    int64_t var_40
    var_40.o = _mm_cvtpd_ps(float.d(eax_13) f+ *((eax_13 u>> 0x1f << 3) + &data_60cbc0)) * xmm1_18
    float xmm0_44[0x4] = var_50_1.d
    float xmm6_2[0x4] = _mm_unpacklo_ps(xmm1_19, xmm1_19)
    ...
    int64_t xmm1_22 = _mm_unpacklo_ps(xmm5_6, _mm_unpackhi_ps(xmm4_7, xmm4_7))
    float xmm6_5[0x4] = _mm_unpacklo_ps(xmm6_4, xmm4_7[0].q)
    float xmm0_51[0x4] = arg11
    float xmm7_5[0x4] = __shufps_xmmps_memps_immb(xmm7_4, xmm7_4, 0xe5)
    float xmm6_6[0x4] = _mm_unpacklo_ps(xmm6_5, xmm1_22)
    float xmm1_23[0x4] = var_30.o
    float xmm0_52[0x4] = _mm_shuffle_ps(xmm0_51, xmm0_51, 0)
    float xmm1_25[0x4] = _mm_mul_ps(_mm_shuffle_ps(xmm1_23, xmm1_23, 0), xmm0_52)
    float xmm4_8[0x4] = xmm7_4[0]
    float xmm3_9[0x4] = _mm_unpackhi_ps(xmm7_5, xmm7_5)
    float xmm6_7[0x4] = _mm_mul_ps(xmm6_6, xmm1_25)
    float xmm0_54[0x4] = _mm_shuffle_ps(xmm6_7, xmm6_7, 0xe5)
    float xmm1_27[0x4] = _mm_unpackhi_ps(xmm0_54, xmm0_54)
    var_30.o = xmm0_54
    float xmm0_56 = _mm_unpackhi_ps(xmm1_27, xmm1_27)
    int64_t xmm0_58 = _mm_unpackhi_ps(xmm3_9, xmm3_9)
    var_50_1.o = xmm1_27
    int64_t xmm0_59 = xmm3_9[0].q
    int64_t xmm1_29 = _mm_unpacklo_ps(xmm7_5, xmm0_58)
    float xmm4_10[0x4] = _mm_unpacklo_ps(_mm_unpacklo_ps(xmm4_8, xmm0_59), xmm1_29)
    float xmm1_30[0x4] = var_40.o
    ...
    float xmm4_11[0x4] = _mm_mul_ps(xmm4_10, _mm_mul_ps(_mm_shuffle_ps(xmm1_30, xmm1_30, 0), xmm0_61))
    float xmm1_34 = xmm4_11[0] * xmm0_33
    float xmm5_8[0x4] = _mm_shuffle_ps(xmm4_11, xmm4_11, 0xe5)
    int32_t xmm7_7[0x4] = _mm_unpackhi_ps(xmm5_8, xmm5_8)
    float xmm1_35 = xmm5_8[0]
    float xmm0_63 = _mm_unpackhi_ps(xmm7_7, xmm7_7)
    float xmm4_13 = var_30.d
    float xmm0_67 = xmm5_8[0] * var_98
    *arg10 = _mm_unpacklo_ps((xmm3_11 + xmm4_11[0] * var_98) * 0.00999999978f f+ arg1.d, 
        (xmm2_10 + xmm1_34) * 0.00999999978f f+ arg1:4.d)
    float xmm1_38 = xmm7_7[0] f* xmm0_33
    float xmm6_12 = var_50_1.d
    arg10[1].d = (xmm6_7 f* xmm0_23 + xmm4_11 f* xmm0_35) * 0.00999999978f + arg2
    float xmm0_69 = xmm7_7[0] f* var_98
    *(arg10 + 0xc) = _mm_unpacklo_ps((xmm4_13 * xmm0_19 + xmm0_67) * 0.00999999978f f+ arg1.d, 
        (xmm4_13 * xmm0_21 + xmm1_35 * xmm0_33) * 0.00999999978f f+ arg1:4.d)
    *(arg10 + 0x14) = (xmm4_13 * xmm0_23 + xmm5_8 f* xmm0_35) * 0.00999999978f + arg2
    arg10[3] = _mm_unpacklo_ps((xmm0_19 * xmm6_12 + xmm0_69) * 0.00999999978f f+ arg1.d, 
        (xmm0_21 * xmm6_12 + xmm1_38) * 0.00999999978f f+ arg1:4.d)
    arg10[4].d = (xmm0_23 * xmm6_12 + xmm7_7 f* xmm0_35) * 0.00999999978f + arg2

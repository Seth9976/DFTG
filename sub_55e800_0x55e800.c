...
int32_t __fastcallsub_55e800(void* arg1, long double arg2 @ st0, long double arg3 @ st1, long double arg4 @ st2)
{
    // 第一条实际指令: void* var_20 = arg1
    void* var_20 = arg1
    float xmm1 = *(arg1 + 0x38)
    int32_t eax_1 = (&data_6cedac)[*(arg1 + 0x50) * 2]
    int32_t eax_2
    eax_2.b = xmm1 > 1f
    long double x87_r0
    ...
    float xmm0_3 = sub_4369e0(fconvert.s(x87_r0))
    float xmm2 = *(arg1 + 0x3c)
    int32_t ecx_1 = (&data_6cedac)[*(arg1 + 0x54) * 2]
    ...
    int32_t ecx_2
    float xmm0_6
    ecx_2, xmm0_6 = sub_4369e0(fconvert.s(x87_r1))
    ...
    if (eax_8 == 0)
        ...
        (&data_6cedac)[*(arg1 + 0x50) * 2](xmm1_1)
        int32_t eax_12
        int32_t edx_1
        edx_1:eax_12 = sx.q(int.d(sub_4369e0(fconvert.s(arg4 * fconvert.t(2f) / fconvert.t(xmm1_1)))))
    ...
    *(arg1 + 0x98) = ecx_3
    ...
    if (eax_15 == 0)
        ...
        (&data_6cedac)[*(arg1 + 0x54) * 2](xmm1_2)
        ...
        float xmm0_10 = sub_4369e0(var_c_5)
        ecx_3 = *(arg1 + 0x98)
        int32_t eax_20
        int32_t edx_2
    ...
    *(arg1 + 0xc4) = *(arg1 + 0x9c) << 3
    ...
    (&data_6cedac)[*(arg1 + 0x54) * 2](var_20_13)
    unimplemented  {fmul st0, dword [0x60c4b8]}
    float var_8_8 = fconvert.s(unimplemented  {fstp dword [ebp-0x4], st0})
    unimplemented  {fstp dword [ebp-0x4], st0}
    float xmm0_16 = sub_4369e0(var_8_8)

...
char* __convention("regparm")sub_595f48(int32_t arg1, int32_t arg2, int32_t arg3, char* arg4, int32_t arg5, int32_t arg6, char arg7)
{
    ...
    *(arg4 + 0x10) = 0x80
    ...
    if ((0x100 & arg5) != 0 && ((not.d(data_6cfe28)).b & arg7) s>= 0)
        *(arg4 + 0x10) = 1

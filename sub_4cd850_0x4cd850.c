...
float* __convention("regparm")sub_4cd850(int32_t arg1, int32_t* arg2, float* arg3, float* arg4, int128_t* arg5, float* arg6)
{
    ...
    if (p_1 || p_3)
        ...
        if (xmm5_8 < xmm5_7 || xmm1_7 < xmm6_6)
            sub_489550(eax_4, &data_5b2591, "RectIsNormalized(r)", 
        ...
        *arg4 = xmm5_7
        ...
        if (p_5)
            ...
            *(arg4 + 0x2c) = xmm3_9.o
            arg4[0xf] = (*arg2 - *arg3) / xmm7_4
            arg4[0x11] = (arg2[2] f- arg3[2]) / xmm7_4
            arg4[0x10] = (arg2[1] f- arg3[1]) / xmm7_4
            arg4[0x12] = (arg2[3] f- arg3[3]) / xmm7_4
        else

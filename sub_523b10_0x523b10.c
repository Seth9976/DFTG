...
char* __fastcallsub_523b10(int32_t* arg1, int32_t* arg2)
{
    ...
    label_523ba4:
        ...
        if (edx_1 == eax)
        label_523c01:
            int32_t i_1 = sub_523550(edi, edx_1)
            void* ecx_3 = sub_5234e0(edx, arg1[4])
            eax_5 = arg1
            void* var_30 = ecx_3
            
            if (eax_5[3] == ecx_3 && arg2[3] == ecx_3)
                return sub_579300(*arg2, *eax_5, ecx_3 * i_1)
        ...
        label_523bb8:
            ...
            if (eax s< 0xd || (eax s> 0x12 && eax != 0x15))
                int32_t eax_7 = sub_5233d0(edx_1)
                eax_5 = sub_5233d0(arg2[4])
                int32_t ecx_7 = 0
                int32_t var_20_1 = 0
                ...
                do
                    ...
                    if (edx_5 s> 0)
                        ...
                        do
                            char* eax_9 = sub_523670(esi_1, eax_8[4])
                            sub_5238f0(eax_9, arg2[4], edi_1, eax_9)
                            edi_1 += eax_5
                            esi_1 = &esi_1[eax_7]
        ...
        var_44_1 = 0x1b7
        ecx = "!TextureFormatIsCompressed(pDestSpec->format)"
    sub_489550(eax, &data_5b2591, ecx, "d:\ax\trunk\ax2017\engine\imageutils.cpp", var_44_1, 

...
uint32_t __convention("regparm")sub_4c67f0(int32_t arg1, void* arg2, char** arg3, int32_t arg4, void* arg5)
{
        ...
        while (true)
            ...
            if (edi_3 == 0xf)
                ...
                *(esp_1 - 4) = arg5
                ...
                result = sub_4c6300(eax_3, edx_3, ecx_5)
                goto label_4c69df
            
            result = sub_4ce0a0(ecx_3)
            ...
            if (edi_3 == 5)
                ...
                *(esp_1 - 8) = *(eax_4 + edi_4)
                *(esp_1 - 0xc) = arg4
                result = sub_4c6530(eax_4, esi_2, edi_4)
                edx = edi_4
                goto label_4c69e3
            ...
            if (edi_3 != 6)
                if (edi_3 == 8)
                    ...
                    *(esp_1 - 4) = arg5
                    *(esp_1 - 8) = esi_2
                    result = sub_4c63b0(result, edx_6, ecx_9)
                    esp_1 = esp_1
                    goto label_4c69df
                ...
                if (edi_3 == 0xb)
                    ...
                    *(esp_1 - 8) = ecx_10
                    *(esp_1 - 0xc) = 0
                    result = sub_4c6530(eax_6, esi_2, edi_6)
                    edx = edi_6
                    goto label_4c69e3
                ...
                if (edi_3 == 9)
                    ...
                    *(esp_1 - 4) = arg5
                    *(esp_1 - 8) = arg4
                    result = sub_4c6660(result, esi_2, ecx_12)
                    esp_1 = esp_1
                    goto label_4c69df
                ...
                if (edi_3 == 0xc)
                    ...
                    *(esp_1 - 4) = arg5
                    ...
                    sub_4c6300(eax_7, edx_9 + *arg5 + eax_7, ecx_13)
                ...
                label_4c6a2d:
                    *(esp_21 - 4) = "d:\ax\trunk\ax2017\engine\defbin.cpp"
                    sub_489550(result, &data_5b2591, ecx_17)
            ...
            *(esp_1 - 0xc) = esi_2
            *(arg5 + 4) = eax_5
            result = sub_4c63e0(eax_5, edx_5, ecx_8)
            *(arg5 + 4) = edi_5
        label_4c69df:
            edx = esp_1[3]
        label_4c69e3:

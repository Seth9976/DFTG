...
int32_t __convention("regparm")sub_5680d0(int32_t arg1, char* arg2, int32_t* arg3, int32_t arg4, void* arg5, void* arg6, int32_t arg7, int32_t arg8)
{
    ...
    if (arg8 == 0)
        int32_t result = sub_567210(arg2, arg2, esi, arg4, arg5, *ecx, ecx[1], arg6, arg7)
    ...
    do
        ...
        if (k_3 != 0)
            ...
            if (j_3 != 0)
                ...
                if (sub_567210(eax_24, var_90, esi, var_94, arg5, k_3, j_3, arg6, arg7) == 0)
                    _free(var_80)
                    @__security_check_cookie@4(eax_1 ^ &__saved_ebp)
                    return 0

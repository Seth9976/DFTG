...
void* __thiscallsub_51cd70(char* arg1, HWND arg2)
{
    ...
    int32_t var_130 = edi
    char* var_120 = arg1
    BOOL params_4 = sub_4892e0("OpenGLInterface::GraphicsInterfaceAttach")
    int32_t var_138
    char const* const ecx
    
    if (*(arg1 + 0x4250) == 0)
        int128_t xmm0_1 = data_5d2398
        *(arg1 + 0x425c) = 0
        arg1[0x4260] = 0
        *(arg1 + 0x4230) = xmm0_1
        ...
        int32_t ecx_1
        int32_t edi_3
        edi_3, ecx_1 = __memfill_u32(data_1151adc + 0x4028, 0xbaadf00d, 0x82)
        *(arg1 + 0xc) = arg2
        *(arg1 + 8) = GetDC(arg2)
        ...
        if (eax_7 != 0)
            sub_489550(eax_7, &data_5b2591, "initResult == GLEW_OK", 
                "d:\ax\trunk\ax2017\engine\openglgraphics.cpp", 0x435, "CreateDummyWindowToInitGlew")
        ...
        label_51d28b:
            sub_489550(format_1, &data_5b2591, ecx_2, "d:\ax\trunk\ax2017\engine\openglgraphics.cpp", 
        ...
        int32_t ecx_3 = *(data_aca1ec + 0x1c)
        ...
        if (params_4 != 0)
            ...
            if (params_4 == 0)
                ...
                if (_strstr(xmm0_4, eax_15, "Adreno (TM) 420") != 0)
                    void* eax_18 = data_aca1ec
                    data_115107d = 1
                    
                    if (*(eax_18 + 0x1c) s> 2)
                        sub_4892e0("Setting msaa to 2x for adreno")
                        *(data_aca1ec + 0x1c) = 2
                ...
                HDC hDC_1 = hDC
                sub_4892e0("GL version %s (%d.%d) %s (%d)")
                int32_t ecx_5
                ecx_5.b = *(data_aca1ec + 0x26) != 0
                (*__wglewSwapIntervalEXT)(ecx_5)
                void* result = data_aca1ec
    ...
    sub_489550(params_4, &data_5b2591, ecx, "d:\ax\trunk\ax2017\engine\openglgraphics.cpp", var_138, 

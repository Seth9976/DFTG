...
int32_t __fastcallsub_4fc8d0(int32_t* arg1, void** arg2)
{
    ...
    void var_2c
    int32_t xmm0_5[0x4] = sub_4fa6b0(&var_2c, arg1[4], arg1[3], arg1[1], &var_2c)
                        ...
                        if (eax_17 == 0)
                            ...
                            if (eax_19 == 0)
                                ...
                                if (eax_21 == 0)
                                    ...
                                    esi_2[4] = 6
                                    int32_t* eax_22
                                    eax_22, xmm0_5 = sub_4d0b50(eax_21 + 0xe, 0x19)
                                    esi_2[6] = eax_22
                            else
                                esi_2[4] = 5
                                int32_t* eax_20
                                eax_20, xmm0_5 = sub_4d0b50(eax_19 + 0xf, 0x19)
                                esi_2[6] = eax_20
                        else
                            esi_2[4] = 7
                            int32_t* eax_18
                            eax_18, xmm0_5 = sub_4d0b50(eax_17 + 0xe, 0x19)
                            esi_2[6] = eax_18
                    else
                        esi_2[4] = 3
                        int32_t* eax_16
                        eax_16, xmm0_5 = sub_4d0b50(eax_15 + 0xb, 0x15)
                        esi_2[6] = eax_16
                else
                    esi_2[4] = 2
                    int32_t* eax_14
                    eax_14, xmm0_5 = sub_4d0b50(eax_13 + 0xc, 0x15)
                    esi_2[6] = eax_14
            else
                esi_2[4] = 4
                int32_t* eax_12
                eax_12, xmm0_5 = sub_4d0b50(eax_11 + 0xb, 0x15)
                esi_2[6] = eax_12
        
        int32_t edx_2 = *(*(ebx_4 - 0x10) + 0xc)
        
        if (edx_2 != 0xffffffff)
            float var_5c
            sub_4fb640(&var_2c, edx_2, eax_2, &var_2c, &var_5c)
            float xmm2_1 = arg1[8]

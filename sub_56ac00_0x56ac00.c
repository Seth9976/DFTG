...
void* __convention("regparm")sub_56ac00(int32_t arg1, uint32_t* arg2, void* arg3, uint32_t* arg4, int32_t* arg5, int32_t* arg6)
{
    // 第一条实际指令: uint32_t eax = sub_561390(arg3)
    uint32_t eax = sub_561390(arg3)
    
    if (sub_561390(arg3) + (eax << 0x10) == 0x38425053 && sub_561390(arg3) == 1)
        ...
        uint32_t eax_7 = sub_561390(arg3)
        
        if (eax_7 u<= 0x10)
            uint32_t eax_8 = sub_561390(arg3)
            uint32_t eax_10 = sub_561390(arg3) + (eax_8 << 0x10)
            uint32_t ebx_3 = (sub_561390(arg3) << 0x10) + sub_561390(arg3)
            uint32_t eax_13 = sub_561390(arg3)
            
            if ((eax_13 == 8 || eax_13 == 0x10) && sub_561390(arg3) == 3)
                sub_5612a0(arg3, sub_561410(arg3))
                sub_5612a0(arg3, sub_561410(arg3))
                sub_5612a0(arg3, sub_561410(arg3))
                uint32_t eax_18 = sub_561390(arg3)
                                ...
                                label_56ad6f:
                                    ...
                                    if (result_2 != 0)
                                        if (eax_18 == 0)
                                            ...
                                            sub_5612a0(arg3, eax_10 * eax_7 * 2)
                                            ...
                                            do
                                                ...
                                                if (i_1 s< ecx_20)
                                                    if (sub_56aaa0(result_1, edx_11, arg3, ebx_4) == 0)
                                                        _free(result)
                                                        goto label_56ae04

...
bool __fastcallsub_4cfed0(int32_t* arg1)
{
    ...
    if (edx != 0)
                ...
                if (ecx != 0x71)
                    if (ecx != 0x73)
                        if (ecx == 0x43)
                            ...
                            if ((eax_1.b & ecx_6.b) != 0 && *(eax_8 + 0x27) != 0)
                                sub_4e8300()
                                edx = data_114e818
                            else if (var_8_1 != 0 && *(eax_8 + 0x27) != 0)
                        ...
                        PostMessageA(data_1150b8c, 0x10, 0, 0)
                        BOOL eax_7
                        eax_7.b = 1
                        return eax_7
                else if (ebx_2 == 0 && *(data_aca1ec + 0x27) != ebx_2.b)
        ...
        if (sub_4e4fe0(arg1) != 0)
            return 1
        
        char eax = (*(*data_aca1ec + 0x28))(arg1)
        
        if (eax != 0)
            return eax
        
        sub_4c4910(&data_12baa80, arg1)

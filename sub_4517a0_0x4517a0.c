...
int32_t* __convention("regparm")sub_4517a0(int32_t arg1, int32_t arg2, int32_t* arg3, int32_t* arg4, int32_t* arg5)
{
    ...
    if (arg2 u< 0xc0)
        int32_t* eax_3 = sub_450ff0(arg4, arg2, arg3, arg4, arg5)
    ...
    int32_t var_a0 = ebx
    int32_t var_b0 = ebx
    char* ecx_3 = &eax_7[arg2 u/ 0x60 * 0x18]
    ...
    void* ebx_11 = arg2 - ecx_3 + eax_7
    int32_t var_6c
    sub_579300(&var_6c, ecx_3, ebx_11)
    _memset(&var_6c + ebx_11, 0, 0x60 - ebx_11)
    char var_d = ebx_11.b
    int32_t var_64
    int32_t ebx_13 = var_b0 + var_64
    int32_t var_60
    int32_t esi_29 = adc.d(esi_1, var_60, var_b0 + var_64 u< var_b0)
    int32_t var_14
    int32_t ecx_15 = var_14 + ebx_13
    int32_t var_c0_2 = var_c0 + ecx_15
    int32_t var_10
    int32_t ecx_17 =
        adc.d(var_9c, adc.d(var_10, esi_29, var_14 + ebx_13 u< var_14), var_c0 + ecx_15 u< var_c0)
    int32_t var_5c
    ...
    int32_t ecx_22 = ebx_13 u>> 0x14 | esi_29 << 0xc
    int32_t ecx_23 = ecx_22 + edi_18
    int32_t ebx_16 = adc.d(ebx_13 << 0xc | esi_29 u>> 0x14, eax_83, ecx_22 + edi_18 u< ecx_22)
    int32_t var_4c
    int32_t ebx_19 = (var_4c + var_a0) ^ ecx_23
    int32_t var_48
    int32_t ecx_26 = adc.d(var_48, var_b4, var_4c + var_a0 u< var_4c) ^ ebx_16
    int32_t ebx_22 = edx_68 u>> 0x11 | esi_32 << 0xf
    int32_t var_90_4 = ebx_22 + ebx_19
    int32_t esi_38 = adc.d(edx_68 << 0xf | esi_32 u>> 0xffffffef, ecx_26, ebx_22 + ebx_19 u< ebx_22)
    int32_t var_44
    ...
    int32_t var_38
    int32_t ebx_28 = adc.d(var_38, var_80, var_3c + var_b8 u< var_3c) ^ var_7c_5
    int32_t var_80_4 = ecx_26 u>> 0xb | ebx_19 << 0x15
    int32_t ebx_32 = var_80_4 + eax_87
    int32_t edi_25 =
        adc.d(ecx_26 << 0x15 | ebx_19 u>> 0xfffffff5, ebx_28, var_80_4 + eax_87 u< var_80_4)
    int32_t var_34
    int32_t ecx_30 = (var_34 + var_94) ^ ebx_32
    int32_t var_30
    int32_t eax_90 = adc.d(var_30, var_98, var_34 + var_94 u< var_34) ^ edi_25
    int32_t ebx_33 = esi_41 u>> 0x1a | edx_72 << 6
    int32_t ebx_34 = ebx_33 + ecx_30
    int32_t edi_29 = adc.d(esi_41 << 6 | edx_72 u>> 0x1a, eax_90, ebx_33 + ecx_30 u< ebx_33)
    int32_t var_2c
    int32_t ebx_37 = (var_2c + var_bc) ^ ebx_34
    int32_t var_28
    int32_t edi_32 = adc.d(var_28, var_a4, var_2c + var_bc u< var_2c) ^ edi_29
    int32_t esi_44 = eax_87 u>> 0x1f | ebx_28 << 1
    int32_t ebx_40 = ebx_28 u>> 0x1f | (eax_87 * 2)
    int32_t esi_45 = esi_44 + ebx_37
    int32_t var_70_5 = ebx_40
    int32_t ebx_41 = adc.d(ebx_40, edi_32, esi_44 + ebx_37 u< esi_44)
    int32_t var_24
    int32_t esi_48 = (var_24 + var_ac) ^ esi_45
    int32_t var_20
    int32_t edx_78 = adc.d(var_20, var_84, var_24 + var_ac u< var_24) ^ ebx_41
    int32_t var_84_4 = eax_90 u>> 0x16 | ecx_30 << 0xa
    int32_t var_84_5 = var_84_4 + esi_48
    int32_t ebx_45 = adc.d(eax_90 << 0xa | ecx_30 u>> 0xffffffea, edx_78, var_84_4 + esi_48 u< var_84_4)
    int32_t var_1c
    int32_t ecx_34 = (var_1c + var_d0) ^ var_84_5
    int32_t var_18
    int32_t eax_94 = adc.d(var_18, var_8c, var_1c + var_d0 u< var_1c) ^ ebx_45
    int32_t var_98_4 = edi_32 u>> 0x13 | ebx_37 << 0xd
    int32_t edi_35 = var_98_4 + ecx_34
    int32_t ebx_51 = adc.d(edi_32 << 0xd | ebx_37 u>> 0xffffffed, eax_94, var_98_4 + ecx_34 u< var_98_4)
    int32_t var_c0_3 = var_c0_2 ^ edi_35
    int32_t var_9c_4 = ecx_17 ^ ebx_51
    ...
    int32_t var_80_6 = ebx_32 ^ eax_103
    ...
    int32_t var_c4_3 = ebx_34 ^ ecx_49
    ...
    int32_t var_70_7 = ebx_41 ^ ecx_53
    ...
    int32_t var_a0_4 = ebx_45 ^ eax_109
    ...
    int32_t ebx_52 = ebx_51 ^ ecx_61
    int32_t eax_113 = var_a4_4 u>> 0x1f | var_70_7 << 1
    int32_t eax_114 = eax_113 + var_98_6
    int32_t esi_74 = adc.d(var_70_7 u>> 0x1f | (var_a4_4 * 2), ebx_52, eax_113 + var_98_6 u< eax_113)
    ...
    int32_t ecx_70 = ebx_52 u>> 0x13 | var_98_6 << 0xd
    int32_t ecx_71 = ecx_70 + edx_102
    int32_t eax_118 =
        adc.d(ebx_52 << 0xd | var_98_6 u>> 0xffffffed, var_d0_2, ecx_70 + edx_102 u< ecx_70)
    ...
    int32_t ebx_59 = adc.d(var_ac_5 << 0xa | ecx_73 u>> 0x16, var_c8_5, edi_42 + var_9c_6 u< edi_42)
    int32_t var_78_8 = ecx_49 ^ edi_43
    int32_t var_90_7 = eax_105 ^ ebx_59
    ...
    int32_t ebx_63 = ecx_83 ^ adc.d(
        adc.d(var_98_8 << 0xd | var_a0_7 u>> 0xffffffed, edi_58, esi_86 + var_94_7 u< esi_86) ^ ebx_59, 
        edx_121 << 6 | esi_83 u>> 0x1a, esi_88 + eax_144 u< esi_88)
    arg4[1] = edi_62 << 0x16 | ebx_63 u>> 0xa
    *arg4 = edi_62 u>> 0xa | ebx_63 << 0x16
    int32_t eax_148 = var_94_7 u>> 0xb | edi_58 << 0x15
    int32_t eax_150 = (eax_148 + edi_62) ^ eax_128
    arg5[1] = adc.d(var_94_7 << 0x15 | edi_58 u>> 0xb, ebx_63, eax_148 + edi_62 u< eax_148) ^ ecx_87
    *arg5 = eax_150
    @__security_check_cookie@4(eax_1 ^ &__saved_ebp)
    return eax_150
}

...
int32_t __convention("regparm")sub_5603a0(int32_t arg1, int32_t* arg2, int32_t* arg3, int32_t* arg4, uint32_t* arg5, int32_t* arg6)
{
    ...
    *eax_1 = arg3
    ...
    eax_1[0x11f1].b = 0xff
    bool cond:0 = sub_5634c0(eax_1) == 0xd8
    arg3[0x2a] = arg3[0x2c]
    int32_t ebx
    ebx.b = cond:0
    arg3[0x2b] = arg3[0x2d]
    ...
    if (ebx != 0)
        ...
        *eax_5 = arg3
        int32_t eax_6
        int32_t ecx_4
        eax_6, ecx_4 = sub_565a50(eax_5)
        int32_t var_44_3 = ecx_4
        int32_t eax_7 = sub_565ad0(eax_6, arg2, eax_5, arg4, arg5)
        _free(eax_5)
        return eax_7
    
    int32_t eax_9 = sub_5671a0(arg3)
        ...
        if (edx_1.b != 0x42)
            ...
            label_56055a:
                ...
                if (ecx_7.b != 0x4d)
                    ...
                    sub_561430(arg3)
                    sub_561430(arg3)
                    uint32_t eax_19 = sub_561430(arg3)
                    uint32_t eax_22 = (sub_561430(arg3) << 0x10) + eax_19
    ...
    if (ecx_21 != 0)
        return sub_569330(eax_24, arg2, arg3, arg4, arg5)
    
    int32_t eax_26 = sub_56b860(arg3)
    arg3[0x2a] = arg3[0x2c]
    arg3[0x2b] = arg3[0x2d]
    
    if (eax_26 != 0)
        return sub_56c630(arg4, arg5)
    
    uint32_t eax_28 = sub_561390(arg3)
    uint32_t ecx_27 = sub_561390(arg3) + (eax_28 << 0x10)
    arg3[0x2a] = arg3[0x2c]
    ...
    if (ecx_27 == 0x38425053)
        ...
        return sub_56ac00(eax_31, arg2, arg3, arg4, arg5, arg6)
    
    int32_t ecx_31
    
    if (sub_56b090(arg3, 0x60b650) != 0)
        int32_t i_2 = 0x54
        int32_t i
        ...
        do
            ...
            i_2 -= 1
        while (i != 1)
        int32_t eax_36 = sub_56b090(arg3, "PICT")
    ...
    if (ecx_31 != 0)
        return sub_56b6d0(eax_38, arg2, arg3, arg4, arg5)
    ...
    if (ebx.b != 0x50 || (ecx_31.b != 0x35 && ecx_31.b != 0x36))
        arg3[0x2a] = arg3[0x2c]
        arg3[0x2b] = arg3[0x2d]
        int32_t eax_60 = sub_56c760(arg3)
        
        if (eax_60 == 0)
            int32_t eax_77 = sub_56a0c0(arg3)
            
            if (eax_77 == 0)
                return 0
            
            return sub_56a380(eax_77, arg2, arg3, arg4, arg5)
        
        int32_t* edi_3 = arg5
        float* eax_61 = sub_56ca10(eax_60, arg2, arg3, arg4, edi_3)
        int32_t ebx_4 = *edi_3
        int32_t ecx_49 = *arg4
        arg6 = eax_61
        ...
        if (eax_61 != 0)
                                        ...
                                        if (ecx_50 s> 0)
                                            ...
                                            do
                                                long double x87_r7_2 =
                                                    sub_41f0d0(*edi_5, 0x3ee8ba2e) * fconvert.t(255f)
            ...
            _free(arg6)
    else if (sub_56d310(eax_38, arg3, arg3, &arg3[1], &arg3[2]) != 0)
        *arg2 = *arg3
        *arg4 = arg3[1]
                        ...
                        if ((ebx_3 == 0 || arg3[2] s<= divs.dp.d(edx_14:eax_49, ebx_3)) && ecx_44 s>= 0
                            ...
                            if (esi_7 == 0 || ecx_44 s<= divs.dp.d(edx_16:eax_51, esi_7))
                                ...
                                if (eax_53 != 0)
                                    ...
                                    sub_5612f0(eax_56, eax_53, arg3, eax_56)
                                    return eax_53

...
char* __fastcallsub_5375e0(int32_t arg1, int32_t* arg2)
{
    ...
    int32_t var_44 = arg1
    char* result_3
    int32_t edx_1 = sub_537540(&result_3, &var_44)
    int32_t var_8_1 = 0
    ...
    sub_48d8d0(&result_1, edx_1, result_19, result_19, &data_5efc90)
    ...
    if (result == arg2[1])
        ...
        var_8_1.b = 2
        void* result_2
        int32_t edx_5 = sub_48a560(&result_3, sub_537540(&result_2, &var_44))
        var_8_1.b = 3
        ...
        if (data_aca1f4 != 0)
            ...
            if (result_5 != 0 && *result_5 != 0)
                ...
                *(eax_6 + 4) -= 1
                ...
                if (temp0_1 == 1)
                    edx_5 = sub_4984f0(eax_6, *(eax_6 + 0xc) + 0x10)
        ...
        *arg2 = 0
        sub_48d8d0(result_6, edx_5, result_20, result_20, &data_5efc90)
        result = *arg2
        ...
        uint32_t (* eax_8)[0x4] = sub_4c2e40(esi_1)
        _memset(eax_8, 0, esi_1)
        arg2[6] = eax_8
        var_8_1.b = 5
        sub_48a560(&result_3, sub_537540(&result_2, &var_44))
        var_8_1.b = 6
        ...
        if (data_aca1f4 != 0)
            ...
            if (result_7 != 0 && *result_7 != 0)
                char* eax_11 = sub_48a080(&result_2)
        ...
        if (*edi_2 s> 0)
            do
                var_8_1.b = 9
                char* const var_50
                sub_48a560(&result_3, sub_537540(&var_50, &var_44))
                var_8_1.b = 0xa
                ...
                var_8_1.b = 0xb
                char* const var_54
                sub_48a560(&result_3, sub_537540(&var_54, &var_44))
                var_8_1.b = 0xc
                ...
                *(edx_21 + 0x24) = 0x3f800000
                ...
                result = sub_48d8d0(&edx_21[1], edx_21, result_21, result_21, "%f %f %f")
                
                if (result != 3)
                    sub_489550(result, &data_5b2591, "count == 3", 
                        "d:\ax\trunk\ax2017\engine\animimport.cpp", 0x5a, "sAnimExtractDataFromText")
                ...
                if (result_10 s> 1)
                    do
                        int128_t* eax_25 = (i * result_10 + edx_22) * 0x2c + edi_2[6]
                        char* const var_58
                        int32_t* result_9 = sub_537540(&var_58, &var_44)
                        result_2 = result_9
                        var_8_1.b = 0xd
                        char* const result_24 = &data_5b2591
                        char* result_11 = result_3
                        char* const esi_4 = &data_5b2591
                        ...
                        if (result_24 != esi_4)
                            if (data_aca1f4 != 0 && result_11 != 0 && *result_11 != 0)
                                char* eax_26 = sub_48a080(&result_3)
                            ...
                            if (result_11 != 0 && *result_11 != 0)
                                char* eax_27 = sub_48a080(&result_3)
                                *(eax_27 + 4) += 1
                                result_11 = result_3
                        ...
                        result_2 = sub_48d8d0(eax_25 + 0x1c, result_22, eax_25, result_22, "%f %f %f")
                        char* const var_5c
                        int32_t* eax_34 = sub_537540(&var_5c, &var_44)
                        var_8_1.b = 0xf
                        ...
                        if (result_25 != esi_5)
                            if (data_aca1f4 != 0 && result_12 != 0 && *result_12 != 0)
                                char* eax_35 = sub_48a080(&result_3)
                                int32_t temp10_1 = *(eax_35 + 4)
                                *(eax_35 + 4) -= 1
                                
                                if (temp10_1 == 1)
                                    edx_32 = sub_4984f0(eax_35, *(eax_35 + 0xc) + 0x10)
                                    result_3 = &data_5b2591
                            ...
                            if (result_12 != 0 && *result_12 != 0)
                                char* eax_36 = sub_48a080(&result_3)
                                *(eax_36 + 4) += 1
                                result_12 = result_3
                        ...
                        if (data_aca1f4 != 0)
                            ...
                            if (eax_37 != 0 && *eax_37 != 0)
                                char* eax_38 = sub_48a080(&var_5c)
                                int32_t temp9_1 = *(eax_38 + 4)
                                *(eax_38 + 4) -= 1
                                
                                if (temp9_1 == 1)
                                    edx_32 = sub_4984f0(eax_38, *(eax_38 + 0xc) + 0x10)
                                    var_5c = &data_5b2591
                        ...
                        int32_t eax_39 = sub_48d8d0(result_16, edx_32, &var_38, result_16, "%f %f %f")
                        result_2 += eax_39
                        char* const var_60
                        int32_t* eax_40 = sub_537540(&var_60, &var_44)
                        var_8_1.b = 0x11
                        char* const result_26 = &data_5b2591
                        char* result_13 = result_3
                        char* const esi_6 = &data_5b2591
                        char* edx_39 = *eax_40
                        ...
                        if (result_26 != esi_6)
                            if (data_aca1f4 != 0 && result_13 != 0 && *result_13 != 0)
                                char* eax_41 = sub_48a080(&result_3)
                                int32_t temp12_1 = *(eax_41 + 4)
                                *(eax_41 + 4) -= 1
                                
                                if (temp12_1 == 1)
                                    edx_39 = sub_4984f0(eax_41, *(eax_41 + 0xc) + 0x10)
                                    result_3 = &data_5b2591
                            ...
                            if (result_13 != 0 && *result_13 != 0)
                                char* eax_42 = sub_48a080(&result_3)
                                *(eax_42 + 4) += 1
                                result_13 = result_3
                        ...
                        if (data_aca1f4 != 0)
                            ...
                            if (eax_43 != 0 && *eax_43 != 0)
                                char* eax_44 = sub_48a080(&var_60)
                                int32_t temp11_1 = *(eax_44 + 4)
                                *(eax_44 + 4) -= 1
                                
                                if (temp11_1 == 1)
                                    edx_39 = sub_4984f0(eax_44, *(eax_44 + 0xc) + 0x10)
                                    var_60 = &data_5b2591
                        ...
                        int32_t eax_45 = sub_48d8d0(result_17, edx_39, &var_2c, result_17, "%f %f %f")
                        result_2 += eax_45
                        char* const var_64
                        char** edx_45 = sub_537540(&var_64, &var_44)
                        var_8_1.b = 0x13
                        char* result_27 = &data_5b2591
                        char* result_14 = result_3
                        char* const esi_7 = &data_5b2591
                        char* edx_46 = *edx_45
                        ...
                        if (result_27 != esi_7)
                            if (data_aca1f4 != 0 && result_14 != 0 && *result_14 != 0)
                                char* eax_47 = sub_48a080(&result_3)
                                int32_t temp14_1 = *(eax_47 + 4)
                                *(eax_47 + 4) -= 1
                                
                                if (temp14_1 == 1)
                                    edx_46 = sub_4984f0(eax_47, *(eax_47 + 0xc) + 0x10)
                                    result_3 = &data_5b2591
                            ...
                            if (result_14 != 0 && *result_14 != 0)
                                char* eax_48 = sub_48a080(&result_3)
                                *(eax_48 + 4) += 1
                                result_14 = result_3
                        ...
                        if (data_aca1f4 != 0)
                            ...
                            if (eax_49 != 0 && *eax_49 != 0)
                                char* eax_50 = sub_48a080(&var_64)
                                int32_t temp13_1 = *(eax_50 + 4)
                                *(eax_50 + 4) -= 1
                                
                                if (temp13_1 == 1)
                                    edx_46 = sub_4984f0(eax_50, *(eax_50 + 0xc) + 0x10)
                                    var_64 = &data_5b2591
                        ...
                        int32_t eax_51
                        int32_t edx_51
                        eax_51, edx_51 = sub_48d8d0(result_18, edx_46, &var_20, result_18, "%f %f %f")
                        ...
                        var_28.o = xmm0_7.o
                        float var_ac[0x4]
                        *eax_25 = *sub_41dc00(&var_ac, edx_51, &var_38, &var_ac)
                        char* const var_68
                        char** eax_56 = sub_537540(&var_68, &var_44)
                        var_8_1.b = 0x15
                        char* result_28 = &data_5b2591
                        char* result_15 = result_3
                        char* esi_8 = &data_5b2591
                        char* edx_54 = *eax_56
                        ...
                        if (result_28 != esi_8)
                            if (data_aca1f4 != 0 && result_15 != 0 && *result_15 != 0)
                                char* eax_57 = sub_48a080(&result_3)
                            ...
                            if (result_15 != 0 && *result_15 != 0)
                                char* eax_58 = sub_48a080(&result_3)
                                *(eax_58 + 4) += 1
                                result_15 = result_3
                        ...
                        result = sub_48d8d0(&eax_25[1], result_23, eax_25, result_23, "%f %f %f")
                        
                        if (result_2 + result != 0xf)
                            sub_489550(result, &data_5b2591, "count == 15", 
                                "d:\ax\trunk\ax2017\engine\animimport.cpp", 0x7a, 

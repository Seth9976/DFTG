...
uint32_t __thiscallsub_53ab60(void* arg1, int32_t* arg2, int32_t arg3)
{
    // 第一条实际指令: int32_t var_8 = 0xffffffff
    int32_t var_8 = 0xffffffff
    int32_t (* var_c)(void* arg1) = sub_5a2db8
    TEB* fsbase
    ...
    int32_t* var_4c
    sub_4889e0(&var_4c, arg2, 4)
    int32_t var_8_1 = 0
    int32_t esi = SrcDataSize_1 + arg3 * 0x28
    void* eax_5 = *(esi + 8)
    uint32_t result
    
    if (eax_5 != 0)
        int32_t pSrcData = *(eax_5 + 0x28)
        SrcDataSize_1 = *(eax_5 + 0x20)
        uint32_t (* eax_8)[0x4] = sub_53e550(arg1 + 0x38)
        uint32_t (* esi_1)[0x4]
        ...
        if (arg3 == 0)
            ...
            *eax_8 = 3
            ...
            label_53aca2:
                ...
                HRESULT eax_17 = D3DReflect(pSrcData, SrcDataSize, &data_5a9270, &ppReflector)
                
                if (eax_17 s< 0)
                    sub_489550(eax_17, &data_5b2591, "SUCCEEDED(hr)", 
                        "d:\ax\trunk\ax2017\engine\windows\windowsdx11.cpp", 0x358, 
                ...
                if (var_104 != 0)
                    if (var_104 != 1)
                        sub_489550(var_104, &data_5b2591, "shaderDesc.ConstantBuffers == 1", 
                            "d:\ax\trunk\ax2017\engine\windows\windowsdx11.cpp", 0x361, 
                            "Dx11GraphicsInterface::CreateShaderBuffer")
                    ...
                    if (eax_20 s< 0)
                        sub_489550(eax_20, &data_5b2591, "SUCCEEDED(hr)", 
                            "d:\ax\trunk\ax2017\engine\windows\windowsdx11.cpp", 0x367, 
                            "Dx11GraphicsInterface::CreateShaderBuffer")
                ...
                *(esi + 0x18) = 0
                ...
                if (var_104 != 0)
                    if (var_104 != 1)
                        sub_489550(var_104, &data_5b2591, "shaderDesc.ConstantBuffers == 1", 
                            "d:\ax\trunk\ax2017\engine\windows\windowsdx11.cpp", 0x375, 
                            "Dx11GraphicsInterface::CreateShaderBuffer")
                    ...
                    if (eax_24 s< 0)
                        sub_489550(eax_24, &data_5b2591, "SUCCEEDED(hr)", 
                            "d:\ax\trunk\ax2017\engine\windows\windowsdx11.cpp", 0x37b, 
                            "Dx11GraphicsInterface::CreateShaderBuffer")
                    ...
                    if (var_20 u> 0)
                        do
                            ...
                            int32_t eax_27 = sub_4f10d0(&data_624734, var_78)
                            
                            if (eax_27 != 0xffffffff)
                                int32_t eax_28 = *(esi + 0x18)
                                
                                if (eax_28 s>= ebx_1)
                                    sub_489550(eax_28, &data_5b2591, 
                                        "constantTable->constantCount < maxConstants", 
                                        "d:\ax\trunk\ax2017\engine\windows\windowsdx11.cpp", 0x38b, 
                                        "Dx11GraphicsInterface::CreateShaderBuffer")
                                ...
                                int32_t* edx_4 = *(esi + 0x20) + eax_28 * 0xc
                                ...
                                *(esi + 0x18) += 1
                                ...
                                sub_4892e0("Dx11 Unknown shader constant '%s'")
                ...
                if (var_100 s> 0)
                    do
                        ...
                        if (eax_34 s< 0)
                            sub_489550(eax_34, &data_5b2591, "SUCCEEDED(hr)", 
                                "d:\ax\trunk\ax2017\engine\windows\windowsdx11.cpp", 0x39c, 
                                "Dx11GraphicsInterface::CreateShaderBuffer")
                        ...
                        if (var_30 == 2)
                            int32_t eax_35 = sub_4f10d0(&data_624734, var_34)
                            
                            if (eax_35 != 0xffffffff)
                                if (*(sub_4f0fd0(&data_624734, eax_35) + 0x10) == 0xf)
                                    int32_t eax_37 = *(esi + 0x18)
                                    
                                    if (eax_37 s>= var_40_1)
                                        sub_489550(eax_37, &data_5b2591, 
                                            "constantTable->constantCount < maxConstants", 
                                            "d:\ax\trunk\ax2017\engine\windows\windowsdx11.cpp", 0x3ae, 
                                            "Dx11GraphicsInterface::CreateShaderBuffer")
                                    ...
                                    *(esi + 0x18) += 1
                                    ...
                                    sub_4892e0("Dx11 shader variable '%s' isn't a texture")
                            else
                                char* var_124_13 = var_34
                                sub_4892e0("Dx11 Unknown texture '%s'")
                        
                        edi_4 += 1
                    while (edi_4 s< var_100)
                
                if (*(esi + 0x18) == 0)
                    int32_t eax_40 = *(esi + 0x20)
                ...
                if (SrcDataSize_3 s<= 0)
                    ...
                    if (eax_44 s< 0)
                        sub_489550(eax_44, &data_5b2591, "SUCCEEDED(hr)", 
                            "d:\ax\trunk\ax2017\engine\windows\windowsdx11.cpp", 0x3d0, 
                            "Dx11GraphicsInterface::CreateShaderBuffer")
                ...
                sub_4892e0("failed to load vertex shader %s")
                esi_1 = eax_8
        else
            if (arg3 != 1)
                sub_489550(eax_8, &data_5b2591, "Halt", 
                    "d:\ax\trunk\ax2017\engine\windows\windowsdx11.cpp", 0x353, 
                    "Dx11GraphicsInterface::CreateShaderBuffer")
            ...
            *eax_8 = 4
            ...
            sub_4892e0("failed to load pixel shader %s")
            esi_1 = eax_8

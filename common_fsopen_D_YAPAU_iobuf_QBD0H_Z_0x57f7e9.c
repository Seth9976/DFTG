...
int32_t??$common_fsopen@D@@YAPAU_iobuf@@QBD0H@Z(char* arg1, char* arg2, int32_t arg3)
{
    ...
    int32_t var_8 = 0x61bc48
    int32_t (* var_10)(int32_t* arg1, void* arg2, void* arg3) = __except_handler4
    TEB* fsbase
    struct _EXCEPTION_REGISTRATION_RECORD* ExceptionList = fsbase->NtTib.ExceptionList
    uint32_t __security_cookie_1 = __security_cookie
    int32_t var_8_3 = 0x61bc48 ^ __security_cookie_1
    int32_t __saved_ebp
    int32_t var_34 = __security_cookie_1 ^ &__saved_ebp
    int32_t* var_1c = &var_34
    void* const var_38_2 = &data_57f7f5
    ...
    fsbase->NtTib.ExceptionList = ExceptionList
    void* const __saved_ebp_2 = &data_57f87b
    return result
}

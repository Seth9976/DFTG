...
int32_t__read_nolock(int32_t arg1, wchar16* arg2, uint32_t arg3)
{
    ...
    if (arg1 != 0xfffffffe)
        ...
        if (arg1 s>= 0 && arg1 u< data_6cfd08)
            ...
            eax_5 = (&data_6cfb08)[ecx_2]
            var_24_1 = 1
            edx = *(eax_5 + edi_1 + 0x28)
        
        if (arg1 s< 0 || arg1 u>= data_6cfd08 || (1 & edx) == 0)
            *___doserrno() = 0
            *__errno() = 9
        else
                    ...
                    label_58ffac:
                        ...
                        if ((*(edi_1 + eax_5 + 0x28) & 0x48) != 0)
                            ...
                            if (eax_5.b != 0xa && nNumberOfBytesToRead_1 != 0)
                                ...
                                *(edi_1 + (&data_6cfb08)[ecx_2] + 0x2a) = 0xa
                                ebx_2 = arg1
                                
                                if (var_5_1 != 0)
                                    int32_t eax_22
                                    eax_22.b = *(edi_1 + (&data_6cfb08)[ecx_2] + 0x2b)
                                    ebx_2 = arg1
                                    ...
                                    if (eax_22.b != 0xa && nNumberOfBytesToRead_1 != 1)
                                        ...
                                        *(edi_1 + (&data_6cfb08)[ecx_2] + 0x2b) = 0xa
                                        ebx_2 = arg1
                                        
                                        if (var_5_1 == 1)
                                            int32_t eax_26
                                            eax_26.b = *(edi_1 + (&data_6cfb08)[ecx_2] + 0x2c)
                                            ebx_2 = arg1
                                            ...
                                            if (eax_26.b != 0xa && nNumberOfBytesToRead_1 != 2)
                                                ...
                                                edi_3 = 3
                                                *(edi_1 + (&data_6cfb08)[ecx_2] + 0x2c) = 0xa
                        
                        int32_t eax_29 = __isatty(ebx_2)
                        BOOL eax_32
                        enum CONSOLE_MODE mode
                        
                        if (eax_29 != 0 && *(edi_1 + (&data_6cfb08)[ecx_2] + 0x28) s< 0)
                            eax_32 = GetConsoleMode(var_1c_1, &mode)
                        uint32_t var_20
                        uint32_t ecx_13
                        
                        if (eax_29 == 0 || *(edi_1 + (&data_6cfb08)[ecx_2] + 0x28) s>= 0 || eax_32 == 0)
                            var_24_1 = 0
                        label_59010e:
                            BOOL eax_40 =
                            ...
                            label_590130:
                                ...
                                if (*(edi_1 + (&data_6cfb08)[ecx_2] + 0x28) s< 0)
                                    int32_t result_1
                    ...
                    label_58fef6:
                        ...
                        *__errno() = 0x16
                        ...
                        if (lpBuffer_2 != 0)
                            ...
                            int32_t ecx_4 = (&data_6cfb08)[ecx_2]

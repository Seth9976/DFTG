...
int128_t* __convention("regparm")sub_540820(int32_t arg1, int32_t arg2, int32_t* arg3, int128_t* arg4, int32_t arg5, int32_t* arg6)
{
    // 第一条实际指令: if (arg3[1] != 0x12)
    if (arg3[1] != 0x12)
        sub_489550(arg1, &data_5b2591, "assetPtr->assetType == ASSET_TYPE_FONT", 
    ...
    void* eax = sub_4981f0(arg3)
    int64_t var_2c
    __builtin_memset(&var_2c, 0, 0x1c)
    void* edx_1 = *(eax + 0x18) + arg2 * 0x30
    int32_t ecx_2 = arg5 * 9
    void* var_50 = edx_1
    int32_t eax_2 = *(edx_1 + 0x20)
    float xmm0 = *(eax_2 + (ecx_2 << 2) + 0x10)
    ...
    sub_541410(&var_70, arg3, arg6, arg2, &var_70, 1)
    sub_53fda0(&var_50)

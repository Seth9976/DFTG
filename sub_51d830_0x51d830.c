...
uint32_t __thiscallsub_51d830(void* arg1, uint32_t arg2, uint32_t arg3, int32_t arg4)
{
    // 第一条实际指令: uint32_t (* eax)[0x4] = sub_523220(arg1 + 0x4240)
    uint32_t (* eax)[0x4] = sub_523220(arg1 + 0x4240)
    int32_t params
        ...
        if (width s<= edx && height s<= edx)
            ...
            if (params_2 != 6)
                if (params_2 == 5)
                    ...
                    label_51dc37:
                        sub_489550(eax_13, &data_5b2591, ecx_2, 
                            "d:\ax\trunk\ax2017\engine\openglgraphics.cpp", var_18_3, 
                    ...
                    (*__glewGenRenderbuffers)(1, &(*eax)[0x39])
                    (*__glewBindRenderbuffer)(0x8d41, (*eax)[0x39])
                    (*__glewRenderbufferStorageMultisample)(0x8d41, *(data_aca1ec + 0x1c), 0x8058, 
                        width, height)
                ...
                *eax = textures_1
                ...
                if (params_2 != 1)
                    sub_51c7f0(textures_1, 0)
                    target = 0xde1
                else
                    sub_51c870(textures_1, 0)
                    target = 0x8513
                ...
                if (params_1 != 0 && params_1 != 1)
                    if (params_1 != 3)
                        sub_489550(params_1, &data_5b2591, "Halt", 
                            "d:\ax\trunk\ax2017\engine\openglgraphics.cpp", 0x6cc, 
                            "OpenGLInterface::CreateTextureBuffer")
                    ...
                    sub_489550(eax_30, &data_5b2591, "status == GL_FRAMEBUFFER_COMPLETE", 
                        "d:\ax\trunk\ax2017\engine\openglgraphics.cpp", 0x6c5, 
                        "OpenGLInterface::CreateTextureBuffer")
                ...
                if (*(eax_6 + 0x1c) s<= 0)
                    sub_489550(eax_6, &data_5b2591, "gAppInterface->mMultisamples > 0", 
                        "d:\ax\trunk\ax2017\engine\openglgraphics.cpp", 0x63a, 
                        "OpenGLInterface::CreateTextureBuffer")
                ...
                (*__glewGenRenderbuffers)(1, &(*eax)[0x39])
                (*__glewBindRenderbuffer)(0x8d41, (*eax)[0x39])
                (*__glewRenderbufferStorageMultisample)(0x8d41, *(data_aca1ec + 0x1c), 0x81a5, width, 
                    height)
                (*__glewBindRenderbuffer)(0x8d41, 0)

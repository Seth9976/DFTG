...
int32_t __stdcallsub_5219f0(int32_t arg1)
{
    // 第一条实际指令: float red_1
    float red_1
    ...
    if (data_114e7d9 != 0)
        sub_489550(eax_1, &data_5b2591, "!gDraw3DData.submittingRenderItems", 
            "d:\ax\trunk\ax2017\engine\openglgraphics.cpp", 0x1338, 

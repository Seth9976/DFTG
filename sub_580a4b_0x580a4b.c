...
void*sub_580a4b(int32_t* arg1, int32_t* arg2, int32_t* arg3)
{
    // 第一条实际指令: int32_t edi
    int32_t edi
    int32_t var_30 = edi
    ...
    if (i == 0x49 || i == 0x69)
        ...
        return sub_580f6a(&i_3, arg2)
    
    if (i == 0x4e || i == 0x6e)
        int32_t var_38_6 = eax_3
        int32_t var_3c_1 = var_1c
        return sub_581148(&i_3, arg2)

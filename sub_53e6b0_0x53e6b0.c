...
int32_t __convention("regparm")sub_53e6b0(int32_t arg1, int32_t arg2, int32_t* arg3, void* arg4)
{
    // 第一条实际指令: int32_t xmm2[0x4] = data_60c870
    int32_t xmm2[0x4] = data_60c870
    int32_t xmm4[0x4] = data_60c8f0
    int32_t i = 0
    uint128_t xmm3 = 3
    void* ecx = arg4 + 0xc

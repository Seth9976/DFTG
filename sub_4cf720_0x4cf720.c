...
char* __fastcallsub_4cf720(char* arg1)
{
    // 第一条实际指令: int32_t var_8 = 0xffffffff
    int32_t var_8 = 0xffffffff
    int32_t (* var_c)(void* arg1) = sub_59fd08
    TEB* fsbase
    ...
    if (*edi_1 != 0)
        char* const lpFileName_4 = &data_5b2591
        
        do
            void* eax_6 = edi_1 - esi
            
            if (eax_6 s<= 0)
                sub_489550(eax_6, &data_5b2591, "len > 0", "d:\ax\trunk\ax2017\engine\definition.cpp", 
                    0x45b, "MakeDirectoriesInFullPath")
            ...
            char* const lpFileName_2 = &data_5b2591
            int32_t var_8_1 = 0
            sub_48a6e0(&lpFileName_2, esi, eax_6)
            ...
            if (GetFileAttributesA(lpFileName) == 0xffffffff)
                ...
                if (__mkdir(lpFileName_3) == 0xffffffff)
                    ...
                    eax_4 = sub_4892e0("Failed to create directory '%s'")
                    int32_t var_8_5 = 2
                    
                    if (data_aca1f4 != 0 && lpFileName_1 != 0 && *lpFileName_1 != 0)
                        eax_4 = sub_48a080(&lpFileName_2)
                        int32_t temp1_1 = *(eax_4 + 4)
                        *(eax_4 + 4) -= 1
                        
                        if (temp1_1 == 1)
                            int32_t eax_10 = sub_4984f0(eax_4, *(eax_4 + 0xc) + 0x10)
                            fsbase->NtTib.ExceptionList = ExceptionList
                            return eax_10
            ...
            if (data_aca1f4 != 0 && lpFileName_1 != 0 && *lpFileName_1 != 0)
                char* eax_9 = sub_48a080(&lpFileName_2)

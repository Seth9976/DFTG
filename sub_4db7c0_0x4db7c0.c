...
int32_t* __convention("regparm")sub_4db7c0(int32_t arg1, int32_t* arg2, int32_t* arg3, int32_t* arg4)
{
    ...
    if ((eax.b & 3) != 0)
        ...
        if (not(sub_426e40(xmm3_1) f<= 9.99999975e-06f))
            float xmm2_1
    ...
    if ((eax.b & 0xc) != 0)
        ...
        if (not(sub_426e40(xmm3_2) f<= 9.99999975e-06f))
            float xmm2_4
    ...
    if ((eax.b & 0x30) != 0)
        ...
        if (not(sub_426e40(xmm2_7) f<= 9.99999975e-06f))
            if ((eax.b & 0x20) == 0)
                xmm1 = arg2[2]

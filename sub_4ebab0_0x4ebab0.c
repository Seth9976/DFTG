...
int32_t* __fastcallsub_4ebab0(int32_t* arg1)
{
    ...
    if (ecx != 0)
        ...
        if (result_3[2] s> 0)
            ...
            do
                ...
                uint32_t (* eax_1)[0x4] = sub_4eb780(ebx, i)
                int32_t ecx_2 = *esi_2
                uint32_t (* edx_2)[0x4] = eax_1
                uint32_t (* var_20_1)[0x4] = edx_2
                
                if (ecx_2 == 2)
                    sub_4cc280(sub_4ee9c0(ebx[0x133], i), (*var_20_1)[0x132].b)
                else if (ecx_2 == 5)
                    uint32_t ebx_1
                    int64_t xmm0_1
                            ...
                            if (edi_1 s> 0)
                                do
                                    ...
                                    if (ebx_1 s> 0)
                                        ...
                                        do
                                            int32_t* eax_3 = *(esi_2 + 0xa8)
                                            int64_t var_14 = xmm0_2
                                            int32_t var_c_1 = edi_2
                                            
                                            if (*eax_3 != 0)
                                                sub_4eb830(&var_14, edx_2, esi_2, &var_14)
                                                sub_4ebab0()
                                                xmm0_2 = j.q
                                                edx_2 = var_20_1
